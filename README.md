...
| 私有云部署                         | ✔️             | ✔️        |                      |
| 总览页                             | ✔️             | ✔️        | 本月总能耗、本月总成本、本月消耗吨标准煤、本月吨二氧化碳排放、分时消耗电量、成本占比、吨标准煤(TCE)占比、吨二氧化碳排放(TCO2E)占比
本月能耗趋势、本月成本趋势、相关参数、本月子空间数据 |
...
| 空间数据/能耗分类分析               | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 空间数据/能耗分项分析               | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 空间数据/成本分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 空间数据/产出分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 空间数据/收入分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 空间数据/效率分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 空间数据/负荷分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 空间数据/统计分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 空间数据/节能分析                   | ❌             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、需要能耗预测组件      |
| 设备数据/能耗分类分析               | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 设备数据/能耗分项分析               | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 设备数据/成本分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 设备数据/产出分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 设备数据/收入分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 设备数据/效率分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 设备数据/负荷分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 设备数据/统计分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 设备数据/节能分析                   | ❌             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、需要能耗预测组件  |
| 设备数据/设备台账                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 租户数据/能耗分类分析                | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 租户数据/能耗分项分析                | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 租户数据/成本分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 租户数据/负荷分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 租户数据/统计分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 租户数据/节能分析                   | ❌             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、需要能耗预测组件   |
| 租户数据/租户账单                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 门店数据/能耗分类分析                | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 门店数据/能耗分项分析                | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 门店数据/成本分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 门店数据/负荷分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 门店数据/统计分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 门店数据/节能分析                   | ❌             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、需要能耗预测组件   |
| 车间数据/能耗分类分析                | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 车间数据/能耗分项分析                | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 车间数据/成本分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 车间数据/负荷分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 车间数据/统计分析                   | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 车间数据/节能分析                   | ❌             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、需要能耗预测组件   |
| 组合设备数据/成本分析                | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 组合设备数据/产出分析                | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 组合设备数据/收入分析                | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 组合设备数据/效率分析                | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 组合设备数据/负荷分析                | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 组合设备数据/统计分析                | ✔️             | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、                     |
| 组合设备数据/节能分析                | ❌            | ✔️        | 按空间层级筛选、多种比较类型、多种时间尺度、需要能耗预测组件  |
...
| BACnet Server                    | ❌            | ✔️        | 需要企业版组件许可 |
| Modbus TCP Server(Slave)         | ❌            | ✔️        | 需要企业版组件许可 |
| OPC UA Server                    | ❌            | ✔️        | 需要企业版组件许可 |
