...
| 租户数据/批量分析                   | ✔️             | ✔️        | 按空间层级筛选、空间向下递归查询租户、按报告期查询全部能耗分类数据、导出Excel |
...
| 门店数据/批量分析                   | ✔️             | ✔️        | 按空间层级筛选、空间向下递归查询门店、按报告期查询全部能耗分类数据、导出Excel |
...
| 车间数据/批量分析                   | ✔️             | ✔️        | 按空间层级筛选、空间向下递归查询车间、按报告期查询全部能耗分类数据、导出Excel |
