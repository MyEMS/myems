...
Chiński uproszczony | [Angielski](./README.md) | [Niemiecki](./README_DE.md) | [Francuski](./README_FR.md) | [Hiszpański](./README_ES.md) | [Rosyjski](./README_RU.md) | [Portugalski](./README_PT.md) | [Chiński tradycyjny](./README_TW.md) | [Arabski](./README_AR.md) | [Tajski](./README_TH.md) | [Hindi](./README_HI.md) | [Bahasa Indonesia](./README_ID.md) | [Bahasa Melayu](./README_MS.md) | [Wietnamski](./README_VI.md) | [Turecki](./README_TR.md) | [Polski](./README_PL.md)
...
![Widok funkcjonalny architektury MyEMS](./docs/images/architecture-function-view-cn.png)

![Widok miejsca architektury MyEMS](./docs/images/architecture-site-view-cn.png)

![Przepływ danych MyEMS](./docs/images/myems-data-flow-cn.svg)

## Prezentacja interfejsu użytkownika MyEMS Web
...
## Prezentacja interfejsu użytkownika MyEMS Admin
...
## Prezentacja interfejsu pulpitu nawigacyjnego MyEMS

![Duży ekran pulpitu nawigacyjnego MyEMS](./docs/images/myems-large-screen-dashboard.gif)

![Pulpit nawigacyjny MyEMS GCC](./docs/images/myems-dashboard-gcc.png)
...
[1]. [https://gitee.com/myems/myems](https://gitee.com/myems/myems) (zalecane)
...
Interfejs użytkownika MyEMS Web: 80
...
## Oficjalny profil WeChat

![Otwarty system zarządzania energią](./docs/images/qr_code_mp_weixin.png)


## Grupa WeChat

![Grupa WeChat](./docs/images/qr_code_wechat_group.png)

## Grupa QQ

Numer grupy: 792528967

![Grupa QQ](./docs/images/qr_code_qq_group.png)
