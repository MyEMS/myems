...
import ProductionEnergyConsumption from '../components/MyEMS/Space/ProductionEnergyConsumption';
...
const MyEMSRoutes = () => (
  <Switch>
    ...
    <Route path="/space/productionenergy" exact component={ProductionEnergyConsumption} />
