...
export const spaceRoutes = {
  ...
  children: [
    ...
    { to: '/space/cost', name: 'CostAnalysis' },
...
export const equipmentRoutes = {
  ...
  children: [
    ...
    { to: '/equipment/cost', name: 'CostAnalysis' },
...
export const tenantRoutes = {
  ...
  children: [
    ...
    { to: '/tenant/cost', name: 'CostAnalysis' },
...
export const storeRoutes = {
  ...
  children: [
    ...
    { to: '/store/cost', name: 'CostAnalysis' },
...
export const shopfloorRoutes = {
  ...
  children: [
    ...
    { to: '/shopfloor/cost', name: 'CostAnalysis' },
...
export const combinedEquipmentRoutes = {
  ...
  children: [
    ...
    { to: '/combinedequipment/cost', name: 'CostAnalysis' },
