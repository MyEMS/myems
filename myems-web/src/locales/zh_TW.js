...
export default {
    translation: {
        ...
        ABOUT_INTRO: "MyEMS 是一款開源的能源管理系統，由<strong>北京海識軟件有限公司</strong>（<a href='https://hassoft.cn' target='_blank' style='color:#1ab394;'>hassoft.cn</a>）開發。",
        OFFICIAL_SITE: "官網：<a href='https://myems.cn' target='_blank' style='color:#1ab394;'>https://myems.cn</a>",
        SOURCE_CODE: '原始碼',
        INSTALL_DOCS: '安裝文檔',
        ADMIN_TUTORIAL: '管理員使用說明',
        VIDEO_TUTORIAL: '視頻教程',
        ...
        WECHAT_GROUP: '免費微信群 — 關注微信朋友圈獲取入群方法',
        PLANET_BADGE: '知識星球',
        PLANET_TITLE: 'MyEMS 開源能源管理系統',
        PLANET_DESC_1: '下載能源管理方案資料',
        PLANET_DESC_2: '提問獲得優先解答',
        JOIN_NOW: '立即加入',
        SCAN_QR: '掃碼關注',
        WECHAT_MP: '微信公眾號',
        WECHAT_MP_DESC: '開源能源管理系統',
        WECHAT: '微信',
        LARK: '飛書',
        VIDEO_ACCOUNT: '視頻號：MyEMS 開源能源管理系統',
        HIDE_MORE: '收起',
        CLICK_TO_EXPAND_FOR_MORE_DESCRIPTION: '點擊展開查看更多說明',
        ABOUT_MORE: 'MyEMS 開源能源管理系統適用於工廠、商業建築、園區、工業生產能耗的全方位採集、監測和分析。',
