// Auto-split from i18n.js 鈥?language: en
export default {
    translation: {
        // routes & menus
        Dashboard: 'Dashboard',
        ...
        BLOG: 'Blog',
        COMMUNITY_FREE_EN: 'The open-source community edition offers free technical support:',
        ...
        WECHAT_GROUP: 'Free Q&A WeChat group, scan QR code on the right to join',
        WECHAT_GROUP_QR: 'WeChat Group',
        PLANET_BADGE: 'Planet',
        ...
        'Energy Consumption by Category': 'Energy Consumption by Category',
        'Cost Distribution by Category': 'Cost Distribution by Category',
        'Monthly Energy & Cost Trends': 'Monthly Energy & Cost Trends',
        'Top 5 Energy Consuming Stores': 'Top 5 Energy Consuming Stores',
        'Energy Category Details': 'Energy Category Details',
        ...
        'AI analysis initial prompt':
            'Based only on the JSON report context below, summarize key findings, anomalies, and comparisons, then give energy-saving and O&M recommendations. Reply in plain text only (no Markdown). Use paragraphs and optional numbering.',
        'AI analysis loading': 'AI is analyzing report data鈥?,
        'AI analysis follow up placeholder':
            'Ask a follow-up question about this report (optional)',
        Send: 'Send',
        'AI analysis copy': 'Copy',
        'AI analysis copied': 'Copied to clipboard',
        'AI analysis copy failed': 'Could not copy',
        'AI analysis max messages hint':
            'Maximum conversation length reached (5 messages per session).',
        Datetime: 'Datetime',
  ...
  on an invalid registration account link. Please tryagain.',
        ...
        'API.DEEPSEEK_INVALID_RESPONSE': 'AI analysis returned an invalid response',
        'API.DEEPSEEK_NOT_CONFIGURED': 'AI analysis is not configured on the server',
        'API.DEEPSEEK_REQUEST_FAILED': 'AI analysis request failed',
        'API.DEEPSEEK_UPSTREAM_ERROR': 'AI analysis service is temporarily unavailable',
        'API.DEEPSEEK_TOO_MANY_MESSAGES': 'Too many messages in this session (maximum is 5)',
        'API.INVALID_MESSAGE_CONTENT': 'Invalid message content',
        'API.INVALID_MESSAGE_ROLE': 'Invalid message role',
        'API.INVALID_MESSAGES': 'Invalid messages',
        'API.INVALID_REPORT_CONTEXT': 'Invalid report context',
        ...
        SubMeter: 'Submeter',
        'Power Quality': 'Netzqualit盲t',
        'About Power Quality': '脺ber die Netzqualit盲t',
        Category: 'Kategorie',
        Type: 'Typ',
        Limit: 'Grenzwert',
        ...
        'Severe Exceed Count': 'Anzahl schwerer 脺berschreitungen',
        'Worst Unbalance': 'Gr枚脽te Unwucht',
        Hz: 'Hz',
        voltage: 'Voltage',
        current: 'Current',
        frequency: 'Frequency',
