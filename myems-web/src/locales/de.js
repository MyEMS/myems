...
export default {
    translation: {
        ...
        BLOG: 'Blog',
        COMMUNITY_FREE_EN: 'Die Open-Source-Community-Edition bietet kostenlosen technischen Support:',
        ...
        WECHAT_GROUP: 'Kostenlose Q&A WeChat-Gruppe, scannen Sie den QR-Code rechts zum Beitreten',
        WECHAT_GROUP_QR: 'WeChat-Gruppe',
        PLANET_BADGE: 'Planet',
        ...
        HIDE_MORE: 'Weniger anzeigen',
        CLICK_TO_EXPAND_FOR_MORE_DESCRIPTION: 'Klicken Sie, um weitere Beschreibung anzuzeigen',
        ABOUT_MORE: 'Das Open-Source-Energiemanagementsystem MyEMS eignet sich zur umfassenden Erfassung, Überwachung und Analyse des Energieverbrauchs in Fabriken, Gewerbegebäuden, Industrieparks und der industriellen Produktion.',
        ...
        Saving: 'SparenⒺ',
        Plan: 'PlanenⒺ',
        Prediction: 'PrognoseanalyseⒺ',
        'Production': 'Production',
        'Space Production': 'Produktionsenergieanalyse',
        'Equipment Tracking': 'Ausrüstung Datei',
        'Equipment Comparison': 'Ausrüstung Vergleich',
        'Equipment Realtime Monitor': 'Echtzeitüberwachung der Ausrüstung',
        ...
        'Trend in the last hour of Main Parameter': 'Trend der letzten Stunde des Hauptparameters',
        ...
        'Enter Production': 'Produktionseingabe',
        ...
        'Comprehensive overview of store energy performance': 'Umfassende Übersicht der Store-Energieleistung',
        'Total Stores': 'Gesamtzahl der Stores',
        ...
        'Cost Distribution by Category': 'Kostenverteilung nach Kategorie',
        'Monthly Energy & Cost Trends': 'Monatliche Energie- und Kostentrends',
        'Top 5 Energy Consuming Stores': 'Top 5 energieintensivste Stores',
        'Energy Category Details': 'Energiekategorie-Details',
        'Store Performance Overview': 'Store-Leistungsübersicht',
        'YoY Change': 'Jährliche Veränderung',
        'Per m²': 'Pro m²',
        ...
        'Shopfloor Name': 'Werkstattname',
        'Shopfloor Area': 'Werkstattfläche',
        // Combined Equipment Dashboard
        'Total Combined Equipments': 'Gesamtzahl kombinierter Geräte',
        ...
        'Comprehensive Unit Price': 'Durchschnittlicher Einheitspreis',
        Baseline: 'Basiswert',
        Actual: 'Istwert',
  ...
  Bitte kopieren Sie ihn in das Eingabefeld unten.',
        ...
        'Battery Discharging': 'Entladen', // 8
        'Battery Idle': 'Idle', // 9
  ...
  Sie auf einen ungültigen Registrierungslink geklickt. Bitte versuchen Sie es erneut.',
        ...
        'About Power Quality': 'Über die Stromqualität',
        ...
        'Worst Deviation': 'Schlechteste Abweichung',
        'Worst Time': 'Zeitpunkt der schlechtesten Abweichung',
        'Severe Exceed Count': 'Anzahl schwerer Überschreitungen',
        'Worst Unbalance': 'Maximales Ungleichgewicht',
        Hz: 'Hz',
        voltage: 'Spannung',
        current: 'Strom',
        frequency: 'Frequenz',
        voltage_deviation: 'Spannungsabweichung',
        current_unbalance: 'Stromunsymmetrie',
        voltage_unbalance: 'Spannungsunsymmetrie',
        mean_deviation_pct: 'Mittlere Abweichung (%)',
        p95_abs_deviation_pct: 'P95 absolute Abweichung (%)',
        mean_abs_deviation_hz: 'Mittlere absolute Abweichung (Hz)',
        frequency_deviation: 'Frequenzabweichung',
        p95_abs_deviation_hz: 'P95 absolute Abweichung (Hz)',
        mean_unbalance_pct: 'Mittlere Unsymmetrie (%)',
        p95_unbalance_pct: 'P95 Unsymmetrie (%)',
        count: 'Anzahl',
        min: 'Min',
        max: 'Max',
        mean: 'Mittelwert',
