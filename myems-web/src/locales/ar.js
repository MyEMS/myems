...
export default {
    translation: {
        ...
        BLOG: 'مدونة',
        COMMUNITY_FREE_EN: 'يقدم إصدار المجتمع مفتوح المصدر دعما فنيا مجانيا:',
        ...
        WECHAT_GROUP: 'مجموعة WeChat مجانية للأسئلة والأجوبة، امسح رمز QR على اليمين للانضمام',
        WECHAT_GROUP_QR: 'مجموعة WeChat',
        PLANET_BADGE: 'Planet',
        ...
        HIDE_MORE: 'طي',
        CLICK_TO_EXPAND_FOR_MORE_DESCRIPTION: 'انقر للتوسع لمزيد من الوصف',
        ABOUT_MORE: 'نظام إدارة الطاقة مفتوح المصدر MyEMS مناسب للجمع الشامل ومراقبة وتحليل استهلاك الطاقة في المصانع والمباني التجارية والمجمعات الصناعية والإنتاج الصناعي.',
        ...
        'Store Dashboard': 'لوحة تحكم المتاجر',
        'Comprehensive overview of store energy performance': 'نظرة شاملة على أداء الطاقة في المتاجر',
        ...
        'Carbon Emissions': 'انبعاثات الكربون',
        'Current Period': 'الفترة الحالية',
        'Energy Consumption by Category': 'استهلاك الطاقة حسب الفئة',
        'Cost Distribution by Category': 'توزيع التكاليف حسب الفئة',
        'Monthly Energy & Cost Trends': 'اتجاهات الطاقة والتكاليف الشهرية',
        'Top 5 Energy Consuming Stores': 'أعلى 5 متاجر استهلاكاً للطاقة',
        'Energy Category Details': 'تفاصيل فئات الطاقة',
        'Store Performance Overview': 'نظرة عامة على أداء المتاجر',
        'YoY Change': 'التغيير السنوي',
        'Per m²': 'لكل متر مربع',
        'Usage Intensity': 'كثافة الاستخدام',
        'Dashboard data loaded successfully': 'تم تحميل بيانات لوحة التحكم بنجاح',
        'Failed to load dashboard data': 'فشل في تحميل بيانات لوحة التحكم',
        'Store Name': 'اسم المتجر',
        'Store Area': 'مساحة المتجر',
        'Energy Consumption': 'استهلاك الطاقة',
        'Consumption': 'الاستهلاك',
        'last period': 'الفترة السابقة',
        // Tenant Dashboard
        'Tenant Dashboard': 'لوحة تحكم المستأجرين',
        'Comprehensive overview of tenant energy performance': 'نظرة شاملة على أداء الطاقة للمستأجرين',
        'Total Tenants': 'إجمالي المستأجرين',
        'Tenant Performance Overview': 'نظرة عامة على أداء المستأجرين',
        ...
        'Start Integrity Rate Description': 'معدل سلامة البيانات الأولي: نسبة الأجهزة التي تم الحصول بنجاح على قراءة استهلاك الطاقة في لحظة البداية من بين جميع الأجهزة خلال الفترة الإحصائية',
        'End Integrity Rate Description': 'معدل سلامة البيانات النهائي: نسبة الأجهزة التي تم الحصول بنجاح على قراءة استهلاك الطاقة في لحظة النهاية من بين جميع الأجهزة خلال الفترة الإحصائية',
        'Full Integrity Rate Description': 'معدل سلامة البيانات الكامل: نسبة الأجهزة التي تم الحصول بنجاح على قراءة استهلاك الطاقة في لحظة البداية والنهاية معاً من بين جميع الأجهزة خلال الفترة الإحصائية',
        //Equipment Tracking
