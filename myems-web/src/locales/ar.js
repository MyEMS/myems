...
export default {
    translation: {
        ...
        WECHAT: 'WeChat',
        LARK: 'Lark',
        VIDEO_ACCOUNT: 'حساب فيديو',
        XIAOHONGSHU: 'Xiaohongshu',
        HIDE_MORE: 'طي',
        CLICK_TO_EXPAND_FOR_MORE_DESCRIPTION: 'انقر للتوسع لمزيد من الوصف',
        ABOUT_MORE: 'نظام إدارة الطاقة مفتوح المصدر MyEMS مناسب للتجميع الشامل والمراقبة والتحليل لاستهلاك الطاقة في المصانع والمباني التجارية والمناطق الصناعية والإنتاج الصناعي.',
