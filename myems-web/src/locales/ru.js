...
export default {
    translation: {
        ...
        WECHAT: 'WeChat',
        LARK: 'Lark',
        VIDEO_ACCOUNT: 'Видеоаккаунт: MyEMS Система Управления Энергией с Открытым Кодом',
        HIDE_MORE: 'Свернуть',
        CLICK_TO_EXPAND_FOR_MORE_DESCRIPTION: 'Нажмите, чтобы развернуть описание',
        ABOUT_MORE: 'Система управления энергией с открытым исходным кодом MyEMS подходит для всестороннего сбора, мониторинга и анализа энергопотребления на заводах, в коммерческих зданиях, промышленных парках и промышленном производстве.',
