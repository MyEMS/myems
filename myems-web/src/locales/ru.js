...
export default {
    translation: {
        ...
        ABOUT_MYEMS: 'О MyEMS',
        ABOUT_INTRO: "MyEMS — это система управления энергией с открытым исходным кодом, разработанная <strong>Hassoft Beijing Co., Ltd.</strong> (<a href='https://hassoft.cn' target='_blank' style='color:#1ab394;'>hassoft.cn</a>).",
        ...
        BLOG: 'Блог',
        COMMUNITY_FREE_EN: 'Издание с открытым исходным кодом предоставляет бесплатную техническую поддержку:',
        SUPPORT_TITLE: 'Техническая Поддержка и Сообщество',
        COMMUNITY_FREE: 'Версия сообщества с открытым исходным кодом предлагает бесплатную техническую поддержку:',
        QQ_GROUP: 'QQ-группа: <strong>792528967</strong> (Будние дни 9:00-18:00)',
        WECHAT_GROUP: 'Бесплатная группа WeChat для вопросов и ответов, отсканируйте QR-код справа, чтобы присоединиться',
        WECHAT_GROUP_QR: 'Группа WeChat',
        PLANET_BADGE: 'Planet',
        PLANET_TITLE: 'MyEMS Система Управления Энергией с Открытым Кодом',
        PLANET_DESC_1: 'Загрузите материалы решений по управлению энергией',
        PLANET_DESC_2: 'Получайте приоритетные ответы на ваши вопросы',
        JOIN_NOW: 'Присоединиться Сейчас',
        SCAN_QR: 'Сканировать QR-код',
        WECHAT_MP: 'Официальный Аккаунт WeChat',
        WECHAT_MP_DESC: 'Система Управления Энергией с Открытым Кодом',
        WECHAT: 'WeChat',
        LARK: 'Lark',
        VIDEO_ACCOUNT: 'Видеоаккаунт',
        XIAOHONGSHU: 'Xiaohongshu',
        HIDE_MORE: 'Свернуть',
        CLICK_TO_EXPAND_FOR_MORE_DESCRIPTION: 'Нажмите, чтобы развернуть описание',
        ABOUT_MORE: 'Система управления энергией с открытым исходным кодом MyEMS подходит для комплексного сбора, мониторинга и анализа энергопотребления на заводах, коммерческих зданиях, промышленных парках и в промышленном производстве.',
        ...
        Saving: 'СпасительныйⒺ',
        Plan: 'ПланⒺ',
        Prediction: 'Прогнозный анализⒺ',
        'Production': 'Production',
        'Space Production': 'Анализ энергопотребления производства',
        'Equipment Tracking': 'Отслеживание оборудования',
        'Equipment Comparison': 'Сравнение оборудования',
        'Equipment Realtime Monitor': 'Мониторинг оборудования в реальном времени',
        ...
        'Trend in the last hour of Main Parameter': 'Тренд за последний час основного параметра',
        ...
        'Enter Production': 'Ввод выработки',
        ...
        'Store Dashboard': 'Панель Магазинов',
        'Comprehensive overview of store energy performance': 'Комплексный обзор энергоэффективности магазинов',
        ...
        'Energy Consumption by Category': 'Потребление Энергии по Категориям',
        'Cost Distribution by Category': 'Распределение Затрат по Категориям',
        'Monthly Energy & Cost Trends': 'Месячные Тренды Энергии и Затрат',
        'Top 5 Energy Consuming Stores': 'Топ-5 Магазинов по Потреблению Энергии',
        'Energy Category Details': 'Детали Категорий Энергии',
        'Store Performance Overview': 'Обзор Эффективности Магазинов',
        'YoY Change': 'Изменение за Год',
        'Per m²': 'На м²',
        'Usage Intensity': 'Интенсивность Использования',
        'Dashboard data loaded successfully': 'Данные панели успешно загружены',
        'Failed to load dashboard data': 'Не удалось загрузить данные панели',
        'Store Name': 'Название магазина',
        'Store Area': 'Площадь магазина',
        ...
        'Start Integrity Rate Description': 'Коэффициент целостности начальных данных: Доля приборов, успешно получивших показания потребления энергии в момент начала, среди всех приборов за статистический период',
        'End Integrity Rate Description': 'Коэффициент целостности конечных данных: Доля приборов, успешно получивших показания потребления энергии в момент окончания, среди всех приборов за статистический период',
        'Full Integrity Rate Description': 'Коэффициент полной целостности данных: Доля приборов, успешно получивших показания потребления энергии как в момент начала, так и в момент окончания, среди всех приборов за статистический период',
        //Equipment Tracking
...
по неверной ссылке на регистрационный аккаунт. Пожалуйста, попробуйте еще раз.',
        ...
        Compliance: 'Доля соответствия',
        'Worst Deviation': 'Наибольшее отклонение',
        'Worst Time': 'Время наибольшего отклонения',
        'Severe Exceed Count': 'Число критических превышений',
        ...
        current_unbalance: 'Небаланс тока',
        voltage_unbalance: 'Небаланс напряжения',
        mean_deviation_pct: 'Среднее отклонение (%)',
        p95_abs_deviation_pct: 'Абсолютное отклонение P95 (%)',
        mean_abs_deviation_hz: 'Среднее абсолютное отклонение (Гц)',
        frequency_deviation: 'Отклонение частоты',
        p95_abs_deviation_hz: 'Абсолютное отклонение P95 (Гц)',
        mean_unbalance_pct: 'Средний небаланс (%)',
        p95_unbalance_pct: 'Небаланс P95 (%)',
        count: 'Количество',
        min: 'Мин.',
        max: 'Макс.',
        mean: 'Среднее',
