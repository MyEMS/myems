...
export default {
    translation: {
        ...
        BLOG: 'บล็อก',
        COMMUNITY_FREE_EN: 'เวอร์ชันชุมชนโอเพ่นซอร์สให้การสนับสนุนทางเทคนิคฟรี:',
        ...
        WECHAT_GROUP: 'กลุ่ม WeChat ถามตอบฟรี สแกน QR code ด้านขวาเพื่อเข้าร่วม',
        WECHAT_GROUP_QR: 'กลุ่ม WeChat',
        PLANET_BADGE: 'Planet',
        ...
        WECHAT: 'WeChat',
        LARK: 'Lark',
        VIDEO_ACCOUNT: 'บัญชีวิดีโอ',
        XIAOHONGSHU: 'Xiaohongshu',
        HIDE_MORE: 'ยุบ',
        CLICK_TO_EXPAND_FOR_MORE_DESCRIPTION: 'คลิกเพื่อขยายคำอธิบายเพิ่มเติม',
        ABOUT_MORE: 'ระบบการจัดการพลังงานโอเพ่นซอร์ส MyEMS เหมาะสำหรับการรวบรวม ติดตาม และวิเคราะห์การใช้พลังงานในโรงงาน อาคารพาณิชย์ นิคมอุตสาหกรรม และการผลิตอุตสาหกรรม',
        ...
        Saving: 'การประหยัดⒺ',
        Plan: 'วางแผนⒺ',
        Prediction: 'การวิเคราะห์การพยากรณ์Ⓔ',
        'Production': 'Production',
        'Space Production': 'วิเคราะห์พลังงานผลผลิต',
        ...
        'Master Meter Submeters Balance': 'สมดุลมิเตอร์หลักและมิเตอร์ย่อย',
        ...
        'Store Dashboard': 'แดชบอร์ดร้านค้า',
        'Comprehensive overview of store energy performance': 'ภาพรวมประสิทธิภาพพลังงานของร้านค้า',
        'Total Stores': 'จำนวนร้านทั้งหมด',
        'Total Area': 'พื้นที่ทั้งหมด',
        'Active Meters': 'มิเตอร์ที่ใช้งาน',
        'Active Alerts': 'การแจ้งเตือนที่ใช้งาน',
        'Total Energy Consumption': 'การใช้พลังงานทั้งหมด',
        'Carbon Emissions': 'การปล่อยคาร์บอน',
        'Current Period': 'งวดปัจจุบัน',
        'Energy Consumption by Category': 'การใช้พลังงานตามหมวดหมู่',
        'Cost Distribution by Category': 'การกระจายต้นทุนตามหมวดหมู่',
        'Monthly Energy & Cost Trends': 'แนวโน้มพลังงานและต้นทุนรายเดือน',
        'Top 5 Energy Consuming Stores': 'ร้านค้าที่ใช้พลังงานสูงสุด 5 อันดับ',
        'Energy Category Details': 'รายละเอียดหมวดหมู่พลังงาน',
        'Store Performance Overview': 'ภาพรวมประสิทธิภาพร้านค้า',
        'YoY Change': 'เปลี่ยนแปลงเมื่อเทียบกับปีก่อน',
        'Per m²': 'ต่อ ตร.ม.',
        'Usage Intensity': 'ความเข้มข้นของการใช้งาน',
        'Dashboard data loaded successfully': 'โหลดข้อมูลแดชบอร์ดสำเร็จ',
        'Failed to load dashboard data': 'ไม่สามารถโหลดข้อมูลแดชบอร์ดได้',
        'Store Name': 'ชื่อร้าน',
        ...
        'Associated Equipments': 'อุปกรณ์ที่เกี่ยวข้อง',
            ...
            'Start Integrity Rate Description': 'อัตราความสมบูรณ์ของข้อมูลเริ่มต้น: สัดส่วนของมิเตอร์ทั้งหมดที่ได้รับค่าอ่านการใช้พลังงานในช่วงเวลาเริ่มต้นสำเร็จในช่วงเวลาสถิติ',
            'End Integrity Rate Description': 'อัตราความสมบูรณ์ของข้อมูลสุดท้าย: สัดส่วนของมิเตอร์ทั้งหมดที่ได้รับค่าอ่านการใช้พลังงานในช่วงเวลาสุดท้ายสำเร็จในช่วงเวลาสถิติ',
            'Full Integrity Rate Description': 'อัตราความสมบูรณ์ของข้อมูลทั้งหมด: สัดส่วนของมิเตอร์ทั้งหมดที่ได้รับค่าอ่านการใช้พลังงานในช่วงเวลาเริ่มต้นและสุดท้ายสำเร็จในช่วงเวลาสถิติ',
            //Equipment Tracking
      ...
      โปรดคัดลอกไปยังช่องป้อนข้อมูลด้านล่าง.',
            ...
            frequency_deviation: 'ความคลาดเคลื่อนความถี่',
