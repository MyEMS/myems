...
export default {
    translation: {
        ...
        BLOG: 'Blog',
        COMMUNITY_FREE_EN: 'Edisi komuniti sumber terbuka menawarkan sokongan teknikal percuma:',
        ...
        QQ_GROUP: 'Kumpulan QQ: <strong>792528967</strong> (Hari kerja 9:00-18:00)',
        WECHAT_GROUP: 'Kumpulan WeChat Q&A percuma, imbas kod QR di sebelah kanan untuk menyertai',
        WECHAT_GROUP_QR: 'Kumpulan WeChat',
        PLANET_BADGE: 'Planet',
        ...
        Saving: 'MenyimpanⒺ',
        Plan: 'RancangⒺ',
        Prediction: 'Analisis ramalanⒺ',
        'Production': 'Production',
        'Space Production': 'Analisis tenaga pengeluaran',
        ...
        'Enter Production': 'Masukan pengeluaran',
        ...
        'Store Dashboard': 'Papan Pemuka Kedai',
        'Comprehensive overview of store energy performance': 'Gambaran keseluruhan prestasi tenaga kedai',
        'Total Stores': 'Jumlah Kedai',
        'Total Area': 'Jumlah Kawasan',
        'Active Meters': 'Meter Aktif',
        'Active Alerts': 'Amaran Aktif',
        'Total Energy Consumption': 'Jumlah Penggunaan Tenaga',
        'Carbon Emissions': 'Pelepasan Karbon',
        'Current Period': 'Tempoh Semasa',
        'Energy Consumption by Category': 'Penggunaan Tenaga mengikut Kategori',
        'Cost Distribution by Category': 'Pengagihan Kos mengikut Kategori',
        'Monthly Energy & Cost Trends': 'Aliran Tenaga dan Kos Bulanan',
        'Top 5 Energy Consuming Stores': '5 Kedai Penggunaan Tenaga Tertinggi',
        'Energy Category Details': 'Butiran Kategori Tenaga',
        'Store Performance Overview': 'Gambaran Prestasi Kedai',
        'YoY Change': 'Perubahan Tahunan',
        'Per m²': 'Setiap m²',
        'Usage Intensity': 'Keamatan Penggunaan',
        'Dashboard data loaded successfully': 'Data papan pemuka berjaya dimuatkan',
        'Failed to load dashboard data': 'Gagal memuatkan data papan pemuka',
        'Store Name': 'Nama Kedai',
        'Store Area': 'Kawasan Kedai',
        ...
        // Equipment Dashboard
        'Equipment Dashboard': 'Papan Pemuka Peralatan',
        'Total Equipments': 'Jumlah Peralatan',
        'Equipment Performance Overview': 'Gambaran Prestasi Peralatan',
...
akaun pendaftaran tidak sah. Sila cubalah.',
        ...
        frequency_deviation: 'Sisihan frekuensi',
