...
export default {
    translation: {
        ...
        WECHAT_GROUP: 'Ucretsiz Q&A WeChat grubu, katilmak icin sagdaki QR kodunu tarayin',
        WECHAT_GROUP_QR: 'WeChat grubu',
        PLANET_BADGE: 'Planet',
        ...
        Saving: 'TasarrufⒺ',
        Plan: 'PlanⒺ',
        Prediction: 'Tahmin analiziⒺ',
        'Production': 'Production',
        'Space Production': 'Üretim enerji analizi',
        ...
        'Enter Production': 'Üretim girişi',
        ...
        'Store Dashboard': 'Mağaza Panosu',
        'Comprehensive overview of store energy performance': 'Mağaza enerji performansı kapsamlı genel bakış',
        'Total Stores': 'Toplam Mağaza Sayısı',
        'Total Area': 'Toplam Alan',
        'Active Meters': 'Aktif Sayaçlar',
        'Active Alerts': 'Aktif Uyarılar',
        'Total Energy Consumption': 'Toplam Enerji Tüketimi',
        'Carbon Emissions': 'Karbon Emisyonları',
        'Current Period': 'Mevcut Dönem',
        'Energy Consumption by Category': 'Kategoriye Göre Enerji Tüketimi',
        'Cost Distribution by Category': 'Kategoriye Göre Maliyet Dağılımı',
        'Monthly Energy & Cost Trends': 'Aylık Enerji ve Maliyet Trendleri',
        'Top 5 Energy Consuming Stores': 'En Çok Enerji Tüketen İlk 5 Mağaza',
        'Energy Category Details': 'Enerji Kategorisi Detayları',
        'Store Performance Overview': 'Mağaza Performansı Genel Bakış',
        'YoY Change': 'Yıllık Değişim',
        'Per m²': 'm² Başına',
        'Usage Intensity': 'Kullanım Yoğunluğu',
        'Dashboard data loaded successfully': 'Pano verileri başarıyla yüklendi',
...
bağlantısına tıklamış gibi görünüyorsunuz. Lütfen tekrar deneyin.',
        ...
        frequency_deviation: 'Frekans sapması',
