...
export default {
    translation: {
        ...
        BLOG: '블로그',
        COMMUNITY_FREE_EN: '오픈 소스 커뮤니티 에디션은 무료 기술 지원을 제공합니다:',
        ...
        WECHAT_GROUP: '무료 Q&A WeChat 그룹, 우측 QR 코드를 스캔하여 가입',
        WECHAT_GROUP_QR: 'WeChat 그룹',
        PLANET_BADGE: 'Planet',
        ...
        'Comprehensive overview of store energy performance': '매장 에너지 성과 종합 개요',
        'Total Stores': '총 매장 수',
        'Total Area': '총 면적',
        'Active Meters': '활성 계량기',
        'Active Alerts': '활성 알림',
        'Total Energy Consumption': '총 에너지 소비량',
        'Carbon Emissions': '탄소 배출량',
        'Current Period': '현재 기간',
        'Energy Consumption by Category': '카테고리별 에너지 소비',
        'Cost Distribution by Category': '카테고리별 비용 분포',
        'Monthly Energy & Cost Trends': '월별 에너지 및 비용 추세',
        'Top 5 Energy Consuming Stores': '에너지 소비 상위 5개 매장',
        'Energy Category Details': '에너지 카테고리 세부정보',
        'Store Performance Overview': '매장 성과 개요',
        'YoY Change': '전년 대비',
        'Per m²': '㎡당',
        'Usage Intensity': '사용 강도',
        'Dashboard data loaded successfully': '대시보드 데이터 로드 성공',
        'Failed to load dashboard data': '대시보드 데이터 로드 실패',
        'Store Name': '매장 이름',
        'Store Area': '매장 면적',
