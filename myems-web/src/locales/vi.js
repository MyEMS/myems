...
export default {
    translation: {
        ...
        Saving: 'Tiết kiệmⒺ',
        Plan: 'Kế hoạchⒺ',
        Prediction: 'Phân tích dự báoⒺ',
        'Production': 'Production',
        'Space Production': 'Phân tích năng lượng sản lượng',
        ...
        'Master Meter Submeters Balance': 'Phân tích cân bằng công tơ tổng và công tơ phụ',
        ...
        'Offline Meter List': 'Danh sách đồng hồ ngoại tuyến',
        ...
        'Enter Production': 'Nhập sản lượng',
        ...
        'Store Dashboard': 'Bảng Điều Khiển Cửa Hàng',
        'Comprehensive overview of store energy performance': 'Tổng quan hiệu suất năng lượng cửa hàng',
        'Total Stores': 'Tổng Số Cửa Hàng',
        'Total Area': 'Tổng Diện Tích',
        'Active Meters': 'Đồng Hồ Hoạt Động',
        ...
        'Energy Consumption by Category': 'Tiêu Thụ Năng Lượng Theo Danh Mục',
        'Cost Distribution by Category': 'Phân Bổ Chi Phí Theo Danh Mục',
        'Monthly Energy & Cost Trends': 'Xu Hướng Năng Lượng và Chi Phí Hàng Tháng',
        'Top 5 Energy Consuming Stores': 'Top 5 Cửa Hàng Tiêu Thụ Năng Lượng Nhiều Nhất',
        'Energy Category Details': 'Chi Tiết Danh Mục Năng Lượng',
        'Store Performance Overview': 'Tổng Quan Hiệu Suất Cửa Hàng',
        'YoY Change': 'Thay Đổi So Với Năm Trước',
        'Per m²': 'Trên m²',
        'Usage Intensity': 'Cường Độ Sử Dụng',
        'Dashboard data loaded successfully': 'Dữ liệu bảng điều khiển đã tải thành công',
...
liên kết tài khoản đăng ký không hợp lệ. Vui lòng thử lại.',
        ...
        current: 'Dòng điện',
        frequency: 'Tần số',
        voltage_deviation: 'Độ lệch điện áp',
        current_unbalance: 'Mất cân bằng dòng điện',
        voltage_unbalance: 'Mất cân bằng điện áp',
        mean_deviation_pct: 'Độ lệch trung bình (%)',
        p95_abs_deviation_pct: 'Độ lệch tuyệt đối P95 (%)',
        mean_abs_deviation_hz: 'Độ lệch tuyệt đối trung bình (Hz)',
        frequency_deviation: 'Độ lệch tần số',
        p95_abs_deviation_hz: 'Độ lệch tuyệt đối P95 (Hz)',
        mean_unbalance_pct: 'Mất cân bằng trung bình (%)',
        p95_unbalance_pct: 'Mất cân bằng P95 (%)',
        count: 'Số lượng',
        min: 'Nhỏ nhất',
        max: 'Lớn nhất',
        mean: 'Trung bình',
