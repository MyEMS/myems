...
export default {
    translation: {
        ...
        BLOG: 'Blog',
        COMMUNITY_FREE_EN: 'L edition communautaire open source offre un support technique gratuit :',
        ...
        WECHAT_GROUP: "Groupe WeChat Q&A gratuit, scannez le QR code a droite pour rejoindre",
        WECHAT_GROUP_QR: 'Groupe WeChat',
        PLANET_BADGE: 'Planet',
        ...
        Saving: 'ÉpargneⒺ',
        Plan: 'PlanⒺ',
        Prediction: 'Analyse prévisionnelleⒺ',
        'Production': 'Production',
        'Space Production': 'Analyse énergétique de production',
        ...
        'Meter Count': 'Nombre de compteurs',
        'Virtual Meter Count': 'Nombre de compteurs virtuels',
        ...
        'Enter Production': 'Saisie de production',
        ...
        'Store Dashboard': 'Tableau de Bord des Magasins',
        'Comprehensive overview of store energy performance': 'Aperçu complet de la performance énergétique des magasins',
        'Total Stores': 'Nombre Total de Magasins',
        ...
        'Energy Consumption by Category': 'Consommation d\'Énergie par Catégorie',
        'Cost Distribution by Category': 'Distribution des Coûts par Catégorie',
        'Monthly Energy & Cost Trends': 'Tendances Mensuelles d\'Énergie et de Coûts',
        'Top 5 Energy Consuming Stores': 'Top 5 des Magasins les Plus Consommateurs',
        'Energy Category Details': 'Détails des Catégories d\'Énergie',
        'Store Performance Overview': 'Aperçu de la Performance des Magasins',
        'YoY Change': 'Variation Annuelle',
        'Per m²': 'Par m²',
        'Usage Intensity': 'Intensité d\'Utilisation',
        'Dashboard data loaded successfully': 'Données du tableau de bord chargées avec succès',
        'Failed to load dashboard data': 'Échec du chargement des données du tableau de bord',
        'Store Name': 'Nom du magasin',
        'Store Area': 'Surface du magasin',
        'Energy Consumption': 'Consommation d\'énergie',
        'Consumption': 'Consommation',
        'last period': 'période précédente',
        // Tenant Dashboard
        'Tenant Dashboard': 'Tableau de Bord des Locataires',
        'Comprehensive overview of tenant energy performance': 'Aperçu complet de la performance énergétique des locataires',
        'Total Tenants': 'Total des Locataires',
        'Tenant Performance Overview': 'Aperçu de la Performance des Locataires',
        'Tenant Name': 'Nom du Locataire',
        'Tenant Area': 'Surface du Locataire',
        'Tenant Type': 'Type de Locataire',
        // Equipment Dashboard
        'Equipment Dashboard': 'Tableau de bord des équipements',
        'Total Equipments': 'Total des équipements',
        'Equipment Performance Overview': 'Aperçu des performances des équipements',
        ...
        'Shopfloor Name': 'Nom de l\'atelier',
        'Shopfloor Area': 'Surface de l\'atelier',
        // Combined Equipment Dashboard
        'Total Combined Equipments': 'Nombre total d\'équipements combinés',
        'Combined Equipment Performance Overview': 'Aperçu des performances des équipements combinés',
        'Combined Equipment Name': 'Nom de l\'équipement combiné',
        'Associated Equipments': 'Équipements associés',
  ...
  cliqué sur un lien de compte d’inscription non valide. Veuillez réessayer..',
        ...
        'Worst Time': 'Moment du pire écart',
        'Severe Exceed Count': 'Nombre de dépassements sévères',
