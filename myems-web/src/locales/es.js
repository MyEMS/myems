...
export default {
    translation: {
        ...
        BLOG: 'Blog',
        COMMUNITY_FREE_EN: 'La edicion comunitaria de codigo abierto ofrece soporte tecnico gratuito:',
        ...
        WECHAT_GROUP: 'Grupo de WeChat de preguntas y respuestas gratuito, escanee el codigo QR a la derecha para unirse',
        WECHAT_GROUP_QR: 'Grupo de WeChat',
        PLANET_BADGE: 'Planet',
        ...
        'Space Production': 'Análisis de energía de producción',
        ...
        'Master Meter Submeters Balance': 'Balance de medidor principal y submedidores',
        ...
        'Offline Meter List': 'Lista de medidores fuera de línea',
        ...
        'Enter Production': 'Entrada de producción',
        ...
        'Store Dashboard': 'Panel de Tiendas',
        'Comprehensive overview of store energy performance': 'Visión general del rendimiento energético de las tiendas',
        'Total Stores': 'Total de Tiendas',
        'Total Area': 'Área Total',
        'Active Meters': 'Medidores Activos',
        ...
        'Energy Consumption by Category': 'Consumo de Energía por Categoría',
        'Cost Distribution by Category': 'Distribución de Costos por Categoría',
        'Monthly Energy & Cost Trends': 'Tendencias Mensuales de Energía y Costos',
        'Top 5 Energy Consuming Stores': 'Top 5 Tiendas con Mayor Consumo',
        'Energy Category Details': 'Detalles de Categoría de Energía',
        'Store Performance Overview': 'Resumen de Rendimiento de Tiendas',
        'YoY Change': 'Cambio Interanual',
        'Per m²': 'Por m²',
        'Usage Intensity': 'Intensidad de Uso',
        'Dashboard data loaded successfully': 'Datos del panel cargados exitosamente',
        'Failed to load dashboard data': 'Error al cargar datos del panel',
        'Store Name': 'Nombre de la tienda',
        'Store Area': 'Área de la tienda',
        'Energy Consumption': 'Consumo de energía',
        'Consumption': 'Consumo',
        'last period': 'período anterior',
        // Tenant Dashboard
        'Tenant Dashboard': 'Panel de Inquilinos',
        'Comprehensive overview of tenant energy performance': 'Visión general del rendimiento energético de los inquilinos',
        'Total Tenants': 'Total de Inquilinos',
        'Tenant Performance Overview': 'Resumen de Rendimiento de Inquilinos',
        'Tenant Name': 'Nombre del Inquilino',
        'Tenant Area': 'Área del Inquilino',
        'Tenant Type': 'Tipo de Inquilino',
        // Equipment Dashboard
        'Equipment Dashboard': 'Panel de Equipos',
        'Total Equipments': 'Total de Equipos',
        'Equipment Performance Overview': 'Resumen de Rendimiento de Equipos',
        ...
        'Shopfloor Name': 'Nombre del taller',
        'Shopfloor Area': 'Área del taller',
        // Combined Equipment Dashboard
        'Total Combined Equipments': 'Total de Equipos Combinados',
        ...
        'Comprehensive Unit Price': 'Precio unitario promedio',
        Baseline: 'Referencia',
        Actual: 'Actual',
        ...
        'Start Integrity Rate Description': 'Tasa de Integridad de Datos Inicial: Proporción de medidores que obtuvieron con éxito lecturas de consumo de energía en el momento de inicio entre todos los medidores durante el período estadístico',
        'End Integrity Rate Description': 'Tasa de Integridad de Datos Final: Proporción de medidores que obtuvieron con éxito lecturas de consumo de energía en el momento de finalización entre todos los medidores durante el período estadístico',
        'Full Integrity Rate Description': 'Tasa de Integridad de Datos Completa: Proporción de medidores que obtuvieron con éxito lecturas de consumo de energía tanto en el momento de inicio como en el de finalización entre todos los medidores durante el período estadístico',
        //Equipment Tracking
  ...
  Cópielo en el cuadro de entrada a continuación.',
        ...
        'Please wait for NUMBER seconds': 'Por favor, espere {{NUMBER}} segundos',
        ...
        'PCS Standby': 'En espera',
        'PCS Shutdown': 'Parada',
        'PCS Fault': 'Fallo',
        'PCS Running': 'Correr',
        'Battery Power': 'Potencia de la batería',
        'Photovoltaic Power': 'Potencia fotovoltaica',
  ...
  en un vínculo de cuenta de registro no válido. Inténtalo de nuevo.',
        ...
        'Worst Unbalance': 'Desequilibrio máximo',
        Hz: 'Hz',
        voltage: 'Tensión',
        current: 'Corriente',
