  ...
  return (
    <Fragment>
      <div className="card-deck">
        ...
        <CardSummary rate={totalInTCE['increment_rate'] || ''} title={'Total Number of Power Stations'} color="info">
          {1 && <CountUp end={26} duration={2} prefix="" separator="," decimal="." decimals={0} />}
        </CardSummary>
        <CardSummary rate={totalInTCE['increment_rate'] || ''} title={'Total Rated Power'} color="info">
          {1 && <CountUp end={12.3} duration={2} prefix="" separator="," decimal="." decimals={2} />}
        </CardSummary>
        <CardSummary rate={totalInTCE['increment_rate'] || ''} title={'Total Rated Capacity'} color="info">
          {1 && <CountUp end={12.3} duration={2} prefix="" separator="," decimal="." decimals={2} />}
        </CardSummary>
        <CardSummary rate={totalInTCE['increment_rate'] || ''} title={'Total Charge'} color="warning">
          {1 && <CountUp end={12.3} duration={2} prefix="" separator="," decimal="." decimals={2} />}
        </CardSummary>
        <CardSummary rate={totalInTCE['increment_rate'] || ''} title={'Total DisCharge'} color="warning">
          {1 && <CountUp end={12.3} duration={2} prefix="" separator="," decimal="." decimals={2} />}
        </CardSummary>
        <CardSummary rate={totalInTCE['increment_rate'] || ''} title={'Total Revenue'} color="success">
          {1 && <CountUp end={12.3} duration={2} prefix="" separator="," decimal="." decimals={2} />}
        </CardSummary>
      </div>
