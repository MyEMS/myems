...
const TenantPlan = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  const handleExport = (e, type) => {
    ...
    if (type === 'excel' && excelBytesBase64) {
      ...
      const fileName = 'tenantplan.xlsx';
      ...
      const fileName = 'tenantplan.docx';
...
export default withTranslation()(withRedirect(TenantPlan));
