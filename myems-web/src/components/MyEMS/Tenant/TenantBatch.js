...
const TenantBatch = ({ setRedirect, setRedirectUrl, t }) => {
        ...
        if (isResponseOK) {
          ...
          if (json['tenants'].length > 0) {
            ...
            json['tenants'].forEach((currentTenant, index) => {
              ...
              detailed_value['carbon_emissions'] = currentTenant['carbon_emissions'] || 0;
              detailed_value['cost'] = currentTenant['cost'] || 0;
  ...
  const handleExport = (e, type) => {
    ...
    if (type === 'excel' && excelBytesBase64) {
      ...
      const fileName = 'tenantbatch.pdf';
      ...
      const fileName = 'tenantbatch.docx';
