...
const TenantPrediction = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  const loadData = useCallback(
        ...
        .then(json => {
          if (isResponseOK) {
            ...
            if (uuid !== null && uuid) {
              ...
              setSelectedTenant(json['tenant']['id']);
            }
            ...
            if (!isBasePeriodTimestampExists(json['base_period'])) {
              ...
              json['reporting_period']['names'].forEach((currentValue, index) => {
                ...
                working_days_table_value['b0'] =
                  json['tenant']['working_calendars'].length > 0
    ...
    [
      ...
      setTCEShareData,
      setTCO2EShareData,
      setTenantBaseAndReportingNames,
      setTenantBaseAndReportingUnits,
      setTenantBaseLabels,
      setTenantBaseData,
      setTenantBaseSubtotals,
      setTenantReportingLabels,
      setTenantReportingData,
      setTenantReportingSubtotals,
      setTenantReportingRates,
      setTenantReportingOptions,
  ...
  const handleExport = e => {
    ...
    const fileName = 'tenantprediction.xlsx';
      ...
      <div>
        <Breadcrumb>
          ...
          <BreadcrumbItem active onClick={() => window.location.reload()}>
            <Link to="/tenant/prediction">{t('Prediction')}</Link>
          </BreadcrumbItem>
        </Breadcrumb>
      </div>
      ...
      <div style={{ visibility: resultDataHidden ? 'hidden' : 'visible', display: resultDataHidden ? 'none' : '' }}>
        <div className="card-deck">
          ...
          <CardSummary
            ...
            title={t('Reporting Period Prediction CATEGORY UNIT', {
              CATEGORY: t('Carbon Emissions Per Unit Of Energy Prediction'),
              UNIT: '(TCO2E/TCE)'
            })}
            color="warning"
            footnote={t('Per Unit Area')}
...
export default withTranslation()(withRedirect(TenantPrediction));
