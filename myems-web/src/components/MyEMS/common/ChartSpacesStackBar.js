    ...
    if (chart) {
      ...
      if (inputData['subtotals_array'] !== undefined && inputData['subtotals_array'].length > 0) {
        let category = t('CATEGORY Consumption UNIT', {
          CATEGORY: inputData['energy_category_names'][index],
          UNIT: inputData['units'][index]
        });
      ...
      if (costData['subtotals_array'] !== undefined && costData['subtotals_array'].length > 0) {
        let category = t('CATEGORY Costs UNIT', {
          CATEGORY: costData['energy_category_names'][index],
          UNIT: costData['units'][index]
        });
      ...
      <Card className="mb-3">
        ...
        <CardBody className="rounded-soft">
          <Row className="text-white align-items-center no-gutters">
            <Col>
              <h4 className="text-lightSlateGray mb-0">Child Spaces Data Breakdown</h4>
            </Col>
