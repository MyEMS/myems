        ...
        <Table striped className="border-bottom">
          <thead>
            <tr>
              <th>{name}</th>
              <th>
                {t('Total Active Power')}: {total_active_power_point} kW
              </th>
              <th>
                {t('Active Power A')}: {active_power_a_point} kW
              </th>
              <th>
                {t('Active Power B')}: {active_power_b_point} kW
              </th>
              <th>
                {t('Active Power C')}: {active_power_c_point} W
              </th>
            </tr>
            <tr>
              <th>
                {t('Total Power Factor')}: {total_power_factor_point}
              </th>
              <th>
                {t('Total Reactive Power')}: {total_reactive_power_point} kW
              </th>
              <th>
                {t('Reactive Power A')}: {reactive_power_a_point} kW
              </th>
              <th>
                {t('Reactive Power B')}: {reactive_power_b_point} kW
              </th>
              <th>
                {t('Reactive Power C')}: {reactive_power_c_point} W
              </th>
            </tr>
            <tr>
              <th>-</th>
              <th>
                {t('Total Apparent Power')}: {total_apparent_power_point} kW
              </th>
              <th>
                {t('Apparent Power A')}: {apparent_power_a_point} kW
              </th>
              <th>
                {t('Apparent Power B')}: {apparent_power_b_point} kW
              </th>
              <th>
                {t('Apparent Power C')}: {apparent_power_c_point} W
              </th>
            </tr>
            <tr>
              <th>-</th>
              <th>
                {t('Active Energy Import')}: {active_energy_import_point} kWh
              </th>
              <th>
                {t('Active Energy Export')}: {active_energy_export_point} kWh
              </th>
              <th>
                {t('Active Energy Net')}: {active_energy_net_point} kWh
              </th>
              <th>-</th>
            </tr>
          </thead>
