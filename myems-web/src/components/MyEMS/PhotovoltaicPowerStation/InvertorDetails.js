        ...
        <Table striped className="border-bottom">
          <thead>
            <tr>
              ...
              <td>
                {t('SERIAL NUMBER')}: {serial_number}{' '}
              </td>
              <td>
                {t('INVERTOR STATE')}: {invertor_state}{' '}
              </td>
              <td>
                {t('COMMUNICATION STATE')}: {communication_state}{' '}
              </td>
              <td>
                {t('TOTAL ENERGY')}: {total_energy}{' '}
              </td>
            </tr>
          </thead>
          <tbody>
            <tr>
              ...
              <td>
                {t('POWER FACTOR')}: {power_factor}{' '}
              </td>
              <td>
                {t('ACTIVE POWER')}: {active_power}{' '}
              </td>
            </tr>
            <tr>
              <td>
                {t('REACTIVE POWER')}: {reactive_power}{' '}
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                {t('MPPT TOTAL ENERGY')}: {mppt_total_energy}{' '}
              </td>
              <td>
                {t('MPPT POWER')}: {mppt_power}{' '}
              </td>
              <td>
                {t('MPPT 1 ENERGY')}: {mppt_1_energy}{' '}
              </td>
            </tr>
            <tr>
              <td>
                {t('MPPT 2 ENERGY')}: {mppt_2_energy}{' '}
              </td>
              <td>
                {t('MPPT 3 ENERGY')}: {mppt_3_energy}{' '}
              </td>
              <td>
                {t('MPPT 4 ENERGY')}: {mppt_4_energy}{' '}
              </td>
              <td>
                {t('MPPT 5 ENERGY')}: {mppt_5_energy}{' '}
              </td>
              <td>
                {t('MPPT 6 ENERGY')}: {mppt_6_energy}{' '}
              </td>
            </tr>
            <tr>
              <td>
                {t('MPPT 7 ENERGY')}: {mppt_7_energy}{' '}
              </td>
              <td>
                {t('MPPT 8 ENERGY')}: {mppt_8_energy}{' '}
              </td>
              <td>
                {t('MPPT 9 ENERGY')}: {mppt_9_energy}{' '}
              </td>
              <td>
                {t('MPPT 10 ENERGY')}: {mppt_10_energy}{' '}
              </td>
            </tr>
            <tr>
              <td>
                {t('STARTUP TIME')}: {startup_time}{' '}
              </td>
              <td>
                {t('SHUTDOWN TIME')}: {shutdown_time}{' '}
              </td>
            </tr>
          </tbody>
        </Table>
