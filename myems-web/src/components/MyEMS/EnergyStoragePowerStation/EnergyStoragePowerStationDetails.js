        ...
        <Col lg="4" className="pr-lg-2">
          <Card className="mb-3 fs--1">
            ...
            <CardBody className="bg-light">
              ...
              <div className="mb-1">{energyStoragePowerStationName}</div>
              <h6 className="mt-4">{t('Address')}</h6>
              <div className="mb-1">{energyStoragePowerStationAddress}</div>
              <h6 className="mt-4">{t('Postal Code')}</h6>
              <div className="mb-1">{energyStoragePowerStationPostalCode}</div>
              <h6 className="mt-4">{t('Capacity')} (kW)</h6>
              <div className="mb-1">{energyStoragePowerStationCapacity}</div>
              <h6 className="mt-4">{t('Latitude')}</h6>
              <div className="mb-1">{energyStoragePowerStationLatitude}</div>
              <h6 className="mt-4">{t('Longitude')}</h6>
              <div className="mb-1">{energyStoragePowerStationLongitude}</div>
            </CardBody>
          </Card>
        </Col>
      </Row>
