...
const StoreEnergyCategory = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  }, [basePeriodDateRange, language, loadData, periodType, reportingPeriodDateRange, t, uuid]);
      ...
      <div>
        <Breadcrumb>
          ...
          <BreadcrumbItem active onClick={() => window.location.reload()}>
            <Link to="/store/energycategory">{t('Energy Category Data')}</Link>
          </BreadcrumbItem>
        </Breadcrumb>
      </div>
