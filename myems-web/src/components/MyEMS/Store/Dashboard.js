...
import { faBolt, faDollarSign, faLeaf, faExclamationTriangle, faStore, faChartLine, faArrowUp, faArrowDown } from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <Fragment>
      ...
      <Row className="mb-4">
            ...
            <CardBody>
              <Row noGutters className="align-items-center">
                <Col xs={8}>
                  ...
                  <div className="h5 mb-0 font-weight-bold text-gray-800">
                    <CountUp end={summary.total_area || 0} duration={2} decimals={2} separator="," /> m²
                  </div>
                </Col>
                <Col xs={4} className="text-right">
        ...
        <Col xl={3} md={6} className="mb-3">
          <Card className={`h-100 shadow-sm ${summary.total_alerts > 0 ? 'border-left-danger' : 'border-left-warning'}`}>
            <CardBody>
              <Row noGutters className="align-items-center">
                <Col xs={8}>
                  ...
                  <tbody>
                    {energyData.names?.map((name, index) => (
                      <tr key={index}>
                        ...
                        <td className="text-right">
                          <Badge color={energyData.increment_rates?.[index] >= 0 ? 'danger' : 'success'}>
                            <FontAwesomeIcon 
