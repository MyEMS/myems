...
const CombinedEquipmentPlan = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  const [combinedEquipmentBaseData, setCombinedEquipmentBaseData] = useState({
    a0: []
  });
          ...
          if (json['associated_equipment']['associated_equipment_names_array'].length > 0) {
            json['associated_equipment']['associated_equipment_names_array'][0].forEach(
              (currentEquipmentName, spaceIndex) => {
                ...
                associated_equipment_value['id'] = (json['associated_equipment']['associated_equipment_ids'] && json['associated_equipment']['associated_equipment_ids'][spaceIndex]) || spaceIndex;
  ...
  const buildSmartAnalysisContext = useCallback(() => {
    ...
    return {
      reportType: 'combined_equipment_plan',
      reportTitle: t('Plan'),
...
export default withTranslation()(withRedirect(CombinedEquipmentPlan));
