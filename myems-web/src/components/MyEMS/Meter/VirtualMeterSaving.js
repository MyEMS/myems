...
const VirtualMeterSaving = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  return (
    <Fragment>
      ...
      <MultiTrendChart reportingTitle = {{"name": "Reporting Period Saving CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": virtualMeterBaseAndReportingNames, "VALUE": virtualMeterReportingSubtotals, "UNIT": virtualMeterBaseAndReportingUnits}}
        baseTitle = {{"name": "Base Period Saving CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": virtualMeterBaseAndReportingNames, "VALUE": virtualMeterBaseSubtotals, "UNIT": virtualMeterBaseAndReportingUnits}}
        reportingTooltipTitle = {{"name": "Reporting Period Saving CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": virtualMeterBaseAndReportingNames, "VALUE": null, "UNIT": virtualMeterBaseAndReportingUnits}}
        baseTooltipTitle = {{"name": "Base Period Saving CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": virtualMeterBaseAndReportingNames, "VALUE": null, "UNIT": virtualMeterBaseAndReportingUnits}}
