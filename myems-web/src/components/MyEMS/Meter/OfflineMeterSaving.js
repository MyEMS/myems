...
const OfflineMeterSaving = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  const handleSubmit = e => {
    ...
    let isResponseOK = false;
    fetch(APIBaseURL + '/reports/offlinemetersaving?' +
  ...
  return (
    <Fragment>
      <div>
        <Breadcrumb>
          <BreadcrumbItem>{t('Meter Data')}</BreadcrumbItem><BreadcrumbItem active>{t('Offline Meter Saving')}</BreadcrumbItem>
        </Breadcrumb>
      </div>
      ...
      <Fragment>
        ...
        <div className="card-deck">
          ...
          <CardSummary rate={reportingPeriodEnergySavingRate} title={t('Reporting Period Saving CATEGORY (Baseline - Actual) UNIT', { 'CATEGORY': offlineMeterEnergyCategory['name'], 'UNIT': '(' + offlineMeterEnergyCategory['unit'] + ')' })}
            color="success"  >
      ...
      <MultiTrendChart reportingTitle = {{"name": "Reporting Period Saving CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": offlineMeterBaseAndReportingNames, "VALUE": offlineMeterReportingSubtotals, "UNIT": offlineMeterBaseAndReportingUnits}}
        baseTitle = {{"name": "Base Period Saving CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": offlineMeterBaseAndReportingNames, "VALUE": offlineMeterBaseSubtotals, "UNIT": offlineMeterBaseAndReportingUnits}}
        reportingTooltipTitle = {{"name": "Reporting Period Saving CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": offlineMeterBaseAndReportingNames, "VALUE": null, "UNIT": offlineMeterBaseAndReportingUnits}}
        baseTooltipTitle = {{"name": "Base Period Saving CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": offlineMeterBaseAndReportingNames, "VALUE": null, "UNIT": offlineMeterBaseAndReportingUnits}}
