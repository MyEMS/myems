...
const OfflineMeterPlan = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  const handleExport = (e, type) => {
    ...
    if (type === 'excel' && excelBytesBase64) {
      ...
      const fileName = 'offlinemeterplan.xlsx';
      ...
      const fileName = 'offlinemeterplan.pdf';
      ...
      const fileName = 'offlinemeterplan.docx';
  ...
  const buildSmartAnalysisContext = useCallback(() => {
    ...
    return {
      reportType: 'offline_meter_plan',
      reportTitle: t('Offline Meter Plan'),
