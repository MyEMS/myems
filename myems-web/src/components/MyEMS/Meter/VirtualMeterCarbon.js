...
const VirtualMeterCarbon = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  const handleExport = (e, type) => {
    ...
    if (type === 'excel' && excelBytesBase64) {
      ...
      const fileName = 'virtualmetercarbon.pdf';
      ...
      const fileName = 'virtualmetercarbon.docx';
  ...
  const buildSmartAnalysisContext = useCallback(() => {
    ...
    return {
      reportType: 'virtual_meter_carbon',
      reportTitle: t('Virtual Meter Carbon'),
      ...
      reportingTotals: {
        carbonInCategory: reportingPeriodEnergyCarbonInCategory,
        incrementRate: reportingPeriodEnergyCarbonRate,
    ...
    basePeriodDateRange,
    reportingPeriodEnergyCarbonInCategory,
    reportingPeriodEnergyCarbonRate,
