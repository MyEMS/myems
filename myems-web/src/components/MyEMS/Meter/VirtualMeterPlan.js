...
const VirtualMeterPlan = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  const handleExport = (e, type) => {
    ...
    if (type === 'excel' && excelBytesBase64) {
      ...
      const fileName = 'virtualmeterplan.xlsx';
      ...
      const fileName = 'virtualmeterplan.pdf';
      ...
      const fileName = 'virtualmeterplan.docx';
  ...
  const buildSmartAnalysisContext = useCallback(() => {
    ...
    return {
      reportType: 'virtual_meter_plan',
      reportTitle: t('Virtual Meter Plan'),
      spaceName: selectedSpaceName ?? null,
      virtualMeter: {
        id: selectedVirtualMeter,
        name: virtualMeterLabel,
        energyCategory: virtualMeterEnergyCategory
      },
      periodType,
      comparisonType,
      reportingPeriod: {
      ...
      reportingTotals: {
        savingInCategory: reportingPeriodEnergySavingInCategory,
        incrementRate: reportingPeriodEnergySavingRate,
        tce: reportingPeriodEnergySavingInTCE,
        tco2e: reportingPeriodEnergySavingInCO2
      },
      ...
      virtualMeterBaseAndReportingNames,
      virtualMeterBaseAndReportingUnits,
      virtualMeterReportingSubtotals,
    ...
    selectedVirtualMeter,
    virtualMeterList,
    virtualMeterEnergyCategory,
    periodType,
    comparisonType,
    reportingPeriodDateRange,
    basePeriodDateRange,
    reportingPeriodEnergySavingInCategory,
    reportingPeriodEnergySavingRate,
    reportingPeriodEnergySavingInTCE,
    reportingPeriodEnergySavingInCO2,
    virtualMeterBaseSubtotals,
