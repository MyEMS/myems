...
const VirtualMeterPrediction= ({ setRedirect, setRedirectUrl, t }) => {
  ...
  const handleSubmit = e => {
    ...
    const url = `${APIBaseURL}/reports/virtualmeterprediction?${params.toString()}`;
  ...
  const handleExport = (e, type) => {
    ...
    if (type === 'excel' && excelBytesBase64) {
      ...
      const fileName = 'virtualmeterprediction.xlsx';
      ...
      const fileName = 'virtualmeterprediction.pdf';
      ...
      const fileName = 'virtualmeterprediction.docx';
          ...
          <div className="card-deck">
            <CardSummary
              ...
              title={t('Reporting Period Prediction CATEGORY UNIT', {
                CATEGORY: virtualMeterPrediction['name'],
                UNIT: '(' + virtualMeterPrediction['unit'] + ')'
              })}
              color="success"
            >
              <CountUp
...
export default withTranslation()(withRedirect(VirtualMeterPrediction));