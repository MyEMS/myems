...
const MeterCost = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  return (
    <Fragment>
      ...
      <MultiTrendChart reportingTitle = {{"name": "Reporting Period Costs CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": meterBaseAndReportingNames, "VALUE": meterReportingSubtotals, "UNIT": meterBaseAndReportingUnits}}
        baseTitle = {{"name": "Base Period Costs CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": meterBaseAndReportingNames, "VALUE": meterBaseSubtotals, "UNIT": meterBaseAndReportingUnits}}
        reportingTooltipTitle = {{"name": "Reporting Period Costs CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": meterBaseAndReportingNames, "VALUE": null, "UNIT": meterBaseAndReportingUnits}}
        baseTooltipTitle = {{"name": "Base Period Costs CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": meterBaseAndReportingNames, "VALUE": null, "UNIT": meterBaseAndReportingUnits}}
