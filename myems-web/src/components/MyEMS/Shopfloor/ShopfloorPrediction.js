...
const ShopfloorPrediction = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  const handleExport = e => {
    ...
    const fileName = 'shopfloorprediction.xlsx';
      ...
      <div>
        <Breadcrumb>
          ...
          <BreadcrumbItem active onClick={() => window.location.reload()}>
            <Link to="/shopfloor/prediction">{t('Prediction')}</Link>
          </BreadcrumbItem>
        </Breadcrumb>
      </div>
...
export default withTranslation()(withRedirect(ShopfloorPrediction));
