...
const ShopfloorPlan = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  const handleExport = (e, type) => {
    ...
    if (type === 'excel' && excelBytesBase64) {
      ...
      const fileName = 'shopfloorplan.xlsx';
      ...
      const fileName = 'shopfloorplan.pdf';
...
export default withTranslation()(withRedirect(ShopfloorPlan));
