...
const ShopfloorCost = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  return (
    <Fragment>
      ...
      <MultiTrendChart reportingTitle = {{"name": "Reporting Period Costs CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": shopfloorBaseAndReportingNames, "VALUE": shopfloorReportingSubtotals, "UNIT": shopfloorBaseAndReportingUnits}}
        baseTitle = {{"name": "Base Period Costs CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": shopfloorBaseAndReportingNames, "VALUE": shopfloorBaseSubtotals, "UNIT": shopfloorBaseAndReportingUnits}}
        reportingTooltipTitle = {{"name": "Reporting Period Costs CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": shopfloorBaseAndReportingNames, "VALUE": null, "UNIT": shopfloorBaseAndReportingUnits}}
        baseTooltipTitle = {{"name": "Base Period Costs CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": shopfloorBaseAndReportingNames, "VALUE": null, "UNIT": shopfloorBaseAndReportingUnits}}
