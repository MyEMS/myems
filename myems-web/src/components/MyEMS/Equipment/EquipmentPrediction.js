...
const EquipmentPrediction = ({ setRedirect, setRedirectUrl, t }) => {
            ...
            if (!isBasePeriodTimestampExists(json['base_period'])) {
              ...
              if (json['reporting_period']['timestamps'].length > 0) {
                json['reporting_period']['timestamps'][0].forEach((currentTimestamp, timestampIndex) => {
                  ...
                  json['reporting_period']['values'].forEach((currentValue, predictionIndex) => {
                    detailed_value['a' + predictionIndex] =
                      json['reporting_period']['values'][predictionIndex][timestampIndex];
                  });
                ...
                for (let index = 0; index < max_timestamps_length; index++) {
                  ...
                  detailed_value['basePeriodDatetime'] =
                    index < json['base_period']['timestamps'][0].length
                      ...
                      : null;
                  json['base_period']['values'].forEach((currentValue, predictionIndex) => {
                    detailed_value['a' + predictionIndex] =
                      index < json['base_period']['values'][predictionIndex].length
                        ? json['base_period']['values'][predictionIndex][index]
                        : null;
                  });
                  detailed_value['reportingPeriodDatetime'] =
                    index < json['reporting_period']['timestamps'][0].length
                      ...
                      : null;
                  json['reporting_period']['values'].forEach((currentValue, predictionIndex) => {
                    detailed_value['b' + predictionIndex] =
                      index < json['reporting_period']['values'][predictionIndex].length
                        ? json['reporting_period']['values'][predictionIndex][index]
                        : null;
                  });
                  detailed_value_list.push(detailed_value);
                }
  ...
  const handleExport = e => {
    ...
    const fileName = 'equipmentprediction.xlsx';
  ...
  const buildSmartAnalysisContext = useCallback(() => {
    ...
    return {
      reportType: 'equipment_prediction',
      ...
      <div>
        <Breadcrumb>
          ...
          <BreadcrumbItem active onClick={() => window.location.reload()}>
            <Link to="/equipment/prediction">{t('Prediction')}</Link>
          </BreadcrumbItem>
        </Breadcrumb>
      </div>
...
export default withTranslation()(withRedirect(EquipmentPrediction));
