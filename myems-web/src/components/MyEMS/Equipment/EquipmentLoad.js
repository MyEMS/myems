...
const EquipmentLoad = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  return (
    <Fragment>
      ...
      <MultiTrendChart reportingTitle = {{"name": "Reporting Period CATEGORY Maximum Load UNIT", "substitute": ["CATEGORY", "UNIT"], "CATEGORY": equipmentBaseAndReportingNames, "UNIT": equipmentBaseAndReportingUnits}}
        baseTitle = {{"name": "Base Period CATEGORY Maximum Load UNIT", "substitute": ["CATEGORY", "UNIT"], "CATEGORY": equipmentBaseAndReportingNames, "UNIT": equipmentBaseAndReportingUnits}}
        reportingTooltipTitle = {{"name": "Reporting Period CATEGORY Maximum Load UNIT", "substitute": ["CATEGORY", "UNIT"], "CATEGORY": equipmentBaseAndReportingNames, "UNIT": equipmentBaseAndReportingUnits}}
        baseTooltipTitle = {{"name": "Base Period CATEGORY Maximum Load UNIT", "substitute": ["CATEGORY", "UNIT"], "CATEGORY": equipmentBaseAndReportingNames, "UNIT": equipmentBaseAndReportingUnits}}
