...
const EquipmentSaving = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  const buildSmartAnalysisContext = useCallback(() => {
    ...
    return {
      reportType: 'equipment_saving',
      reportTitle: t('Saving'),
    ...
    <Fragment>
      <div>
        <Breadcrumb>
          ...
          <BreadcrumbItem active>{t('Saving')}</BreadcrumbItem>
        </Breadcrumb>
      </div>
