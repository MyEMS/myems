...
const EquipmentEnergyItem = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  return (
    <Fragment>
      ...
      <MultiTrendChart reportingTitle = {{"name": "Reporting Period Consumption ITEM CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": equipmentBaseAndReportingNames, "VALUE": equipmentReportingSubtotals, "UNIT": equipmentBaseAndReportingUnits}}
        baseTitle = {{"name": "Base Period Consumption ITEM CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": equipmentBaseAndReportingNames, "VALUE": equipmentBaseSubtotals, "UNIT": equipmentBaseAndReportingUnits}}
        reportingTooltipTitle = {{"name": "Reporting Period Consumption ITEM CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": equipmentBaseAndReportingNames, "VALUE": null, "UNIT": equipmentBaseAndReportingUnits}}
        baseTooltipTitle = {{"name": "Base Period Consumption ITEM CATEGORY VALUE UNIT", "substitute": ["CATEGORY", "VALUE", "UNIT"], "CATEGORY": equipmentBaseAndReportingNames, "VALUE": null, "UNIT": equipmentBaseAndReportingUnits}}
