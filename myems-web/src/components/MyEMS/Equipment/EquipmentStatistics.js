...
const EquipmentStatistics = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  const buildSmartAnalysisContext = useCallback(() => {
    ...
    return {
      reportType: 'equipment_statistics',
    ...
    <Fragment>
      <div>
        <Breadcrumb>
          ...
          <BreadcrumbItem active>{t('Statistics')}</BreadcrumbItem>
        </Breadcrumb>
      </div>
