...
const EquipmentPlan = ({ setRedirect, setRedirectUrl, t }) => {
    ...
    <Fragment>
      <div>
        <Breadcrumb>
          ...
          <BreadcrumbItem active>{t('Plan')}</BreadcrumbItem>
        </Breadcrumb>
      </div>
...
export default withTranslation()(withRedirect(EquipmentPlan));
