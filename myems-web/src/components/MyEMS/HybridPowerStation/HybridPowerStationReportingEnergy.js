...
const HybridPowerStationReportingEnergy = ({ setRedirect, setRedirectUrl, t }) => {
            ...
            .then(json => {
              if (isResponseOK) {
                ...
                if (json[0].length > 0) {
                  ...
                  let url =
                    APIBaseURL +
                    '/reports/hybridpowerstationreportingenergy?' +
                    'id=' +
                    stationID +
                    '&periodtype=' +
                    periodType +
...
export default withTranslation()(withRedirect(HybridPowerStationReportingEnergy));
