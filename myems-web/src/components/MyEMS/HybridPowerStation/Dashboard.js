...
const Dashboard = ({ setRedirect, setRedirectUrl, t }) => {
  ...
  const [isHybridPowerStationsEnergyFetched, setIsHybridPowerStationsEnergyFetched] = useState(false);
  const [isHybridPowerStationsBillingFetched, setIsHybridPowerStationsBillingFetched] = useState(false);
  const [isHybridPowerStationsCarbonFetched, setIsHybridPowerStationsCarbonFetched] = useState(false);
  ...
  useEffect(() => {
    ...
    if (checkEmpty(is_logged_in) || checkEmpty(token) || checkEmpty(user_uuid) || !is_logged_in) {
      ...
      let isResponseOK = false;
      if (!isHybridPowerStationsEnergyFetched) {
        setIsHybridPowerStationsEnergyFetched(true);
        fetch(
  ...
  useEffect(() => {
    ...
    if (checkEmpty(is_logged_in) || checkEmpty(token) || checkEmpty(user_uuid) || !is_logged_in) {
      ...
      let isResponseOK = false;
      if (!isHybridPowerStationsBillingFetched) {
        setIsHybridPowerStationsBillingFetched(true);
        fetch(
  ...
  useEffect(() => {
    ...
    if (checkEmpty(is_logged_in) || checkEmpty(token) || checkEmpty(user_uuid) || !is_logged_in) {
      ...
      let isResponseOK = false;
      if (!isHybridPowerStationsCarbonFetched) {
        setIsHybridPowerStationsCarbonFetched(true);
        fetch(
