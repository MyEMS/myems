...
const resources = {
  en: {
    translation: {
      ...
      'API.API_KEY_NAME_IS_ALREADY_IN_USE': 'Api Key name is already in use',
  ...
  de: {
    translation: {
      ...
      'API.API_KEY_NAME_IS_ALREADY_IN_USE': 'Der API-Schlüssel-Name wird bereits verwendet',
      'API.API_KEY_NOT_FOUND': 'API-Schlüssel nicht gefunden',
      ...
      'API.INVALID_API_KEY_ID': 'Ungültige API-Schlüssel-ID',
      'API.INVALID_API_KEY_NAME': 'Ungültiger API-Schlüssel-Name',
      ...
      'API.INVALID_CREATED_DATETIME': 'Ungültige Erstellungszeit',
      ...
      'API.INVALID_EXPIRES_DATETIME': 'Ungültiges Verfallsdatum',
  ...
  zh_CN: {
    translation: {
      ...
      'API.API_KEY_NAME_IS_ALREADY_IN_USE': '接口密钥名已使用',
      'API.API_KEY_NOT_FOUND': '接口密钥不存在',
      ...
      'API.INVALID_API_KEY_ID': '无效的接口密钥ID',
      'API.INVALID_API_KEY_NAME': '无效的接口密钥名',
      ...
      'API.INVALID_CREATED_DATETIME': "无效的创建时间",
      ...
      'API.INVALID_EXPIRES_DATETIME': '无效的失效时间',
