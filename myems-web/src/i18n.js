...
const resources = {
  en: {
    translation: {
      ...
      'Multiple Energy Storage Power Stations': 'Multiple Energy Storage Power Stations',
      'Multiple Energy Storage Power Stations Dashboard': 'Multiple Energy Storage Power Stations Dashboard',
      'Multiple Energy Storage Power Stations List': 'Multiple Energy Storage Power Stations List',
      'Single Energy Storage Power Station': 'Single Energy Storage Power Station',
      'Single Energy Storage Power Station Dashboard': 'Single Energy Storage Power Station Dashboard',
      'Single Energy Storage Power Station Details': 'Single Energy Storage Power Station Details',
      'Single Energy Storage Power Station Fault Alarm': 'Single Energy Storage Power Station Fault Alarm',
      'Energy Storage Power Station Reports': 'Energy Storage Power Station Reports',
      'Energy Storage Power Station Reports Energy': 'Energy Storage Power Station Reports Energy',
      'Energy Storage Power Station Reports Revenue': 'Energy Storage Power Station Reports Revenue',
      'Energy Storage Power Station Reports Details': 'Energy Storage Power Station Reports Details',
  ...
  zh_CN: {
    translation: {
      ...
      'Energy Storage Power Station Reports Details': '数据分析',
      'Work Order': '工单管理',
      ...
      'API.THERE_IS_RELATION_WITH_ENERGY_STORAGE_CONTAINERS_BATTERIES': '与储能容器电池有关系',
      'API.THERE_IS_RELATION_WITH_ENERGY_STORAGE_CONTAINERS_GRIDS': '与储能容器电网有关系',
      'API.THERE_IS_RELATION_WITH_ENERGY_STORAGE_CONTAINERS_LOADS': '与储能容器负载有关系',
      'API.THERE_IS_RELATION_WITH_ENERGY_STORAGE_CONTAINERS_POWER_CONVERSION_SYSTEMS': '与储能容器电源转换系统有关系',
  ...
  zh_TW: {
    translation: {
      ...
      'Energy Storage Power Station Reports Details': '數據分析',
      'Work Order': '⼯單管理',
    ...
    Please copy it to the input box below.':
      ...
      'API.THERE_IS_RELATION_WITH_ENERGY_FLOW_DIAGRAM_LINKS':
        '與能流圖有關系',
      'API.THERE_IS_RELATION_WITH_ENERGY_STORAGE_CONTAINERS_BATTERIES': '與儲能容器電池有關係',
      'API.THERE_IS_RELATION_WITH_ENERGY_STORAGE_CONTAINERS_GRIDS': '與儲能容器電網有關係',
      'API.THERE_IS_RELATION_WITH_ENERGY_STORAGE_CONTAINERS_LOADS': '與儲能容器負載有關係',
      'API.THERE_IS_RELATION_WITH_ENERGY_STORAGE_CONTAINERS_POWER_CONVERSION_SYSTEMS': '與儲能容器電源轉換系統有關係',
