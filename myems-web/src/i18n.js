...
const resources = {
  ...
  zh_CN: {
    translation: {
      ...
      'API.ADVANCED_REPORT_NOT_FOUND': '高级报告不存在',
      'API.BAD_REQUEST': '错误请求',
      'API.CANNOT_SET_EXISTING_SUBMETER_AS_MASTER_METER': '不能将已存在的分表设置为总表',
      'API.COMBINED_EQUIPMENT_EQUIPMENT_RELATION_EXISTS': '组合设备设备关系已存在',
      'API.COMBINED_EQUIPMENT_EQUIPMENT_RELATION_NOT_FOUND': '组合设备设备关系不存在',
      'API.COMBINED_EQUIPMENT_METER_RELATION_EXISTS': '组合设备计量表关系已存在',
      'API.COMBINED_EQUIPMENT_METER_RELATION_NOT_FOUND': '组合设备计量表关系不存在',
      'API.COMBINED_EQUIPMENT_NAME_IS_ALREADY_IN_USE': '组合设备名称已使用',
      'API.COMBINED_EQUIPMENT_NOT_FOUND': '组合设备不存在',
      'API.COMBINED_EQUIPMENT_OFFLINE_METER_RELATION_EXISTS': '组合设备离线表关系已存在',
      'API.COMBINED_EQUIPMENT_OFFLINE_METER_RELATION_NOT_FOUND': '组合设备离线表关系不存在',
      ...
      'API.COMBINED_EQUIPMENT_VIRTUAL_METER_RELATION_EXISTS': '组合设备虚拟表关系已存在',
      'API.COMBINED_EQUIPMENT_VIRTUAL_METER_RELATION_NOT_FOUND': '组合设备虚拟表关系不存在',
      ...
      'API.DISTRIBUTION_CIRCUIT_NAME_IS_ALREADY_IN_USE': '配电电路名称已使用',
      'API.DISTRIBUTION_CIRCUIT_NOT_FOUND': '配电电路不存在',
      'API.DISTRIBUTION_CIRCUIT_POINT_RELATION_EXISTS': '配电电路点位关系已存在',
      'API.DISTRIBUTION_CIRCUIT_POINT_RELATION_NOT_FOUND': '配电电路点位关系不存在',
      ...
      'API.EQUIPMENT_METER_RELATION_EXISTS': '设备计量表关系已存在',
      'API.EQUIPMENT_METER_RELATION_NOT_FOUND': '设备计量表关系不存在',
      'API.EQUIPMENT_NAME_IS_ALREADY_IN_USE': '设备计量表关系已使用',
      'API.EQUIPMENT_NOT_FOUND': '设备不存在',
      'API.EQUIPMENT_OFFLINE_METER_RELATION_EXISTS': '设备离线表关系已存在',
      'API.EQUIPMENT_OFFLINE_METER_RELATION_NOT_FOUND': '设备离线表关系不存在',
      'API.EQUIPMENT_PARAMETER_NAME_IS_ALREADY_IN_USE': '设备离线表关系已使用',
      'API.EQUIPMENT_PARAMETER_NOT_FOUND_OR_NOT_MATCH': '设备相关参数不存在或不匹配',
      'API.EQUIPMENT_VIRTUAL_METER_RELATION_EXISTS': '设备虚拟表关系已存在',
      'API.EQUIPMENT_VIRTUAL_METER_RELATION_NOT_FOUND': '设备虚拟表关系不存在',
      'API.ERROR': '错误',
      'API.EXCEPTION': '异常',
      ...
      'API.INVALID_DISTRIBUTION_CIRCUIT_ID': '无效的配电电路id',
      'API.INVALID_DISTRIBUTION_CIRCUIT_NAME': '无效的配电电路名称',
      'API.INVALID_DISTRIBUTION_ROOM': '无效的配电房',
      ...
      'API.INVALID_EQUATION_IN_EXPRESSION': '表达式中无效的方程',
      ...
      'API.INVALID_IS_ENABLED': '无效的启用',
      'API.INVALID_IS_HIDDEN': '无效隐藏',
      'API.INVALID_IS_IN_LEASE_VALUE': '无效的租赁值',
      'API.INVALID_IS_INPUT_COUNTED_VALUE': '无效的输入计数值',
      'API.INVALID_IS_KEY_TENANT_VALUE': '无效的租户密钥值',
      'API.INVALID_IS_OUTPUT_COUNTED_VALUE': '无效的输出计数值',
      'API.INVALID_IS_OUTPUT_VALUE': '无效的输出值',
      'API.INVALID_IS_TREND_VALUE': '无效的趋势值',
      'API.INVALID_IS_VIRTUAL_VALUE': '无效的虚拟值',
      'API.INVALID_KGCE': '无效的标准煤',
      'API.INVALID_KGCO2E': '无效的二氧化碳排放',
      ...
      'API.INVALID_NEW_PASSWORD': '新密码无效',
      ...
      'API.INVALID_OLD_PASSWORD': '老密码无效',
      ...
      'API.INVALID_RATIO_VALUE': '无效的广播值',
      ...
      'API.INVALID_ROOMS_VALUE': '无效的空间值',
      'API.INVALID_RULE_ID': '无效的规章id',
      'API.INVALID_RULE_NAME': '无效的规章名称',
      'API.INVALID_SENSOR_ID': '无效的传感器id',
      'API.INVALID_SENSOR_NAME': '无效的传感器名称',
      'API.INVALID_SERIAL_PORT': '无效的串行端口',
      ...
      'API.INVALID_TARIFF_BLOCK_PRICING': '无效的费率分段定价',
      'API.INVALID_TARIFF_ID': '无效的费率id',
      'API.INVALID_TARIFF_TIME_OF_USE_PRICING': '无效的资费使用时间定价',
      ...
      'API.INVALID_VARIABLE_METER_ID': '无效的可变计量表id',
      'API.INVALID_VARIABLE_METER_TYPE': '无效的可变计量表类型',
      ...
      'API.METER_NOT_FOUND': '未找到计量表',
      'API.METER_OF_VARIABLE_NOT_FOUND': '计量表变量不存在',
      'API.METER_POINT_RELATION_EXISTS': '计量表数据点关系已存在',
      'API.METER_POINT_RELATION_NOT_FOUND': '计量表数据点关系不存在',
      'API.NOT_FOUND': '不存在',
      ...
      'API.SENSOR_POINT_RELATION_EXISTS': '传感器数据点关系已存在',
      'API.SENSOR_POINT_RELATION_NOT_FOUND': '传感器数据点关系不存在',
      'API.SHOPFLOOR_EQUIPMENT_RELATION_EXISTS': '车间设备关系已存在',
      'API.SHOPFLOOR_EQUIPMENT_RELATION_NOT_FOUND': '车间设备关系不存在',
      'API.SHOPFLOOR_METER_RELATION_EXISTS': '车间计量表关系已存在',
      'API.SHOPFLOOR_METER_RELATION_NOT_FOUND': '车间计量表关系不存在',
      'API.SHOPFLOOR_NAME_IS_ALREADY_IN_USE': '车间名称已使用',
      'API.SHOPFLOOR_NOT_FOUND': '车间不存在',
      'API.SHOPFLOOR_OFFLINE_METER_RELATION_EXISTS': '车间离线表关系已存在',
      'API.SHOPFLOOR_OFFLINE_METER_RELATION_NOT_FOUND': '车间离线表关系不存在',
      'API.SHOPFLOOR_POINT_RELATION_EXISTS': '车间数据点关系已存在',
      'API.SHOPFLOOR_POINT_RELATION_NOT_FOUND': '车间数据点关系不存在',
      'API.SHOPFLOOR_SENSOR_RELATION_EXISTS': '车间传感器关系已存在',
      'API.SHOPFLOOR_SENSOR_RELATION_NOT_FOUND': '车间传感器关系不存在',
      'API.SHOPFLOOR_VIRTUAL_METER_RELATION_EXISTS': '车间虚拟表关系已存在',
      'API.SHOPFLOOR_VIRTUAL_METER_RELATION_NOT_FOUND': '车间虚拟表关系不存在',
      'API.SOURCE_NODE_NOT_FOUND': '源节点不存在',
      'API.SPACE_COMBINED_EQUIPMENT_RELATION_EXISTS': '空间组合设备关系已存在',
      'API.SPACE_COMBINED_EQUIPMENT_RELATION_NOT_FOUND': '空间组合设备关系不存在',
      'API.SPACE_EQUIPMENT_RELATION_EXISTS': '空间设备关系已存在',
      'API.SPACE_EQUIPMENT_RELATION_NOT_FOUND': '空间设备关系不存在',
      'API.SPACE_METER_RELATION_EXISTS': '空间计量表关系已存在',
      'API.SPACE_METER_RELATION_NOT_FOUND': '空间计量表关系不存在',
      'API.SPACE_NAME_IS_ALREADY_IN_USE': '空间名称已使用',
      'API.SPACE_NOT_FOUND': '空间不存在',
      'API.SPACE_NOT_FOUND_IN_PRIVILEGE': '没有权限空间',
      'API.SPACE_OFFLINE_METER_RELATION_EXISTS': '空间离线表关系已存在',
      'API.SPACE_OFFLINE_METER_RELATION_NOT_FOUND': '空间离线表关系不存在',
      'API.SPACE_POINT_RELATION_EXISTS': '空间数据点关系已存在',
      'API.SPACE_POINT_RELATION_NOT_FOUND': '空间数据点关系不存在',
      'API.SPACE_SENSOR_RELATION_EXISTS': '空间传感器关系已存在',
      'API.SPACE_SENSOR_RELATION_NOT_FOUND': '空间传感器关系不存在',
      'API.SPACE_SHOPFLOOR_RELATION_EXISTS': '空间车间关系已存在',
      'API.SPACE_SHOPFLOOR_RELATION_NOT_FOUND': '空间车间关系不存在',
      'API.SPACE_STORE_RELATION_EXISTS': '空间门店关系已存在',
      'API.SPACE_STORE_RELATION_NOT_FOUND': '空间门店关系不存在',
      'API.SPACE_TENANT_RELATION_EXISTS': '空间租户关系已存在',
      'API.SPACE_TENANT_RELATION_NOT_FOUND': '空间租户关系不存在',
      'API.SPACE_VIRTUAL_METER_RELATION_EXISTS': '空间虚拟表关系已存在',
      'API.SPACE_VIRTUAL_METER_RELATION_NOT_FOUND': '空间虚拟表关系不存在',
      'API.START_DATETIME_MUST_BE_EARLIER_THAN_END_DATETIME': '开始日期时间必须早于结束日期时间',
      'API.STORE_METER_RELATION_EXISTS': '门店计量表关系已存在',
      'API.STORE_METER_RELATION_NOT_FOUND': '门店计量表关系不存在',
      'API.STORE_NAME_IS_ALREADY_IN_USE': '门店名称已使用',
      'API.STORE_NOT_FOUND': '门店不存在',
      'API.STORE_OFFLINE_METER_RELATION_EXISTS': '门店离线表关系已存在',
      'API.STORE_OFFLINE_METER_RELATION_NOT_FOUND': '门店离线表关系不存在',
      'API.STORE_POINT_RELATION_EXISTS': '门店数据点关系已存在',
      'API.STORE_POINT_RELATION_NOT_FOUND': '门店数据点关系不存在',
      'API.STORE_SENSOR_RELATION_EXISTS': '门店传感器关系已存在',
      ...
      'API.STORE_VIRTUAL_METER_RELATION_EXISTS': '门店虚拟表关系已存在',
      'API.STORE_VIRTUAL_METER_RELATION_NOT_FOUND': '门店虚拟表关系不存在',
      ...
      'API.TENANT_METER_RELATION_EXISTS': '租户计量表关系已存在',
      'API.TENANT_METER_RELATION_NOT_FOUND': '租户计量表关系不存在',
      'API.TENANT_NAME_IS_ALREADY_IN_USE': '租户名称已使用',
      'API.TENANT_NOT_FOUND': '租户不存在',
      'API.TENANT_OFFLINE_METER_RELATION_EXISTS': '租户离线表关系已存在',
      'API.TENANT_OFFLINE_METER_RELATION_NOT_FOUND': '租户离线表关系不存在',
      'API.TENANT_POINT_RELATION_EXISTS': '租户数据点关系已存在',
      'API.TENANT_POINT_RELATION_NOT_FOUND': '租户数据点关系不存在',
      'API.TENANT_SENSOR_RELATION_EXISTS': '租户传感器关系已存在',
      'API.TENANT_SENSOR_RELATION_NOT_FOUND': '租户传感器关系不存在',
      'API.TENANT_TYPE_NAME_IS_ALREADY_IN_USE': '租户类型名称已使用',
      ...
      'API.TENANT_VIRTUAL_METER_RELATION_EXISTS': '租户虚拟表关系已存在',
      'API.TENANT_VIRTUAL_METER_RELATION_NOT_FOUND': '租户虚拟表关系不存在',
      'API.TEXT_MESSAGE_NOT_FOUND': '未找到短信',
      'API.THE_REPORTING_PERIOD_MUST_BE_LONGER_THAN_15_MINUTES': '报告期必须大于15分钟',
      'API.THERE_IS_ASSOCIATED_DISTRIBUTION_CIRCUITS': '相关的配电电路',
      ...
      'API.THERE_IS_RELATION_WITH_METERS': '与多个记录表有关系',
      ...
      'API.THIS_SPACE_CANNOT_BE_DELETED': '该空间不能被删除',
      ...
      'API.VIRTUAL_POINT_SHOULD_BE_ANALOG_VALUE': '虚拟数据点应该是模拟值',
