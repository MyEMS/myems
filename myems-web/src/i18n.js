...
const resources = {
  en: {
    translation: {
      ...
      'Energy Storage Power Station Reports Parameters': 'Energy Storage Power Station Reports Parameters',
      ...
      'API.VIRTUAL_POINT_CAN_NOT_BE_DIGITAL_VALUE': 'Virtual point can not be digital value',
  ...
  zh_CN: {
    translation: {
      ...
      'API.VIRTUAL_POINT_CAN_NOT_BE_DIGITAL_VALUE': '虚拟数据点不能是数字量',
  ...
  de: {
    translation: {
      ...
      'API.VIRTUAL_POINT_CAN_NOT_BE_DIGITAL_VALUE': 'Virtueller Punkt kann kein digitaler Wert sein',
  ...
  zh_TW: {
    ...
    Please copy it to the input box below.':
      ...
      'API.VIRTUAL_POINT_CAN_NOT_BE_DIGITAL_VALUE': '虛擬點不能是數位值',
