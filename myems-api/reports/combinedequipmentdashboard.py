...
class Reporting:
    ...
    # Step 7: Query combined equipment statistics (meters, associated equipments, alerts)
    # Step 8: Query top consuming combined equipments
    ...
    def on_get(req, resp):
        ...
        try:
            ...
            ################################################################################################################
            # Step 8: Query top 5 consuming combined equipments
            ################################################################################################################
