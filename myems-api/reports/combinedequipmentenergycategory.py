"""
Combined Equipment Energy Category Report API

This module provides REST API endpoints for generating combined equipment energy category reports.
...
import docxexporters.combinedequipmentenergycategory
import pdfexporters.combinedequipmentenergycategory
    ...
    def on_get(req, resp):
        ...
        if config.redis.get('is_enabled'):
            try:
                ...
                cache_key = 'report:combinedequipmentenergycategory:' + \
            ...
            if is_export_docx:
                try:
                    result['docx_bytes_base64'] = \
                        docxexporters.combinedequipmentenergycategory.export(result,
                                                                             combined_equipment['name'],
                                                                             base_period_start_datetime_local,
                                                                             base_period_end_datetime_local,
                                                                             reporting_period_start_datetime_local,
            ...
            if is_export_pdf:
                try:
                    result['pdf_bytes_base64'] = \
                        pdfexporters.combinedequipmentenergycategory.export(result,
                                                                    combined_equipment['name'],
                                                                    base_period_start_datetime_local,
                                                                    base_period_end_datetime_local,
                                                                    reporting_period_start_datetime_local,
