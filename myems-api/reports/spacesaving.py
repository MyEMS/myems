...
import pdfexporters.spacesaving
import docxexporters.spacesaving
...
class Reporting:
    ...
    def on_get(req, resp):
        ...
        if not is_quick_mode:
            ...
            if is_export_pdf:
                try:
                    result['pdf_bytes_base64'] = pdfexporters.spacesaving.export(result,
                                                                                 space['name'],
                                                                                 base_period_start_datetime_local,
                                                                                 base_period_end_datetime_local,
                                                                                 reporting_period_start_datetime_local,
            ...
            if is_export_docx:
                try:
                    result['docx_bytes_base64'] = docxexporters.spacesaving.export(result,
                                                                                    space['name'],
                                                                                    base_period_start_datetime_local,
                                                                                    base_period_end_datetime_local,
                                                                                    reporting_period_start_datetime_local,
