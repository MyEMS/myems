...
class Reporting:
    ...
    def on_get(req, resp):
        ...
        # Create connections and cursors in outer try block
        cnx_user_db = None
                ...
                if rows_microgrids is not None and len(rows_microgrids) > 0:
                    for row in rows_microgrids:
                        ...
                        if is_online:
                            ...
                            if row_point is not None and len(row_point) > 0:
                                if digital_value_latest_dict.get(row_point[0]) is not None:
                                    pcs_run_state_point_value = digital_value_latest_dict.get(
                        ...
                        if is_online:
                            ...
                            if row_point is not None and len(row_point) > 0:
                                if digital_value_latest_dict.get(row_point[0]) is not None:
                                    battery_state_point_value = digital_value_latest_dict.get(
                                        row_point[0])['actual_value']
                        ...
                        if is_online:
                            ...
                            if row_point is not None and len(row_point) > 0:
                                ...
                                if analog_value_latest_dict.get(row_point[1]) is not None:
                                    battery_power_point_value = analog_value_latest_dict.get(
                                        row_point[1])['actual_value']
                        ...
                        if is_online:
                            ...
                            if row_point is not None and len(row_point) > 0:
                                if analog_value_latest_dict.get(row_point[0]) is not None:
                                    photovoltaic_power_point_value = analog_value_latest_dict.get(
                                        row_point[0])['actual_value']
