...
import pdfexporters.shopfloorcomparison
    ...
    def on_get(req, resp):
        ...
        if config.redis.get('is_enabled'):
            try:
                ...
                cache_params = {
                    "shopfloorid1": shopfloor_id1,
                    "shopflooruuid1": shopfloor_uuid1,
                    "shopfloorid2": shopfloor_id2,
                    "shopflooruuid2": shopfloor_uuid2,
        ...
        if not is_quick_mode:
            ...
            if is_export_pdf:
                result["pdf_bytes_base64"] = pdfexporters.shopfloorcomparison.export(
                    result,
                    shopfloor1["name"],
                    shopfloor2["name"],
                    energy_category["name"],
