"""
Virtual Meter Plan Report API

This module provides REST API endpoints for generating virtual meter plan reports.
It analyzes virtual meter planning data and performance against planned targets,
providing insights into plan execution and optimization opportunities.

Key Features:
- Virtual meter plan analysis
...
import pdfexporters.virtualmeterplan
import docxexporters.virtualmeterplan
    ...
    def on_get(req, resp):
        ...
        if config.redis.get('is_enabled'):
            try:
                ...
                cache_key = 'report:virtualmeterplan:' + hashlib.sha256(cache_params_json.encode('utf-8')).hexdigest()
        ...
        if not is_quick_mode:
            ...
            if is_export_pdf:
                result['pdf_bytes_base64'] = \
                    pdfexporters.virtualmeterplan.export(result,
                                                         virtual_meter['name'],
                                                         base_period_start_datetime_local,
                                                         base_period_end_datetime_local,
                                                         reporting_period_start_datetime_local,
            ...
            if is_export_docx:
                result['docx_bytes_base64'] = \
                    docxexporters.virtualmeterplan.export(result,
                                                          virtual_meter['name'],
                                                          base_period_start_datetime_local,
                                                          base_period_end_datetime_local,
                                                          reporting_period_start_datetime_local,
