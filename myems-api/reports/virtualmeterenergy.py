...
import pdfexporters.virtualmeterenergy
import docxexporters.virtualmeterenergy
        ...
        if not is_quick_mode:
            ...
            if is_export_pdf:
                result['pdf_bytes_base64'] = \
                    pdfexporters.virtualmeterenergy.export(result,
                                                           virtual_meter['name'],
                                                           base_period_start_datetime_local,
                                                           base_period_end_datetime_local,
                                                           reporting_period_start_datetime_local,
            ...
            if is_export_docx:
                result['docx_bytes_base64'] = \
                    docxexporters.virtualmeterenergy.export(result,
                                                            virtual_meter['name'],
                                                            base_period_start_datetime_local,
                                                            base_period_end_datetime_local,
                                                            reporting_period_start_datetime_local,
