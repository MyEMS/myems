"""
Meter Carbon Report API

This module provides REST API endpoints for generating meter carbon emissions reports.
It analyzes carbon dioxide emissions from meter readings, providing insights
...
import docxexporters.metercarbon
        ...
        if not is_quick_mode:
            ...
            if is_export_docx:
                result['docx_bytes_base64'] = \
                    docxexporters.metercarbon.export(result,
                                                     meter['name'],
                                                     base_period_start_datetime_local,
                                                     base_period_end_datetime_local,
                                                     reporting_period_start_datetime_local,
