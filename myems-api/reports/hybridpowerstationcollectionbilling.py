...
class Reporting:
    ...
    # Step 5: query fuel billing data in 7 days
    # Step 6: query charge billing data in this month
    # Step 7: query discharge billing data in this month
    # Step 8: query fuel billing data in this month
    # Step 9: query charge billing data in this year
    # Step 10: query discharge billing data in this year
    # Step 11: query fuel billing data in this year
    ...
    def on_get(req, resp):
        ...
        for hybrid_power_station in hybrid_power_station_list:
            ...
            cursor_billing_db.execute(query, (hybrid_power_station['id'], start_datetime_utc, end_datetime_utc))
        ...
        for hybrid_power_station in hybrid_power_station_list:
            ...
            query = (" SELECT start_datetime_utc, actual_value "
                     ...
                     " ORDER BY start_datetime_utc ")
            cursor_billing_db.execute(query, (hybrid_power_station['id'], start_datetime_utc, end_datetime_utc))
            rows_fuel_hourly = cursor_billing_db.fetchall()
