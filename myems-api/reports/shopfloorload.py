"""
Shop Floor Load Report API

This module provides REST API endpoints for generating shop floor load reports.
It analyzes shop floor load patterns and capacity utilization to provide
