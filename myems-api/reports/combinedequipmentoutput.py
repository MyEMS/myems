"""
Combined Equipment Output Report API

This module provides REST API endpoints for generating combined equipment output reports.
It analyzes combined equipment output performance and production metrics to provide
...
import docxexporters.combinedequipmentoutput
import pdfexporters.combinedequipmentoutput
    ...
    def on_get(req, resp):
        ...
        if config.redis.get('is_enabled'):
            try:
                ...
                cache_key = 'report:combinedequipmentoutput:' + \
            ...
            if is_export_docx:
                try:
                    result['docx_bytes_base64'] = \
                        docxexporters.combinedequipmentoutput.export(result,
                                                                     combined_equipment['name'],
                                                                     base_period_start_datetime_local,
                                                                     base_period_end_datetime_local,
                                                                     reporting_period_start_datetime_local,
            ...
            if is_export_pdf:
                try:
                    result['pdf_bytes_base64'] = \
                        pdfexporters.combinedequipmentoutput.export(result,
                                                                    combined_equipment['name'],
                                                                    base_period_start_datetime_local,
                                                                    base_period_end_datetime_local,
                                                                    reporting_period_start_datetime_local,
