...
import pdfexporters.spacecarbon
import docxexporters.spacecarbon
        ...
        if not is_quick_mode:
            if is_export_excel:
                result['excel_bytes_base64'] = \
                    excelexporters.spacecarbon.export(result,
                                                     space['name'],
            ...
            if is_export_pdf:
                result['pdf_bytes_base64'] = \
                    pdfexporters.spacecarbon.export(result,
                                                    space['name'],
                                                    base_period_start_datetime_local,
                                                    base_period_end_datetime_local,
                                                    reporting_period_start_datetime_local,
            ...
            if is_export_docx:
                result['docx_bytes_base64'] = \
                    docxexporters.spacecarbon.export(result,
                                                     space['name'],
                                                     base_period_start_datetime_local,
                                                     base_period_end_datetime_local,
                                                     reporting_period_start_datetime_local,
