...
import pdfexporters.virtualmetercomparison
import docxexporters.virtualmetercomparison
    ...
    def on_get(req, resp):
        ...
        if config.redis.get('is_enabled'):
            try:
                ...
                cache_params = {
                    "virtualmeterid1": virtual_meter_id1,
                    "virtualmeteruuid1": virtual_meter_uuid1,
                    "virtualmeterid2": virtual_meter_id2,
                    "virtualmeteruuid2": virtual_meter_uuid2,
        ...
        if not is_quick_mode:
            ...
            if is_export_pdf:
                result['pdf_bytes_base64'] = \
                    pdfexporters.virtualmetercomparison.export(result,
                                                               virtual_meter1['name'],
                                                               virtual_meter2['name'],
                                                               reporting_period_start_datetime_local,
                                                               reporting_period_end_datetime_local,
            ...
            if is_export_docx:
                result['docx_bytes_base64'] = \
                    docxexporters.virtualmetercomparison.export(result,
                                                                virtual_meter1['name'],
                                                                virtual_meter2['name'],
                                                                reporting_period_start_datetime_local,
                                                                reporting_period_end_datetime_local,
