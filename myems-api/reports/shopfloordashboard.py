...
class Reporting:
    ...
    # Step 7: Query shopfloor statistics (meters, sensors, alerts)
    # Step 8: Query top consuming shopfloors
    ...
    def on_get(req, resp):
        ...
        try:
            ...
            reporting_cost = {
                ...
                'increment_rates': [0.0] * len(reporting_input['names']),
                'timestamps': [],
                'values': []
            }
            ...
            ################################################################################################################
            # Step 7: Query shopfloor statistics
            ################################################################################################################
            # Count meters
            total_meters = 0
            total_sensors = 0
            ...
            ################################################################################################################
            # Step 8: Query top 5 consuming shopfloors and all shopfloors energy by category
            ################################################################################################################
            top_shopfloors = []
