...
class Reporting:
    ...
    def on_get(req, resp, id_):
        ...
        cursor_system.execute(" SELECT id, name, uuid, "
                              " operating_status_point_id, active_power_point_id, reactive_power_point_id, "
                              " daily_power_generation_point_id, total_power_generation_point_id, "
                              " ambient_temperature_point_id, core_heatsink_temperature_point_id "
