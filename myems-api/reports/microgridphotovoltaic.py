        ...
        try:
            ...
            try:
                ...
                for microgrid in microgrid_list:
                    ...
                    rows_photovoltaic_periodically = utilities.aggregate_hourly_data_by_period(
                        rows_photovoltaic_hourly,
                        start_datetime_utc,
                        end_datetime_utc,
                        period_type)
                    for row_photovoltaic_periodically in rows_photovoltaic_periodically:
                        ...
                        actual_value = Decimal(0.0) if row_photovoltaic_periodically[1] is None \
                            else row_photovoltaic_periodically[1]
