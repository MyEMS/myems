"""
Offline Meter Prediction Report API

This module provides REST API endpoints for generating Offline Meter prediction reports.
It analyzes energy prediction for Offline Meter, providing insights into future energy usage.
...
import config
import excelexporters.offlinemeterprediction
import docxexporters.offlinemeterprediction
    ...
    def on_get(req, resp):
        ...
        if config.redis.get('is_enabled'):
            try:
                ...
                cache_key = 'report:offlinemeterenergy:' + hashlib.sha256(cache_params_json.encode('utf-8')).hexdigest()
        ...
        if not is_quick_mode:
            ...
            if is_export_docx:
                result['docx_bytes_base64'] = docxexporters.offlinemeterprediction.export(
                    result,
                    offline_meter['name'],
                    base_period_start_datetime_local,
                    base_period_end_datetime_local,
