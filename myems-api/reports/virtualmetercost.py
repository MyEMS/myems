"""
Virtual Meter Cost Report API

This module provides REST API endpoints for generating virtual meter cost reports.
It analyzes energy costs associated with virtual meter readings, providing insights
into cost optimization opportunities and financial performance metrics.

Key Features:
- Virtual meter energy cost analysis
...
Report Components:
- Virtual meter energy cost summary
...
import pdfexporters.virtualmetercost
import docxexporters.virtualmetercost
    ...
    def on_get(req, resp):
        ...
        if config.redis.get('is_enabled'):
            try:
                ...
                cache_params = {
                    "virtualmeterid": virtual_meter_id,
                    "virtualmeteruuid": virtual_meter_uuid,
                ...
                cache_key = 'report:virtualmetercost:' + hashlib.sha256(cache_params_json.encode('utf-8')).hexdigest()
        ...
        try:
            ...
            try:
                ...
                query = (" SELECT start_datetime_utc, actual_value "
                         ...
                         " AND start_datetime_utc < %s "
                         " ORDER BY start_datetime_utc ")
                cursor_billing.execute(query, (virtual_meter['id'],
        ...
        if not is_quick_mode:
            ...
            if is_export_pdf:
                result['pdf_bytes_base64'] = \
                    pdfexporters.virtualmetercost.export(result,
                                                         virtual_meter['name'],
                                                         base_period_start_datetime_local,
                                                         base_period_end_datetime_local,
                                                         reporting_period_start_datetime_local,
            ...
            if is_export_docx:
                result['docx_bytes_base64'] = \
                    docxexporters.virtualmetercost.export(result,
                                                          virtual_meter['name'],
                                                          base_period_start_datetime_local,
                                                          base_period_end_datetime_local,
                                                          reporting_period_start_datetime_local,
