...
class Reporting:
    ...
    def on_get(req, resp):
        ...
        # Step 2: query the energy storage power station
        ################################################################################################################
        cnx_system = cursor_system = None
        cnx_energy = cursor_energy = None
        cnx_billing = cursor_billing = None
        cnx_historical = cursor_historical = None
        try:
            ...
            for cur in (cursor_historical, cursor_billing, cursor_energy, cursor_system):
                try:
                    if cur is not None:
                        cur.close()
