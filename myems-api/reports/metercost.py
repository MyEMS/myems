"""
Meter Cost Report API

This module provides REST API endpoints for generating meter cost reports.
It analyzes energy costs associated with meter readings, providing insights
into cost optimization opportunities and financial performance metrics.

Key Features:
- Meter energy cost analysis
...
import pdfexporters.metercost
import docxexporters.metercost
    ...
    def on_get(req, resp):
        ...
        if config.redis.get('is_enabled'):
            try:
                ...
                cache_key = 'report:metercost:' + hashlib.sha256(cache_params_json.encode('utf-8')).hexdigest()
        ...
        if not is_quick_mode:
            ...
            if is_export_pdf:
                result['pdf_bytes_base64'] = \
                    pdfexporters.metercost.export(result,
                                                  meter['name'],
                                                  base_period_start_datetime_local,
                                                  base_period_end_datetime_local,
                                                  reporting_period_start_datetime_local,
            ...
            if is_export_docx:
                result['docx_bytes_base64'] = \
                    docxexporters.metercost.export(result,
                                                   meter['name'],
                                                   base_period_start_datetime_local,
                                                   base_period_end_datetime_local,
                                                   reporting_period_start_datetime_local,
