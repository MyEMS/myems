"""
Equipment Batch Report API

This module provides REST API endpoints for generating equipment batch reports.
It analyzes energy consumption data for multiple equipment within a space hierarchy,
providing comprehensive insights into equipment performance and energy usage patterns.
...
Report Components:
- Equipment energy consumption summary
- Space-based equipment grouping
...
- Database queries for equipment data
