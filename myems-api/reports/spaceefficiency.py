...
import pdfexporters.spaceefficiency
import docxexporters.spaceefficiency
        ...
        if not is_quick_mode:
            if is_export_excel:
                result['excel_bytes_base64'] = excelexporters.spaceefficiency.export(result,
                                                                                     ...
                                                                                     language)
            if is_export_pdf:
                result['pdf_bytes_base64'] = pdfexporters.spaceefficiency.export(result,
                                                                                space['name'],
                                                                                base_period_start_datetime_local,
                                                                                base_period_end_datetime_local,
                                                                                reporting_period_start_datetime_local,
                                                                                ...
                                                                                language)
            if is_export_docx:
                result['docx_bytes_base64'] = docxexporters.spaceefficiency.export(result,
                                                                                   space['name'],
                                                                                   base_period_start_datetime_local,
                                                                                   base_period_end_datetime_local,
                                                                                   reporting_period_start_datetime_local,
