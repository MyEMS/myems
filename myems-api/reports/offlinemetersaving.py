"""
Offline Meter Saving Report API

This module provides REST API endpoints for generating offline meter saving reports.
It analyzes energy savings achieved through offline meter optimization and efficiency
...
import pdfexporters.offlinemetersaving
import docxexporters.offlinemetersaving
    ...
    def on_get(req, resp):
        ...
        if config.redis.get('is_enabled'):
            try:
                ...
                cache_key = 'report:offlinemetersaving:' + hashlib.sha256(cache_params_json.encode('utf-8')).hexdigest()
        ...
        if not is_quick_mode:
            ...
            if is_export_pdf:
                result['pdf_bytes_base64'] = \
                    pdfexporters.offlinemetersaving.export(result,
                                                           offline_meter['name'],
                                                           base_period_start_datetime_local,
                                                           base_period_end_datetime_local,
                                                           reporting_period_start_datetime_local,
            ...
            if is_export_docx:
                result['docx_bytes_base64'] = \
                    docxexporters.offlinemetersaving.export(result,
                                                            offline_meter['name'],
                                                            base_period_start_datetime_local,
                                                            base_period_end_datetime_local,
                                                            reporting_period_start_datetime_local,
