"""
Space Income Report API

This module provides REST API endpoints for generating space income reports.
It analyzes revenue generation from space energy operations, providing insights
...
import pdfexporters.spaceincome
import docxexporters.spaceincome
        ...
        if not is_quick_mode:
            if is_export_excel:
                result['excel_bytes_base64'] = excelexporters.spaceincome.export(result,
                                                                                 ...
                                                                                 language)
            if is_export_pdf:
                result['pdf_bytes_base64'] = pdfexporters.spaceincome.export(result,
                                                                            space['name'],
                                                                            base_period_start_datetime_local,
                                                                            base_period_end_datetime_local,
                                                                            reporting_period_start_datetime_local,
                                                                            ...
                                                                            language)
            if is_export_docx:
                result['docx_bytes_base64'] = docxexporters.spaceincome.export(result,
                                                                               space['name'],
                                                                               base_period_start_datetime_local,
                                                                               base_period_end_datetime_local,
                                                                               reporting_period_start_datetime_local,
