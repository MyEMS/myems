"""
Energy Storage Power Station Dashboard Report API

This module provides REST API endpoints for generating comprehensive energy storage power station dashboard reports.
It aggregates data from multiple sources including energy storage power stations, energy categories, sensors,
and child spaces to provide a complete overview of energy storage performance and system status.

Key Features:
- Multi-energy storage power station analysis
...
Report Components:
- Energy storage power station performance analysis
...
class Reporting:
    ...
    def on_get(req, resp):
        ...
        ################################################################################################################
        # Step 3 & 4: query charge/discharge energy data
        ################################################################################################################
        ...
        ################################################################################################################
        # Step 5 & 6: query charge/discharge billing data
        ################################################################################################################
        ...
        ################################################################################################################
        # Step 7 & 8: query charge/discharge carbon data
        ################################################################################################################
