"""
Combined Equipment Income Report API

This module provides REST API endpoints for generating combined equipment income reports.
It analyzes revenue generation from combined equipment operations, providing insights
...
Report Components:
- Combined equipment income summary
...
import docxexporters.combinedequipmentincome
import pdfexporters.combinedequipmentincome
...
class Reporting:
    ...
    # Step 6: query base period energy income
    # Step 7: query reporting period energy income
    # Step 8: query tariff data
    # Step 9: query associated points data
    # Step 10: query associated equipments energy income
    ...
    def on_get(req, resp):
        ...
        if config.redis.get('is_enabled'):
            try:
                ...
                cache_key = 'report:combinedequipmentincome:' + \
            ...
            if is_export_excel:
                try:
                    result['excel_bytes_base64'] = \
                        excelexporters.combinedequipmentincome.export(result,
            ...
            if is_export_docx:
                try:
                    result['docx_bytes_base64'] = \
                        docxexporters.combinedequipmentincome.export(result,
                                                                     combined_equipment['name'],
                                                                     base_period_start_datetime_local,
                                                                     base_period_end_datetime_local,
                                                                     reporting_period_start_datetime_local,
            ...
            if is_export_pdf:
                try:
                    result['pdf_bytes_base64'] = \
                        pdfexporters.combinedequipmentincome.export(result,
                                                                    combined_equipment['name'],
                                                                    base_period_start_datetime_local,
                                                                    base_period_end_datetime_local,
                                                                    reporting_period_start_datetime_local,
