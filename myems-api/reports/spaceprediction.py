...
import pdfexporters.spaceprediction
import docxexporters.spaceprediction
            ...
            if is_export_pdf:
                try:
                    result['pdf_bytes_base64'] = \
                        pdfexporters.spaceprediction.export(result,
                                                            space['name'],
                                                            base_period_start_datetime_local,
                                                            base_period_end_datetime_local,
                                                            reporting_period_start_datetime_local,
            ...
            if is_export_docx:
                try:
                    result['docx_bytes_base64'] = \
                        docxexporters.spaceprediction.export(result,
                                                             space['name'],
                                                             base_period_start_datetime_local,
                                                             base_period_end_datetime_local,
                                                             reporting_period_start_datetime_local,
