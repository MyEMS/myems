...
import pdfexporters.equipmentsaving
import docxexporters.equipmentsaving
    ...
    def on_get(req, resp):
        ...
        if config.redis.get('is_enabled'):
            try:
                ...
                cache_key = 'report:equipmentsaving:' + hashlib.sha256(cache_params_json.encode('utf-8')).hexdigest()
        ...
        try:
            # Establish all connections in the outer try block
            ...
            try:
                # Create all cursors in the inner try block
        ...
        if not is_quick_mode:
            if is_export_excel:
                result['excel_bytes_base64'] = excelexporters.equipmentsaving.export(
                    result,
                    equipment['name'],
            ...
            if is_export_pdf:
                result['pdf_bytes_base64'] = \
                    pdfexporters.equipmentsaving.export(result,
                                                        equipment['name'],
                                                        base_period_start_datetime_local,
                                                        base_period_end_datetime_local,
                                                        reporting_period_start_datetime_local,
            ...
            if is_export_docx:
                result['docx_bytes_base64'] = \
                    docxexporters.equipmentsaving.export(result,
                                                         equipment['name'],
                                                         base_period_start_datetime_local,
                                                         base_period_end_datetime_local,
                                                         reporting_period_start_datetime_local,
