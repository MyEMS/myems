...
import pdfexporters.metertracking
import docxexporters.metertracking
...
class Reporting:
    ...
    def on_get(req, resp):
        ...
        # export to Excel file only when explicitly requested
        ...
        # export to PDF file only when explicitly requested
        is_export_pdf = False
        ...
        if not is_quick_mode:
            ...
            if is_export_pdf:
                result['pdf_bytes_base64'] = \
                    pdfexporters.metertracking.export(result,
                                                      space_name,
                                                      energy_category_name,
                                                      reporting_period_start_datetime_local,
                                                      reporting_period_end_datetime_local,
            ...
            if is_export_docx:
                result['docx_bytes_base64'] = \
                    docxexporters.metertracking.export(result,
                                                       space_name,
                                                       energy_category_name,
                                                       reporting_period_start_datetime_local,
                                                       reporting_period_end_datetime_local,
