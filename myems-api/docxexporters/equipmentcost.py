    ...
    def _add_detailed_data_charts_section(self, doc):
        ...
        for i in range(num_categories):
            ...
            if not is_base:
                ...
                for page in range(num_pages):
                    ...
                    col_headers = [_('Datetime'), names[i] + ' ' + _('Reporting Period Costs') + value_unit]
                ...
                for page in range(num_pages):
                    ...
                    col_headers = [
                        ...
                        _('Base Period') + ' - ' + names[i] + ' ' + _('Base Period Costs') + value_unit,
                        _('Reporting Period') + ' - ' + _('Datetime'),
                        _('Reporting Period') + ' - ' + names[i] + ' ' + _('Reporting Period Costs') + value_unit
                    ]
                    table_data = [col_headers]
                    for t_idx in range(start_row, end_row):
        ...
        for i in range(num_categories):
            ...
            if not is_base:
                ...
                ax.set_title(_('Reporting Period Costs') + ' - ' + names[i] + value_unit,
                ...
                base_prefix = _('Base Period Costs')
                report_prefix = _('Reporting Period Costs')
                fig, ax = plt.subplots(figsize=(fig_w, fig_h))
