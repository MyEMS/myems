"""
Space Saving DOCX Exporter

This module provides functionality to export space saving data to DOCX format.
...
- Cover page with logo and report metadata (Space Data - Saving Analysis)
...
class SpaceSavingDOCXExporter:
    """
    Export space saving data to DOCX format.
...
def export(report,
    ...
    """
    exporter = SpaceSavingDOCXExporter(language)
