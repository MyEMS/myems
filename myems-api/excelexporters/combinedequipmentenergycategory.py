    ...
    for associated_reporting_period_data in associated_reporting_period_data_list:
        ...
        if "timestamps" not in associated_reporting_period_data.keys() or \
            ...
            ws['B' + str(current_row_number)] = \
                associated_reporting_period_data['associated_equipment_name'] + \
                ' ' + _('Detailed Data')
            ...
            if has_data:
                ...
                for i in range(0, ca_len):
                    ...
                    for j in range(0, time_len):
                        ...
                        ws[col + row].font = title_font
                        ws[col + row].alignment = c_c_alignment
                        ws[col + row] = round2(associated_reporting_period_data['values'][i][j], 2)
                        ws[col + row].border = f_border
                ...
                for i in range(0, ca_len):
                    ...
                    ws[col + str(current_row_number)].alignment = c_c_alignment
                    ws[col + str(current_row_number)].border = f_border
                    ws[col + str(current_row_number)] = round2(associated_reporting_period_data['subtotals'][i], 2)
