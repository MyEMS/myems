"""
Equipment Plan Excel Exporter

This module provides functionality to export equipment plan data to Excel format.
...
Key Features:
- Equipment plan vs actual analysis
