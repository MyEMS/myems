"""
Combined Equipment Plan Excel Exporter

This module provides functionality to export combined equipment plan data to Excel format.
...
Key Features:
- Combined equipment plan vs actual analysis
...
def generate_excel(report,
    ...
    wb = Workbook()
    ws = wb.active
    ws.title = "CombinedEquipmentPlan"
