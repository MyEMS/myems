"""
Store Cost Excel Exporter

This module provides functionality to export store cost data to Excel format.
It generates comprehensive reports showing cost analysis for stores
