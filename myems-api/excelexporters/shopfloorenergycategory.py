"""
Shop Floor Energy Category Excel Exporter

This module provides functionality to export shop floor energy category data to Excel format.
...
Key Features:
- Shop floor energy consumption by category
