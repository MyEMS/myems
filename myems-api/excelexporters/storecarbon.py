"""
Store Carbon Excel Exporter

This module provides functionality to export store carbon emissions data to Excel format.
It generates comprehensive reports showing carbon dioxide emissions for stores
