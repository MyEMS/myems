"""
Tenant Energy Item Excel Exporter

This module provides functionality to export tenant energy item data to Excel format.
...
Key Features:
- Tenant energy consumption by energy items
