"""
Shop Floor Prediction Report API

This module provides REST API endpoints for generating Shop Floor prediction reports.
It analyzes Shop Floor prediction for equipment, providing insights into future Shop Floor usage.

Key Features:
- Shop Floor prediction analysis
...
def generate_excel(report,
    ...
    ####################################################################################################################
    # Second: Electricity Prediction by Time-Of-Use
    # 13: title
    # 14: table title
    # 15~18 table_data
    # Total: 6 rows
    ...
    if "toppeaks" not in reporting_period_data.keys() or \
        ...
        ws['B13'] = name + ' ' + _('Electricity Prediction by Time-Of-Use')
        ...
        ws['C14'] = _('Electricity Prediction by Time-Of-Use')
        ...
        pie = PieChart()
        pie.title = name + ' ' + _('Electricity Prediction by Time-Of-Use')
    ...
    if "non_working_days_subtotals" not in report['base_period'].keys() or \
        ...
        ws['B' + str(current_row_number)].font = title_font
        ws['B' + str(current_row_number)] = name + ' ' + _('Base Period Prediction')
        ...
        ws['C' + str(current_row_number)].alignment = c_c_alignment
        ws['C' + str(current_row_number)].border = f_border
        ws['C' + str(current_row_number)] = _('Non Working Days') + _('Prediction')

        ws['D' + str(current_row_number)].fill = table_fill
        ws['D' + str(current_row_number)].font = name_font
        ws['D' + str(current_row_number)].alignment = c_c_alignment
        ws['D' + str(current_row_number)].border = f_border
        ws['D' + str(current_row_number)] = _('Working Days') + _('Prediction')
    ...
    if "non_working_days_subtotals" not in report['reporting_period'].keys() or \
        ...
        ws['B' + str(current_row_number)].font = title_font
        ws['B' + str(current_row_number)] = name + ' ' + _('Reporting Period Prediction')
