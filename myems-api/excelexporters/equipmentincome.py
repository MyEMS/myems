...
def generate_excel(report,
    ...
    if "names" not in reporting_period_data.keys() or \
        ...
        ws['B5'] = name + ' ' + _('Reporting Period Income')
        ...
        ws['B7'] = _('Reporting Period Income')
        ws['B7'].border = f_border

        ws['B8'].font = title_font
        ws['B8'].alignment = c_c_alignment
        ws['B8'] = _('Increment Rate')
        ...
        ws[col + '6'].font = name_font
        ws[col + '6'].alignment = c_c_alignment
        ws[col + '6'] = _("Total") + " (" + reporting_period_data['total_unit'] + ")"
        ws[col + '6'].border = f_border
    ...
    if "timestamps" not in reporting_period_data.keys() or \
        ...
        if has_data:
            ...
            for i in range(0, ca_len):
                ...
                line = LineChart()
                line.title = _('Reporting Period Income') + ' - ' + reporting_period_data['names'][i] + \
            ...
            ws[col + str(table_row)].font = title_font
            ws[col + str(table_row)].alignment = c_c_alignment
            ws[col + str(table_row)] = _('Total') + ' (' + report['reporting_period']['total_unit'] + ')'
            ws[col + str(table_row)].border = f_border
