"""
Virtual Meter Prediction Excel Exporter

This module provides functionality to export Virtual Meter prediction data to Excel format.
...
def generate_excel(report,
    ...
    # todo
    ws = wb.active
    ws.title = "VirtualMeterPrediction"
    # Row height
    ...
    if "values" not in report['reporting_period'].keys() or len(report['reporting_period']['values']) == 0:
        ...
        ws['B7'] = name + _('Reporting Period Prediction')
