"""
Combined Equipment Statistics Excel Exporter

This module provides functionality to export combined equipment statistics data to Excel format.
It generates comprehensive reports showing statistical analysis for combined equipment
