"""
Offline Meter Batch Excel Exporter

This module provides functionality to export offline meter batch data to Excel format.
It generates comprehensive reports showing energy consumption data for multiple offline meters
within a specific time period.

Key Features:
- Multi-offline meter energy consumption comparison
...
- Offline meter names and associated spaces
