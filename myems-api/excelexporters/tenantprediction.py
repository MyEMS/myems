"""
Tenant Prediction Excel Exporter

This module provides functionality to export tenant Prediction data to Excel format.
It generates comprehensive reports showing energy consumption breakdown by categories
for tenants with detailed analysis and visualizations.

Key Features:
- Tenant energy consumption by category
