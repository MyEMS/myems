"""
Space Prediction Excel Exporter

This module provides functionality to export space prediction data to Excel format.
...
Key Features:
- Space energy prediction consumption
    ...
    if "child_space" not in report.keys() or "energy_category_names" not in report['child_space'].keys() or \
        ...
        for i in range(0, space_len):
            ...
            for j in range(0, ca_len):
                ...
                ws[col + row].font = name_font
                ws[col + row].alignment = c_c_alignment
                ws[col + row] = str(round2(child['subtotals_array'][j][i] / total * 100, 2)) + '%' \
