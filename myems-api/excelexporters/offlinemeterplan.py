"""
Offline Meter Plan Excel Exporter

This module provides functionality to export offline meter plan data to Excel format.
It generates comprehensive reports showing planned vs actual energy consumption
for offline meters with detailed analysis and visualizations.

Key Features:
- Offline meter plan vs actual analysis
