"""
Shop Floor Batch Excel Exporter

This module provides functionality to export shop floor batch data to Excel format.
It generates comprehensive reports showing energy consumption data for multiple shop floors
within a specific time period.

Key Features:
- Multi-shop floor energy consumption comparison
...
- Shop floor names and associated spaces
...
def generate_excel(report, space_name, reporting_start_datetime_local, reporting_end_datetime_local, language):
    ...
    for i in range(0, len(report['shopfloors'])):
        ...
        for j in range(0, ca_len):
            ...
            ws[col + str(current_row_number)] = round2(report['shopfloors'][i]['values'][j], 2)
        ...
        ws[carbon_col + str(current_row_number)] = round2(report['shopfloors'][i].get('carbon_emissions', 0.0), 2)
        ...
        ws[cost_col + str(current_row_number)] = round2(report['shopfloors'][i].get('cost', 0.0), 2)
