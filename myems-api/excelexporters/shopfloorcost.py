"""
Shop Floor Cost Excel Exporter

This module provides functionality to export shop floor cost data to Excel format.
It generates comprehensive reports showing cost analysis for shop floors
...
def generate_excel(report,
    ...
    if "toppeaks" not in reporting_period_data.keys() or \
        ...
        ws['D14'] = _('Electricity Cost Proportion by Time-Of-Use')
