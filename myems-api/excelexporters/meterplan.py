"""
Meter Plan Excel Exporter

This module provides functionality to export meter plan data to Excel format.
It generates comprehensive reports showing planned vs actual energy consumption
for meters with detailed analysis and visualizations.

Key Features:
- Meter plan vs actual analysis
