"""
Store Load Excel Exporter

This module provides functionality to export store load data to Excel format.
It generates comprehensive reports showing load analysis for stores
