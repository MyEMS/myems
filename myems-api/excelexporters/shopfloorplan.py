"""
Shop Floor Plan Excel Exporter

This module provides functionality to export shop floor plan data to Excel format.
...
Key Features:
- Shop floor plan vs actual analysis
