"""
Microgrid Reporting Energy Excel Exporter

This module provides functionality to export microgrid energy reporting data to Excel format.
It generates comprehensive reports showing microgrid energy performance
with detailed analysis and visualizations.

Key Features:
- Microgrid energy performance analysis
...
- Microgrid energy performance summary
