...
class PhotovoltaicPowerStationCollection:
    ...
    def on_get(req, resp):
        ...
        rows_cost_centers = []
        rows_svgs = []
        rows_photovoltaic_power_stations = []
        ...
        try:
            ...
            try:
                ...
                query = (" SELECT id, name, uuid, "
                         ...
                         "        contact_id, cost_center_id, svg_id, is_cost_data_displayed, "
        ...
        try:
            ...
            try:
                ...
                add_values = (" INSERT INTO tbl_photovoltaic_power_stations "
                              ...
                              "  rated_capacity, rated_power, contact_id, "
                              "  cost_center_id, svg_id, is_cost_data_displayed, "
                              "  phase_of_lifecycle, description) "
        ...
        try:
            ...
            try:
                ...
                update_row = (" UPDATE tbl_photovoltaic_power_stations "
                              ...
                              "     svg_id = %s, is_cost_data_displayed = %s, "
                              "     phase_of_lifecycle = %s, description = %s "
                              " WHERE id = %s ")
        ...
        try:
            ...
            try:
                ...
                add_values = (" INSERT INTO tbl_photovoltaic_power_stations_loads "
                              "    (name, uuid, photovoltaic_power_station_id, "
                              "     power_point_id, meter_id, rated_input_power,"
                              "     total_active_power_point_id,"
                              "     active_power_a_point_id,"
                              "     active_power_b_point_id,"
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        add_row = (" INSERT INTO tbl_photovoltaic_power_stations_users "
                                   " (photovoltaic_power_station_id, user_id) "
                                   " VALUES (%s, %s) ")
        ...
        try:
            ...
            try:
                ...
                query = (" SELECT ds.id, ds.name, ds.uuid "
                         " FROM tbl_photovoltaic_power_stations psp, "
                         "      tbl_photovoltaic_power_stations_data_sources psds, "
                         "      tbl_data_sources ds "
                         " WHERE psds.photovoltaic_power_station_id = psp.id "
                         " AND ds.id = psds.data_source_id AND psp.id = %s "
                         " ORDER BY ds.id ")
                cursor.execute(query, (id_,))
                rows = cursor.fetchall()
