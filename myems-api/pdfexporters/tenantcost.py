"""
Tenant Cost PDF Exporter

This module exports tenant cost analysis data to PDF format.
The content mirrors the Excel exporter (excelexporters/tenantcost.py).
...
class TenantCostPDFExporter:
    """
    Export tenant cost data to PDF format.
    ...
    def _create_cover_page(self, pdf, name, period_type,
        ...
        # Title
        fig.text(0.5, 0.50, _('Tenant Data') + ' - ' + _('Cost'),
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = TenantCostPDFExporter(language)
