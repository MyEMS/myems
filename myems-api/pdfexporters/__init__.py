"""
MyEMS PDF Exporters Module

This module contains PDF export functionality for various MyEMS reports.
It provides functions to generate PDF files with formatted data, charts, and visualizations
...
2. Generate PDF file with proper formatting
3. Encode file to Base64 for transmission

The module uses openpyxl for PDF file generation and includes support for:
