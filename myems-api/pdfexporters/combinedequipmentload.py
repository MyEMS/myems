"""
Combined Equipment Load PDF Exporter
...
Key Features:
- CombinedEquipment load analysis (average load, maximum load, load factor)
...
class CombinedEquipmentLoadPDFExporter:
    """
    ...
    def _create_cover_page(self, pdf, name, period_type,
        ...
        fig.text(0.5, 0.50, _('Combined Equipment Data') + ' - ' +_('Load'),
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = CombinedEquipmentLoadPDFExporter(language)
