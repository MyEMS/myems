"""
Shopfloor Carbon PDF Exporter

This module exports store carbon dioxide emissions analysis data to PDF format.
The content mirrors the Excel exporter (excelexporters/shopfloorcarbon.py).
...
class ShopfloorCarbonPDFExporter:
    """
    Export shopfloor carbon emissions data to PDF format.
    ...
    def generate_pdf(self,
        ...
        with PdfPages(filename) as pdf:
            ...
            # Time-of-use + Carbon proportion by category + Child store proportion
    ...
    def _create_cover_page(self, pdf: PdfPages, name: str, period_type: str,
        ...
        fig.text(0.5, 0.50, _('Shopfloor Data') + ' - ' + _('Carbon'),
    ...
    def _create_combined_analysis_page(self, pdf: PdfPages):
        ...
        carbon_values = [round2(v, 2) for v in subtotals] if carbon_exists else []
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = ShopfloorCarbonPDFExporter(language)
