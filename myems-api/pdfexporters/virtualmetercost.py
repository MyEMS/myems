"""
Virtual Meter Cost PDF Exporter

This module provides functionality to export virtual meter cost data to PDF format.
It generates comprehensive reports showing costs for virtual meters
with detailed analysis including base period comparison and time-series data.

Key Features:
- Virtual meter cost analysis
...
class VirtualMeterCostPDFExporter:
    """
    Export virtual meter cost data to PDF format.
    ...
    def _create_cover_page(self, pdf: PdfPages, name: str, period_type: str,
        ...
        fig.text(0.5, 0.50, _('Meter Data') + ' - ' + _('Virtual Meter Cost'),
...
def export(report, name, base_period_start_datetime_local, base_period_end_datetime_local,
    ...
    """
    exporter = VirtualMeterCostPDFExporter(language)
