"""
Combined Equipment Efficiency PDF Exporter
...
Key Features:
- CombinedEquipment efficiency analysis
...
class CombinedEquipmentEfficiencyPDFExporter:
    """
    ...
    def _create_cover_page(self, pdf, name, period_type,
        ...
        # Title
        fig.text(0.5, 0.50, _('Combined Equipment Data') + ' - ' +_('Efficiency'),
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = CombinedEquipmentEfficiencyPDFExporter(language)
