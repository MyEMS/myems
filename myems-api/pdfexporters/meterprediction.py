"""
Meter Prediction PDF Exporter

This module provides functionality to export meter prediction data to PDF format.
...
class MeterPredictionPDFExporter:
    """
    Export meter prediction data to PDF format.
    ...
    def _create_cover_page(self, pdf: PdfPages, name: str, period_type: str,
        ...
        fig.text(0.5, 0.50, _('Meter Data') + ' - ' + _('Meter Prediction'),
...
def export(report, name, reporting_start_datetime_local, reporting_end_datetime_local,
    ...
    """
    exporter = MeterPredictionPDFExporter(language)
