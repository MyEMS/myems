"""
Combined Equipment Prediction PDF Exporter

This module provides functionality to export equipment prediction data to PDF format.
It generates comprehensive reports showing energy prediction analysis for equipment
with detailed breakdown including time-of-use analysis and energy category proportions.

Key Features:
- CombinedEquipment energy prediction analysis
- Base period vs reporting period comparison
- Time-of-use electricity breakdown (TopPeak/OnPeak/MidPeak/OffPeak)
...
class CombinedEquipmentPredictionPDFExporter:
    """
    Export equipment prediction data to PDF format.
    ...
    def _create_cover_page(self, pdf, name, period_type,
        ...
        # Title
        fig.text(0.5, 0.50, _('Combined Equipment Data') + ' - ' +_('Energy Prediction Analysis'),
    ...
    def _create_combined_analysis_page(self, pdf: PdfPages):
        ...
        rp_table_data = [rp_col_headers, consumption_row, increment_row]
        ...
        # ===== Create figure =====
        fig = plt.figure(figsize=self.page_size)
        fig.suptitle(self.name + ' - ' + _('Reporting Period Prediction'),
        ...
        # ===== Top: Reporting Period Prediction table =====
        ...
        if not self.is_base_period_exists:
            ...
            for page in range(num_pages):
                ...
                for idx, i in enumerate(page_categories):
                    ...
                    ax_chart.set_title(_('Reporting Period Prediction') + ' - ' +
                                       names[i] + ' (' + units[i] + ')',
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = CombinedEquipmentPredictionPDFExporter(language)
