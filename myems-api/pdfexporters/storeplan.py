"""
Store Plan PDF Exporter

This module exports store energy plan analysis (plan - actual) data to PDF format.
The content mirrors the Excel exporter (excelexporters/storeplan.py).
...
class StorePlanPDFExporter:
    """
    Export store plan data to PDF format.
    ...
    def _create_cover_page(self, pdf, name, period_type,
        ...
        # Title
        fig.text(0.5, 0.50, _('Store Data') + ' - ' + _('Energy Plan Analysis'),
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = StorePlanPDFExporter(language)
