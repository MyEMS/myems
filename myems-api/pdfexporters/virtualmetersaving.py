"""
Virtual Meter Saving PDF Exporter

This module provides functionality to export virtual meter saving data to PDF format.
It generates comprehensive reports showing energy saving analysis for virtual meters
...
class VirtualMeterSavingPDFExporter:
    """
    Export virtual meter saving data to PDF format.
    ...
    def _create_cover_page(self, pdf: PdfPages, name: str, period_type: str,
        ...
        fig.text(0.5, 0.50, _('Meter Data') + ' - ' + _('Virtual Meter Saving'),
...
def export(report, name, base_period_start_datetime_local, base_period_end_datetime_local,
    ...
    """
    exporter = VirtualMeterSavingPDFExporter(language)
