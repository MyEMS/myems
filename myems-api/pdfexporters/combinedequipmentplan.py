"""
Combined Equipment Plan PDF Exporter

This module provides functionality to export equipment plan data to PDF format.
It generates comprehensive reports showing energy plan analysis for equipment
with detailed breakdown by energy categories and time periods.

Key Features:
- CombinedEquipment energy plan analysis (baseline - actual)
...
class CombinedEquipmentPlanPDFExporter:
    """
    Export equipment plan data to PDF format.
    ...
    def _create_cover_page(self, pdf, name, period_type,
        ...
        # Title
        fig.text(0.5, 0.50, _('Combined Equipment Data') + ' - ' +_('Energy Plan Analysis'),
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = CombinedEquipmentPlanPDFExporter(language)
