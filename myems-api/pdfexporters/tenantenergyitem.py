"""
Tenant Energy Item PDF Exporter

This module exports tenant energy consumption breakdown by energy items data to PDF format.
The content mirrors the Excel exporter (excelexporters/tenantenergyitem.py).
...
class TenantEnergyItemPDFExporter:
    """
    Export tenant energy item data to PDF format.
    ...
    def _create_cover_page(self, pdf, name, period_type,
        ...
        # Title
        fig.text(0.5, 0.50, _('Tenant Data') + ' - ' + _('Energy Item Analysis'),
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = TenantEnergyItemPDFExporter(language)
