"""
Store Carbon PDF Exporter

This module exports store carbon dioxide emissions analysis data to PDF format.
The content mirrors the Excel exporter (excelexporters/storecarbon.py).
...
class StoreCarbonPDFExporter:
    """
    Export store carbon emissions data to PDF format.
    ...
    def _create_cover_page(self, pdf: PdfPages, name: str, period_type: str,
        ...
        fig.text(0.5, 0.50, _('Store Data') + ' - ' + _('Carbon'),
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = StoreCarbonPDFExporter(language)
