"""
Equipment Prediction PDF Exporter
...
class EquipmentPredictionPDFExporter:
    """
    ...
    def _create_cover_page(self, pdf, name, period_type,
        ...
        # Title
        fig.text(0.5, 0.50, _('Equipment Data') + ' - ' +_('Energy Prediction Analysis'),
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = EquipmentPredictionPDFExporter(language)
