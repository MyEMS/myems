"""
Virtual Meter Carbon PDF Exporter

This module provides functionality to export virtual meter carbon emissions data to PDF format.
...
class VirtualMeterCarbonPDFExporter:
    """
    Export virtual meter carbon emissions data to PDF format.
    ...
    def _create_cover_page(self, pdf: PdfPages, name: str, period_type: str,
        ...
        fig.text(0.5, 0.50, _('Meter Data') + ' - ' + _('Virtual Meter Carbon'),
...
def export(report, name, base_period_start_datetime_local, base_period_end_datetime_local,
    ...
    """
    exporter = VirtualMeterCarbonPDFExporter(language)
