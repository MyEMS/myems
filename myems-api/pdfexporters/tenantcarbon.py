"""
Tenant Carbon PDF Exporter

This module exports tenant carbon dioxide emissions analysis data to PDF format.
The content mirrors the Excel exporter (excelexporters/tenantcarbon.py).
...
class TenantCarbonPDFExporter:
    """
    Export tenant carbon emissions data to PDF format.
    ...
    def generate_pdf(self,
        ...
        with PdfPages(filename) as pdf:
            ...
            # Time-of-use + Carbon proportion by category + Child tenant proportion
    ...
    def _create_cover_page(self, pdf: PdfPages, name: str, period_type: str,
        ...
        fig.text(0.5, 0.50, _('Tenant Data') + ' - ' + _('Carbon'),
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = TenantCarbonPDFExporter(language)
