"""
Store Statistics PDF Exporter

This module exports store statistical analysis data to PDF format.
The content mirrors the Excel exporter (excelexporters/storestatistics.py).
...
class StoreStatisticsPDFExporter:
    """
    Export store statistics data to PDF format.
    ...
    def _create_cover_page(self, pdf, name, period_type,
        ...
        # Title
        fig.text(0.5, 0.50, _('Store Data') + ' - ' + _('Statistics'),
    ...
    def _create_statistics_page(self, pdf: PdfPages):
        ...
        area = self.report.get('store', {}).get('area', None)
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = StoreStatisticsPDFExporter(language)
