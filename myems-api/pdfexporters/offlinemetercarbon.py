"""
Offline Meter Carbon PDF Exporter

This module provides functionality to export offline meter carbon emissions data to PDF format.
It generates comprehensive reports showing carbon dioxide emissions for offline meters
with detailed analysis including base period comparison and time-series data.

Key Features:
- Offline meter carbon emissions analysis
...
- Offline meter carbon emissions summary
...
class OfflineMeterCarbonPDFExporter:
    """
    Export offline meter carbon emissions data to PDF format.
    ...
    def _create_cover_page(self, pdf: PdfPages, name: str, period_type: str,
        ...
        fig.text(0.5, 0.50, _('Meter Data') + ' - ' + _('Offline Meter Carbon'),
...
def export(report, name, base_period_start_datetime_local, base_period_end_datetime_local,
    ...
    """
    exporter = OfflineMeterCarbonPDFExporter(language)
