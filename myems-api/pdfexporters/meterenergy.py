"""
Meter Energy PDF Exporter

This module provides functionality to export meter energy data to PDF format.
...
class MeterEnergyPDFExporter:
    """
    Export meter energy data to PDF format.
    ...
    def export(self,
               ...
               base_period_start_datetime: str,
               base_period_end_datetime: str,
               period_type: str,
    ...
    def generate_pdf(self,
        ...
        self.base_period_start = base_period_start_datetime
        self.base_period_end = base_period_end_datetime
    ...
    def _create_cover_page(self, pdf: PdfPages, name: str, period_type: str,
        ...
        fig.text(0.5, 0.50, _('Meter Data') + ' - ' + _('Meter Energy'),
    ...
    def _create_consumption_page(self, pdf: PdfPages):
        ...
        Mirrors the Excel block at rows 7~9: one header row (name, energy category,
...
def export(report, name, reporting_start_datetime_local, reporting_end_datetime_local,
    ...
    """
    exporter = MeterEnergyPDFExporter(language)
