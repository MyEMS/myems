"""
Offline Meter Plan PDF Exporter

This module provides functionality to export offline meter plan data to PDF format.
...
Key Features:
- Offline meter energy plan analysis
...
class OfflineMeterPlanPDFExporter:
    """
    Export offline meter plan data to PDF format.
    ...
    def _create_cover_page(self, pdf: PdfPages, name: str, period_type: str,
        ...
        fig.text(0.5, 0.50, _('Meter Data') + ' - ' + _('Offline Meter Plan'),
...
def export(report, name, base_period_start_datetime_local, base_period_end_datetime_local,
    ...
    """
    exporter = OfflineMeterPlanPDFExporter(language)
