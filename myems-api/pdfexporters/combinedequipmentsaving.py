"""
Combined Equipment Saving PDF Exporter

This module provides functionality to export equipment saving data to PDF format.
...
Key Features:
- CombinedEquipment energy saving analysis (baseline - actual)
...
class CombinedEquipmentSavingPDFExporter:
    """
    Export equipment saving data to PDF format.
    ...
    def _create_cover_page(self, pdf, name, period_type,
        ...
        fig.text(0.5, 0.50, _('Combined Equipment Data') + ' - ' +_('Energy Saving Analysis'),
    ...
    def _create_combined_analysis_page(self, pdf: PdfPages):
        ...
        Content matches Excel export exactly (without Per Unit Area row for equipment).
        """
        _ = self._
        ...
        rp_table_data = [col_headers, saving_row, increment_row]
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = CombinedEquipmentSavingPDFExporter(language)
