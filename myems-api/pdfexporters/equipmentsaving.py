...
Key Features:
- Equipment energy saving analysis (baseline - actual)
...
class EquipmentSavingPDFExporter:
    """
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = EquipmentSavingPDFExporter(language)
