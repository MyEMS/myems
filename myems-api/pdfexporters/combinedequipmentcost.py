"""
Combined Equipment Cost PDF Exporter

This module provides functionality to export equipment cost data to PDF format.
...
Key Features:
- CombinedEquipment cost analysis
...
class CombinedEquipmentCostPDFExporter:
    """
    Export equipment cost data to PDF format.
    ...
    def _create_cover_page(self, pdf, name, period_type,
        ...
        fig.text(0.5, 0.50, _('Combined Equipment Data') + ' - ' +_('Cost'),
    ...
    def _create_combined_analysis_page(self, pdf: PdfPages):
        ...
        CombinedEquipment does not have Per Unit Area or Per Capita data.
        """
        _ = self._
        ...
        rp_table_data = [rp_col_headers, rp_cost_row, rp_increment_row]
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = CombinedEquipmentCostPDFExporter(language)
