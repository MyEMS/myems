"""
Tenant Prediction PDF Exporter

This module exports tenant energy prediction analysis data to PDF format.
The content mirrors the Excel exporter (excelexporters/tenantprediction.py).
...
class TenantPredictionPDFExporter:
    """
    Export tenant prediction data to PDF format.
    ...
    def _create_cover_page(self, pdf, name, period_type,
        ...
        # Title
        fig.text(0.5, 0.50, _('Tenant Data') + ' - ' + _('Energy Prediction Analysis'),
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = TenantPredictionPDFExporter(language)
