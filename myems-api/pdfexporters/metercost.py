"""
Meter Cost PDF Exporter

This module provides functionality to export meter cost data to PDF format.
It generates comprehensive reports showing cost analysis for meters
...
class MeterCostPDFExporter:
    """
    Export meter cost data to PDF format.
    ...
    def generate_pdf(self,
        ...
        with PdfPages(filename) as pdf:
            ...
            # Reporting period costs summary table
    ...
    def _create_cover_page(self, pdf: PdfPages, name: str, period_type: str,
        ...
        fig.text(0.5, 0.50, _('Meter Data') + ' - ' + _('Meter Cost'),
...
def export(report, name, base_period_start_datetime_local, base_period_end_datetime_local,
    ...
    """
    exporter = MeterCostPDFExporter(language)
