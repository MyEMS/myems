"""
Store Comparison PDF Exporter

This module exports store comparison analysis of two stores data to PDF format.
The content mirrors the Excel exporter (excelexporters/storecomparison.py).
...
class StoreComparisonPDFExporter:
    """
    Export store comparison data to PDF format.
    ...
    def _create_cover_page(self, pdf, store1_name, store2_name,
        ...
        # Title
        fig.text(0.5, 0.50, _('Store Data') + ' - ' + _('Store Comparison'),
...
# Convenience function with the same signature as excelexporters.storecomparison.export
def export(report, store1_name, store2_name, energy_category_name,
    ...
    """
    exporter = StoreComparisonPDFExporter(language)
