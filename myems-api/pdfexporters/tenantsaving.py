"""
Tenant Saving PDF Exporter

This module exports tenant energy saving analysis (baseline - actual) data to PDF format.
The content mirrors the Excel exporter (excelexporters/tenantsaving.py).
...
class TenantSavingPDFExporter:
    """
    Export tenant saving data to PDF format.
    ...
    def _create_cover_page(self, pdf, name, period_type,
        ...
        # Title
        fig.text(0.5, 0.50, _('Tenant Data') + ' - ' + _('Energy Saving Analysis'),
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = TenantSavingPDFExporter(language)
