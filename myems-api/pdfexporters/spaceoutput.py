"""
Space Output PDF Exporter

This module provides functionality to export space output data to PDF format.
...
- Combined analysis page (reporting period output table + output proportion)
...
class SpaceOutputPDFExporter:
    """
    Export space output data to PDF format.
    ...
    def _create_combined_analysis_page(self, pdf: PdfPages):
        ...
        rp_table_data = [rp_col_headers, rp_output_row, rp_per_area_row, rp_increment_row]
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = SpaceOutputPDFExporter(language)
