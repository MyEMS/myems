"""
Combined Equipment Carbon PDF Exporter

This module provides functionality to export equipment carbon emissions data to PDF format.
...
Key Features:
- CombinedEquipment carbon emissions analysis
...
class CombinedEquipmentCarbonPDFExporter:
    """
    Export equipment carbon emissions data to PDF format.
    ...
    def generate_pdf(self,
        ...
        with PdfPages(filename) as pdf:
            ...
            # Time-of-use + Carbon proportion by category
    ...
    def _create_cover_page(self, pdf: PdfPages, name: str, period_type: str,
        ...
        fig.text(0.5, 0.50, _('Combined Equipment Data') + ' - ' + _('Carbon'),
    ...
    def _create_combined_analysis_page(self, pdf: PdfPages):
        ...
        CombinedEquipment does not have Per Unit Area data.
        """
        _ = self._
        ...
        rp_table_data = [rp_col_headers, rp_emissions_row, rp_increment_row]
        ...
        gs_main = gridspec.GridSpec(2, 1, height_ratios=[0.22, 0.78], hspace=0.30)
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = CombinedEquipmentCarbonPDFExporter(language)
