"""
Combined Equipment Statistics PDF Exporter
...
Key Features:
- CombinedEquipment statistical analysis
...
class CombinedEquipmentStatisticsPDFExporter:
    """
    ...
    def _create_cover_page(self, pdf, name, period_type,
        ...
        fig.text(0.5, 0.50, _('Combined Equipment Data') + ' - ' +_('Statistics'),
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = CombinedEquipmentStatisticsPDFExporter(language)
