"""
Shopfloor Cost PDF Exporter

This module exports store cost analysis data to PDF format.
The content mirrors the Excel exporter (excelexporters/shopfloorcost.py).
...
class ShopfloorCostPDFExporter:
    """
    Export shopfloor cost data to PDF format.
    ...
    def _create_cover_page(self, pdf, name, period_type,
        ...
        # Title
        fig.text(0.5, 0.50, _('Shopfloor Data') + ' - ' + _('Cost'),
    ...
    def _create_combined_analysis_page(self, pdf: PdfPages):
        ...
        rp_table_data = [rp_col_headers, rp_cost_row, rp_per_area_row, rp_increment_row]
        ...
        tou_table_data = [
            ['', _('Electricity Costs by Time-Of-Use')],
        ...
        if tou_exists:
            ...
            ax_chart1.set_title(_('Electricity Costs by Time-Of-Use'),
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = ShopfloorCostPDFExporter(language)
