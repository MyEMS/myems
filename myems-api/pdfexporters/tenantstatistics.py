"""
Tenant Statistics PDF Exporter

This module exports tenant statistical analysis data to PDF format.
The content mirrors the Excel exporter (excelexporters/tenantstatistics.py).
...
class TenantStatisticsPDFExporter:
    """
    Export tenant statistics data to PDF format.
    ...
    def _create_cover_page(self, pdf, name, period_type,
        ...
        # Title
        fig.text(0.5, 0.50, _('Tenant Data') + ' - ' + _('Statistics'),
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = TenantStatisticsPDFExporter(language)
