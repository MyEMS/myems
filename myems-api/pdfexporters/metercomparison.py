"""
Meter Comparison PDF Exporter

This module provides functionality to export meter comparison data to PDF format.
...
class MeterComparisonPDFExporter:
    """
    Export meter comparison data to PDF format.
    ...
    def export(self,
        ...
        logger.info("Starting PDF generation for meter comparison")
    ...
    def _create_cover_page(self, pdf: PdfPages):
        ...
        # Title
        fig.text(0.5, 0.50, _('Meter Data') + ' - ' + _('Meter Comparison'),
...
def export(report, name1, name2,
    ...
    """
    exporter = MeterComparisonPDFExporter(language)
