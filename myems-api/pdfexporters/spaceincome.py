"""
Space Income PDF Exporter

This module provides functionality to export space income data to PDF format.
...
class SpaceIncomePDFExporter:
    """
    Export space income data to PDF format.
    ...
    def _create_combined_analysis_page(self, pdf: PdfPages):
        """Create combined analysis page: Reporting Period Income table only (matching Excel)."""
        _ = self._
        ...
        rp_table_data = [rp_col_headers, rp_income_row, rp_per_area_row, rp_increment_row]
...
def export(report, name, base_period_start_datetime_local,
    ...
    """
    exporter = SpaceIncomePDFExporter(language)
