"""
Offline Meter Energy PDF Exporter

This module provides functionality to export offline meter energy data to PDF format.
...
Note: the content mirrors the Excel exporter (excelexporters/offlinemeterenergy.py) exactly.
...
class OfflineMeterEnergyPDFExporter:
    """
    Export offline meter energy data to PDF format.
    ...
    def _create_cover_page(self, pdf: PdfPages, name: str, period_type: str,
        ...
        fig.text(0.5, 0.50, _('Meter Data') + ' - ' + _('Offline Meter Energy'),
...
def export(report, name, base_period_start_datetime_local, base_period_end_datetime_local,
    ...
    """
    exporter = OfflineMeterEnergyPDFExporter(language)
