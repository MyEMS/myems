"""
Combined Equipment Batch PDF Exporter
...
class CombinedEquipmentBatchPDFExporter:
    """
    ...
    def _create_cover_page(self, pdf: PdfPages):
        ...
        fig.text(0.5, 0.50, _('Combined Equipment Data') + ' - ' +_('Batch Analysis'),
...
def export(report, space_name, reporting_start_datetime_local,
    ...
    """
    exporter = CombinedEquipmentBatchPDFExporter(language)
