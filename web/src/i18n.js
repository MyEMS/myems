...
const resources = {
  en: {
    translation: {
      ...
      "API.THERE_IS_RELATION_WITH_SPACE": "There is relation with space",
      ...
      "API.COMBINED_EQUIPMENT_EQUIPMENT_RELATION_EXISTED": "Combined equipment equipment relation existed",
      ...
      "API.COMBINED_EQUIPMENT_METER_RELATION_EXISTED": "Combined equipment meter relation existed",
      "API.COMBINED_EQUIPMENT_METER_RELATION_NOT_FOUND": "Combined equipment meter relation not found",
      "API.COMBINED_EQUIPMENT_OFFLINE_METER_RELATION_EXISTED": "Combined equipment offline meter relation existed",
      "API.COMBINED_EQUIPMENT_OFFLINE_METER_RELATION_NOT_FOUND": "Combined equipment offline meter relation not found",
      "API.COMBINED_EQUIPMENT_VIRTUAL_METER_RELATION_EXISTED": "Combined equipment virtual meter relation existed",
      ...
      "API.THERE_IS_RELATIONSHIP_WITH_SPACES": "There is relationship with spaces",
      "API.TARIFF_NOT_FOUND": "Tariff not found",
      "API.TARIFF_ALREADY_ASSOCIATED_WITH_COST_CENTER": "Tariff already associated with cost center",
      ...
      "API.DISTRIBUTION_CIRCUIT_POINT_RELATION_EXISTED": "Distribution circuit point relation existed",
      ...
      "API.START_DATETIME_SHOULD_BE_EARLY_THAN_END_DATETIME": "Start datetime should be early than end datetime",
      ...
      "API.EQUIPMENT_NAME_IS_ALREADY_IN_USE": "Invalid cost center id",
      ...
      "API.INVALID_DENOMINATOR_METER_UUID": "Invalid numerator meter uuid",
      ...
      "API.EQUIPMENT_METER_RELATION_EXISTED": "Equipment meter relation existed",
      "API.EQUIPMENT_METER_RELATION_NOT_FOUND": "Equipment meter relation not found",
      "API.EQUIPMENT_OFFLINE_METER_RELATION_EXISTED": "Equipment offline meter relation existed",
      "API.EQUIPMENT_OFFLINE_METER_RELATION_NOT_FOUND": "Equipment offline meter relation not found",
      "API.EQUIPMENT_VIRTUAL_METER_RELATION_EXISTED": "Equipment virtual meter relation existed",
      ...
      "API.GATEWAY_NOT_FOUND": "Invalid gateway id",
      ...
      "API.INVALID_IS_COUNTED_VALUE": "Invalid energy category id",
      ...
      "API.INVALID_MASTER_METER_ID": "Invalid energy item id",
      ...
      "API.THERE_IS_RELATION_WITH_COMBINED_EQUIPMENT_PARAMETERS": "There is relation with combined equipments",
      ...
      "API.METER_POINT_RELATION_EXISTED": "Meter point relation existed",
      ...
      "API.THERE_IS_RELATIONSHIP_WITH_EQUIPMENTS": "There is relationship with equipments",
      ...
      "API.THERE_IS_RELATIONSHIP_WITH_USERS": "There is relationship with users",
      "API.PRIVILEGE_NOT_FOUND": "Privilege not found",
      "API.INVALID_PRIVILEGE_ID_": "Invalid privilege id ",
      ...
      "API.SENSOR_POINT_RELATION_EXISTED": "Sensor point relation existed",
      ...
      "API.THIS_SHOPFLOOR_CAN_NOT_BE_DELETED": "This shopfloor can not be deleted",
      "API.THERE_IS_RELATION_WITH_VIRTUAL_METERS": "There is relation with virtual meters",
      "API.SHOPFLOOR_EQUIPMENT_RELATION_EXISTED": "Shopfloor equipment relation existed",
      "API.SHOPFLOOR_EQUIPMENT_RELATION_NOT_FOUND": "Shopfloor equipment relation not found",
      "API.SHOPFLOOR_METER_RELATION_EXISTED": "Shopfloor meter relation existed",
      "API.SHOPFLOOR_METER_RELATION_NOT_FOUND": "Shopfloor meter relation not found",
      "API.SHOPFLOOR_OFFLINE_METER_RELATION_EXISTED": "Shopfloor offline meter relation existed",
      "API.SHOPFLOOR_OFFLINE_METER_RELATION_NOT_FOUND": "Shopfloor offline meter relation not found",
      "API.SHOPFLOOR_POINT_RELATION_EXISTED": "Shopfloor point relation existed",
      "API.SHOPFLOOR_POINT_RELATION_NOT_FOUND": "Shopfloor point relation not found",
      "API.SHOPFLOOR_SENSOR_RELATION_EXISTED": "Shopfloor sensor relation existed",
      "API.SHOPFLOOR_SENSOR_RELATION_NOT_FOUND": "Shopfloor sensor relation not found",
      "API.SHOPFLOOR_VIRTUAL_METER_RELATION_EXISTED": "Shopfloor virtual meter relation existed",
      ...
      "API.THIS_SPACE_CAN_NOT_BE_DELETED": "This space can not be deleted",
      "API.THERE_IS_RELATION_WITH_CHILDREN_SPACES": "There is relation with children spaces",
      "API.SPACE_COMBINED_EQUIPMENT_RELATION_EXISTED": "Space combined equipment relation existed",
      "API.SPACE_COMBINED_EQUIPMENT_RELATION_NOT_FOUND": "Space combined equipment relation not found",
      "API.SPACE_EQUIPMENT_RELATION_EXISTED": "Space equipment relation existed",
      "API.SPACE_EQUIPMENT_RELATION_NOT_FOUND": "Space equipment relation not found",
      "API.SPACE_METER_RELATION_EXISTED": "Space meter relation existed",
      "API.SPACE_METER_RELATION_NOT_FOUND": "Space meter relation not found",
      "API.SPACE_OFFLINE_METER_RELATION_EXISTED": "Space offline meter relation existed",
      "API.SPACE_OFFLINE_METER_RELATION_NOT_FOUND": "Space offline meter relation not found",
      "API.SPACE_POINT_RELATION_EXISTED": "Space point relation existed",
      "API.SPACE_POINT_RELATION_NOT_FOUND": "Space point relation not found",
      "API.SPACE_SENSOR_RELATION_EXISTED": "Space sensor relation existed",
      "API.SPACE_SENSOR_RELATION_NOT_FOUND": "Space sensor relation not found",
      "API.SPACE_SHOPFLOOR_RELATION_EXISTED": "Space shopfloor relation existed",
      "API.SPACE_SHOPFLOOR_RELATION_NOT_FOUND": "Space shopfloor relation not found",
      "API.SPACE_STORE_RELATION_EXISTED": "Space store relation existed",
      "API.SPACE_STORE_RELATION_NOT_FOUND": "Space store relation not found",
      "API.SPACE_TENANT_RELATION_EXISTED": "Space tenant relation existed",
      "API.SPACE_TENANT_RELATION_NOT_FOUND": "Space tenant relation not found",
      "API.SPACE_VIRTUAL_METER_RELATION_EXISTED": "Space virtual meter relation existed",
      ...
      "API.STORE_METER_RELATION_EXISTED": "Store meter relation existed",
      "API.STORE_METER_RELATION_NOT_FOUND": "Store meter relation not found",
      "API.STORE_OFFLINE_METER_RELATION_EXISTED": "Store offline meter relation existed",
      "API.STORE_OFFLINE_METER_RELATION_NOT_FOUND": "Store offline meter relation not found",
      "API.STORE_POINT_RELATION_EXISTED": "Store point relation existed",
      "API.STORE_POINT_RELATION_NOT_FOUND": "Store point relation not found",
      "API.STORE_SENSOR_RELATION_EXISTED": "Store sensor relation existed",
      "API.STORE_SENSOR_RELATION_NOT_FOUND": "Store_sensor_relation_not_found",
      "API.STORE_VIRTUAL_METER_RELATION_EXISTED": "Store_virtual_meter_relation_existed",
      "API.STORE_VIRTUAL_METER_RELATION_NOT_FOUND": "Store_virtual_meter_relation_not_found",
      "API.INVALID_STORE_TYPE_NAME": "Invalid_store_type_name",
      "API.INVALID_STORE_TYPE_DESCRIPTION": "Invalid_store_type_description",
      "API.INVALID_STORE_TYPE_SIMPLIFIED_CODE": "Invalid_store_type_simplified_code",
      "API.STORE_TYPE_NAME_IS_ALREADY_IN_USE": "Store_type_name_is_already_in_use",
      "API.STORE_TYPE_SIMPLIFIED_CODE_IS_ALREADY_IN_USE": "Store_type_simplified_code_is_already_in_use",
      "API.STORE_TYPE_USED_IN_STORE": "Store_type_used_in_store",
      "API.INVALID_TARIFF_TYPE": "Invalid_tariff_type",
      "API.INVALID_TARIFF_BLOCK_PRICING": "Invalid_tariff_block_pricing",
      "API.INVALID_TARIFF_TIME_OF_USE_PRICING": "Invalid_tariff_time_of_use_pricing",
      "API.INVALID_UNIT_OF_PRICE": "Invalid_unit_of_price",
      "API.TARIFF_NAME_IS_ALREADY_IN_USE": "Tariff_name_is_already_in_use",
      "API.TARIFF_NOT_EMPTY": "Tariff_not_empty",
      "API.TARIFF_IN_USE": "Tariff_in_use",
      "API.INVALID_TENANT_NAME": "Invalid_tenant_name",
      "API.INVALID_BUILDINGS_VALUE": "Invalid_buildings_value",
      "API.INVALID_FLOORS_VALUE": "Invalid_floors_value",
      "API.INVALID_ROOMS_VALUE": "Invalid_rooms_value",
      "API.INVALID_TENANT_TYPE_ID": "Invalid_tenant_type_id",
      "API.INVALID_IS_KEY_TENANT_VALUE": "Invalid_is_key_tenant_value",
      "API.INVALID_LEASE_NUMBER_VALUE": "Invalid_lease_number_value",
      "API.INVALID_IS_IN_LEASE_VALUE": "Invalid_is_in_lease_value",
      "API.TENANT_NAME_IS_ALREADY_IN_USE": "Tenant_name_is_already_in_use",
      "API.TENANT_TYPE_NOT_FOUND": "Tenant_type_not_found",
      "API.THERE_IS_RELATION_WITH_SENSOR": "There_is_relation_with_sensor",
      "API.TENANT_METER_RELATION_EXISTED": "Tenant_meter_relation_existed",
      "API.TENANT_METER_RELATION_NOT_FOUND": "Tenant_meter_relation_not_found",
      "API.TENANT_OFFLINE_METER_RELATION_EXISTED": "Tenant_offline_meter_relation_existed",
      "API.TENANT_OFFLINE_METER_RELATION_NOT_FOUND": "Tenant_offline_meter_relation_not_found",
      "API.TENANT_POINT_RELATION_EXISTED": "Tenant_point_relation_existed",
      "API.TENANT_POINT_RELATION_NOT_FOUND": "Tenant_point_relation_not_found",
      "API.TENANT_SENSOR_RELATION_EXISTED": "Tenant_sensor_relation_existed",
      "API.TENANT_SENSOR_RELATION_NOT_FOUND": "Tenant_sensor_relation_not_found",
      "API.TENANT_VIRTUAL_METER_RELATION_EXISTED": "Tenant_virtual_meter_relation_existed",
      "API.TENANT_VIRTUAL_METER_RELATION_NOT_FOUND": "Tenant_virtual_meter_relation_not_found",
      "API.INVALID_TENANT_TYPE_NAME": "Invalid_tenant_type_name",
      "API.INVALID_TENANT_TYPE_DESCRIPTION": "Invalid_tenant_type_description",
      "API.INVALID_TENANT_TYPE_SIMPLIFIED_CODE": "Invalid_tenant_type_simplified_code",
      "API.TENANT_TYPE_NAME_IS_ALREADY_IN_USE": "Tenant_type_name_is_already_in_use",
      "API.TENANT_TYPE_SIMPLIFIED_CODE_IS_ALREADY_IN_USE": "Tenant_type_simplified_code_is_already_in_use",
      "API.TENANT_TYPE_USED_IN_TENANT": "Tenant_type_used_in_tenant",
      "API.INVALID_TEXT_MESSAGE_ID": "Invalid_text_message_id",
      "API.TEXT_MESSAGE_NOT_FOUND": "Text_message_not_found",
      "API.INVALID_DISPLAY_NAME": "Invalid_display_name",
      "API.INVALID_IS_ADMIN_VALUE": "Invalid_is_admin_value",
      "API.USER_NAME_IS_ALREADY_IN_USE": "User_name_is_already_in_use",
      "API.EMAIL_IS_ALREADY_IN_USE": "Email_is_already_in_use",
      "API.INVALID_USER_ID": "Invalid_user_id",
      "API.INVALID_USER_NAME_OR_EMAIL": "Invalid_user_name_or_email",
      "API.INVALID_OLD_PASSWORD": "Invalid_old_password",
      "API.INVALID_NEW_PASSWORD": "Invalid_new_password",
      "API.ADMINISTRATOR_SESSION_NOT_FOUND": "Administrator_session_not_found",
      "API.ADMINISTRATOR_SESSION_TIMEOUT": "Administrator_session_timeout",
      "API.INVALID_VIRTUAL_METER_NAME": "Invalid_virtual_meter_name",
      "API.INVALID_EXPRESSION_OBJECT": "Invalid_expression_object",
      "API.INVALID_EQUATION_IN_EXPRESSION": "Invalid_equation_in_expression",
      "API.EMPTY_VARIABLES_ARRAY": "Empty_variables_array",
      "API.INVALID_VARIABLE_NAME": "Invalid_variable_name",
      "API.INVALID_VARIABLE_METER_TYPE": "Invalid_variable_meter_type",
      "API.INVALID_VARIABLE_METER_ID": "Invalid_variable_meter_id",
      "API.VIRTUAL_METER_NAME_IS_ALREADY_IN_USE": "Virtual_meter_name_is_already_in_use",
      "API.METER_OF_VARIABLE_NOT_FOUND": "Meter_of_variable_not_found",
      "API.OFFLINE_METER_OF_VARIABLE_NOT_FOUND": "Offline_meter_of_variable_not_found",
      "API.VIRTUAL_METER_OF_VARIABLE_NOT_FOUND": "Virtual_meter_of_variable_not_found",
      "API.THERE_IS_RELATION_WITH_OTHER_VIRTUAL_METERS": "There_is_relation_with_other_virtual_meters",
      "API.INVALID_WEB_MESSAGE_ID": "Invalid_web_message_id",
      "API.WEB_MESSAGE_NOT_FOUND": "Web_message_not_found",
      "API.INVALID_REPLY": "Invalid_reply",
      "API.INVALID_WECHAT_MESSAGE_ID": "Invalid_wechat_message_id",
      "API.WECHAT_MESSAGE_NOT_FOUND": "Wechat_message_not_found",
    }
  },
  de: {
    translation: {
      ...
      "API.DATABASE_ERROR": "",
      "API.EXCEPTION": "",
      "API.INVALID_SPACE_ID": "",
      "API.INVALID_ADVANCED_REPORT_ID": "",
      "API.INVALID_COMBINED_EQUIPMENT_ID": "",
      "API.INVALID_DISTRIBUTION_SYSTEM_ID": "",
      "API.INVALID_ENERGY_FLOW_DIAGRAM_ID": "",
      "API.INVALID_EQUIPMENT_ID": "",
      "API.INVALID_equipment_ID": "",
      "API.INVALID_METER_ID": "",
      "API.INVALID_OFFLINE_METER_ID": "",
      "API.INVALID_SHOPFLOOR_ID": "",
      "API.INVALID_STORE_ID": "",
      "API.INVALID_TENANT_ID": "",
      ...
      "API.ADVANCED_REPORT_NOT_FOUND": "",
      "API.ENERGY_CATEGORY_NOT_FOUND": "",
      "API.COMBINED_EQUIPMENT_NOT_FOUND": "",
      "API.USER_NOT_FOUND": "",
      "API.USER_PRIVILEGE_NOT_FOUND": "",
      "API.SPACE_NOT_FOUND": "",
      "API.DISTRIBUTION_SYSTEM_NOT_FOUND": "",
      "API.ENERGY_FLOW_DIAGRAM_NOT_FOUND": "",
      "API.EQUIPMENT_NOT_FOUND": "",
      "API.ENERGY_ITEM_NOT_FOUND": "",
      "API.METER_NOT_FOUND": "",
      "API.OFFLINE_METER_NOT_FOUND": "",
      "API.SHOPFLOOR_NOT_FOUND": "",
      "API.STORE_NOT_FOUND": "",
      "API.TENANT_NOT_FOUND": "",
      "API.VIRTUAL_METER_NOT_FOUND": "",
      "API.INVALID_PERIOD_TYPE": "",
      "API.INVALID_USER_UUID": "",
      ...
      "API.THERE_IS_RELATION_WITH_SPACE": "",
      ...
      "API.COMBINED_EQUIPMENT_METER_RELATION_EXISTED": "",
      "API.COMBINED_EQUIPMENT_METER_RELATION_NOT_FOUND": "",
      "API.COMBINED_EQUIPMENT_OFFLINE_METER_RELATION_EXISTED": "",
      "API.COMBINED_EQUIPMENT_OFFLINE_METER_RELATION_NOT_FOUND": "",
      "API.COMBINED_EQUIPMENT_VIRTUAL_METER_RELATION_EXISTED": "",
      "API.COMBINED_EQUIPMENT_VIRTUAL_METER_RELATION_NOT_FOUND": "",
      "API.INVALID_USER_NAME": "",
      "API.INVALID_EMAIL": "",
      "API.INVALID_USER_PHONE": "",
      "API.CONTACT_NAME_IS_ALREADY_IN_USE": "",
      "API.INVALID_CONTACT_ID": "",
      "API.CONTACT_NOT_FOUND": "",
      "API.THERE_IS_RELATION_WITH_SHOPFLOORS": "",
      "API.THERE_IS_RELATION_WITH_SPACES": "",
      "API.THERE_IS_RELATION_WITH_STORES": "",
      "API.THERE_IS_RELATION_WITH_TENANTS": "",
      "API.INVALID_": "",
      "API.INVALID_CONTACT_NAME": "",
      "API.INVALID_NAME_VALUE": "",
      "API.COST_CENTER_NAME_EXISTS": "",
      "API.COST_CENTER_EXTERNAL_ID_EXISTS": "",
      "API.THERE_IS_RELATION_WITH_EQUIPMENTS": "",
      "API.THERE_IS_RELATION_WITH_COMBINED_EQUIPMENTS": "",
      "API.THERE_IS_RELATION_WITH_TARIFFS": "",
      "API.THERE_IS_RELATION_WITH_METERS": "",
      "API.THERE_IS_RELATION_WITH_OFFLINE_METERS": "",
      "API.THERE_IS_RELATIONSHIP_WITH_SPACES": "",
      "API.TARIFF_NOT_FOUND": "",
      "API.TARIFF_ALREADY_ASSOCIATED_WITH_COST_CENTER": "",
      "API.INVALID_TARIFF_ID": "",
      "API.TARIFF_IS_NOT_ASSOCIATED_WITH_COST_CENTER": "",
      "API.FAILED_TO_UPLOAD_COST_FILE": "",
      "API.TOKEN_NOT_FOUND_IN_HEADERS_PLEASE_LOGIN": "",
      "API.USER_UUID_NOT_FOUND_IN_HEADERS_PLEASE_LOGIN": "",
      "API.INVALID_SESSION_PLEASE_RE_LOGIN": "",
      "API.USER_SESSION_TIMEOUT": "",
      "API.INVALID_USER_PLEASE_RE_LOGIN": "",
      "API.INVALID_COST_FILE_ID": "",
      "API.COST_FILE_NOT_FOUND": "",
      "API.FAILED_TO_RESTORE_COST_FILE": "",
      "API.INVALID_DATA_SOURCE_NAME": "",
      "API.INVALID_GATEWAY_ID": "",
      "API.INVALID_DATA_SOURCE_PROTOCOL": "",
      "API.INVALID_CONNECTION": "",
      "API.DATA_SOURCE_NAME_IS_ALREADY_IN_USE": "",
      "API.INVALID_DATA_SOURCE_ID": "",
      "API.DATA_SOURCE_NOT_FOUND": "",
      "API.THIS_DATA_SOURCE_IS_BEING_USED_BY_A_METER": "",
      "API.INVALID_DISTRIBUTION_CIRCUIT_NAME": "",
      "API.INVALID_DISTRIBUTION_ROOM": "",
      "API.INVALID_SWITCHGEAR": "",
      "API.INVALID_PEAK_LOAD": "",
      "API.INVALID_PEAK_CURRENT": "",
      "API.DISTRIBUTION_CIRCUIT_NAME_IS_ALREADY_IN_USE": "",
      "API.DISTRIBUTION_CIRCUIT_NOT_FOUND": "",
      "API.INVALID_DISTRIBUTION_CIRCUIT_ID": "",
      "API.DISTRIBUTION_CIRCUIT_POINT_RELATION_EXISTED": "",
      "API.DISTRIBUTION_CIRCUIT_POINT_RELATION_NOT_FOUND": "",
      "API.INVALID_DISTRIBUTION_SYSTEM_NAME": "",
      "API.INVALID_SVG": "",
      "API.DISTRIBUTION_SYSTEM_NAME_IS_ALREADY_IN_USE": "",
      "API.THERE_IS_ASSOCIATED_DISTRIBUTION_CIRCUITS": "",
      "API.INVALID_START_DATE_FORMAT": "",
      "API.INVALID_END_DATE_FORMAT": "",
      "API.START_DATETIME_SHOULD_BE_EARLY_THAN_END_DATETIME": "",
      "API.INVALID_EMAIL_MESSAGE_ID": "",
      "API.EMAIL_MESSAGE_NOT_FOUND": "",
      "API.INVALID_EMAIL_SERVER_HOST": "",
      "API.INVALID_PORT": "",
      "API.INVALID_REQUIRES_AUTHENTICATION": "",
      "API.INVALID_PASSWORD": "",
      "API.INVALID_FROM_ADDR": "",
      "API.EMAIL_SERVER_HOST_IS_ALREADY_IN_USE": "",
      "API.INVALID_EMAIL_SERVER_ID": "",
      "API.EMAIL_SERVER_NOT_FOUND": "",
      "API.INVALID_ENERGY_CATEGORY_NAME": "",
      "API.INVALID_UNIT_OF_MEASURE": "",
      "API.INVALID_KGCE": "",
      "API.INVALID_KGCO2E": "",
      "API.ENERGY_CATEGORY_NAME_IS_ALREADY_IN_USE": "",
      "API.INVALID_ENERGY_CATEGORY_ID": "",
      "API.ENERGY_CATEGORY_USED_IN_METER": "",
      "API.ENERGY_CATEGORY_USED_IN_VIRTUAL_METER": "",
      "API.ENERGY_CATEGORY_USED_IN_OFFLINE_METER": "",
      "API.ENERGY_CATEGORY_USED_IN_TARIFFS": "",
      "API.ENERGY_CATEGORY_USED_IN_ENERGY_ITEMS": "",
      "API.INVALID_ENERGY_FLOW_DIAGRAM_NAME": "",
      "API.ENERGY_FLOW_DIAGRAM_NAME_IS_ALREADY_IN_USE": "",
      "API.INVALID_SOURCE_NODE_ID": "",
      "API.INVALID_TARGET_NODE_ID": "",
      "API.ENERGY_FLOW_DIAGRAM_LINK_IS_ALREADY_IN_USE": "",
      "API.SOURCE_NODE_NOT_FOUND": "",
      "API.TARGET_NODE_NOT_FOUND": "",
      "API.INVALID_METER_UUID": "",
      ...
      "API.INVALID_ENERGY_FLOW_DIAGRAM_NODE_ID": "",
      "API.ENERGY_FLOW_DIAGRAM_NODE_NOT_FOUND_OR_NOT_MATCH": "",
      "API.ENERGY_FLOW_DIAGRAM_NODE_NAME_IS_ALREADY_IN_USE": "",
      "API.INVALID_ENERGY_ITEM_NAME": "",
      "API.ENERGY_ITEM_NAME_IS_ALREADY_IN_USE": "",
      "API.INVALID_ENERGY_ITEM_ID": "",
      "API.ENERGY_ITEM_USED_IN_METER": "",
      "API.ENERGY_ITEM_USED_IN_VIRTUAL_METER": "",
      "API.ENERGY_ITEM_USED_IN_OFFLINE_METER": "",
      "API.INVALID_EQUIPMENT_NAME": "",
      "API.EQUIPMENT_NAME_IS_ALREADY_IN_USE": "",
      "API.INVALID_EQUIPMENT_PARAMETER_NAME": "",
      "API.INVALID_EQUIPMENT_PARAMETER_TYPE": "",
      "API.EQUIPMENT_PARAMETER_NAME_IS_ALREADY_IN_USE": "",
      "API.INVALID_DENOMINATOR_METER_UUID": "",
      "API.INVALID_EQUIPMENT_PARAMETER_ID": "",
      "API.EQUIPMENT_PARAMETER_NOT_FOUND_OR_NOT_MATCH": "",
      "API.EQUIPMENT_METER_RELATION_EXISTED": "",
      "API.EQUIPMENT_METER_RELATION_NOT_FOUND": "",
      "API.EQUIPMENT_OFFLINE_METER_RELATION_EXISTED": "",
      "API.EQUIPMENT_OFFLINE_METER_RELATION_NOT_FOUND": "",
      "API.EQUIPMENT_VIRTUAL_METER_RELATION_EXISTED": "",
      "API.EQUIPMENT_VIRTUAL_METER_RELATION_NOT_FOUND": "",
      "API.INVALID_GATEWAY_NAME": "",
      "API.GATEWAY_NAME_IS_ALREADY_IN_USE": "",
      "API.GATEWAY_NOT_FOUND": "",
      "API.THERE_IS_RELATION_WITH_DATA_SOURCES": "",
      "API.INVALID_SERIAL_PORT": "",
      "API.INVALID_BAUD_RATE": "",
      "API.GSM_MODEM_SERIAL_PORT_IS_ALREADY_IN_USE": "",
      "API.INVALID_GSM_MODEM_ID": "",
      "API.GSM_MODEM_NOT_FOUND": "",
      "API.FAILED_TO_UPLOAD_KNOWLEDGE_FILE": "",
      "API.INVALID_KNOWLEDGE_FILE_ID": "",
      "API.KNOWLEDGE_FILE_NOT_FOUND": "",
      "API.FAILED_TO_RESTORE_KNOWLEDGE_FILE": "",
      "API.INVALID_MENU_ID": "",
      "API.INVALID_IS_HIDDEN": "",
      "API.MENU_NOT_FOUND": "",
      "API.INVALID_METER_NAME": "",
      "API.INVALID_IS_COUNTED_VALUE": "",
      "API.INVALID_HOURLY_LOW_LIMIT_VALUE": "",
      "API.INVALID_HOURLY_HIGH_LIMIT_VALUE": "",
      "API.INVALID_MASTER_METER_ID": "",
      "API.METER_NAME_IS_ALREADY_IN_USE": "",
      ...
      "API.THIS_METER_IS_BEING_USED_BY_A_VIRTUAL_METER": "",
      "API.THERE_IS_RELATION_WITH_CHILD_METERS": "",
      "API.THERE_IS_RELATION_WITH_COMBINED_EQUIPMENT_PARAMETERS": "",
      "API.THERE_IS_RELATION_WITH_EQUIPMENT_PARAMETERS": "",
      "API.THERE_IS_RELATION_WITH_POINTS": "",
      "API.THERE_IS_RELATION_WITH_ENERGY_FLOW_DIAGRAM_LINKS": "",
      "API.CANNOT_SET_EXISTING_SUBMETER_AS_MASTER_METER": "",
      "API.METER_POINT_RELATION_EXISTED": "",
      "API.METER_POINT_RELATION_NOT_FOUND": "",
      "API.INVALID_STATUS": "",
      "API.INVALID_END_DATETIME": "",
      "API.INVALID_NOTIFICATION_ID": "",
      "API.NOTIFICATION_NOT_FOUND": "",
      "API.INVALID_OFFLINE_METER_NAME": "",
      "API.OFFLINE_METER_NAME_IS_ALREADY_IN_USE": "",
      "API.ENERGY_ITEM_IS_NOT_BELONG_TO_ENERGY_CATEGORY": "",
      "API.THIS_OFFLINE_METER_IS_BEING_USED_BY_A_VIRTUAL_METER": "",
      "API.THERE_IS_RELATIONSHIP_WITH_EQUIPMENTS": "",
      "API.FAILED_TO_UPLOAD_OFFLINE_METER_FILE": "",
      "API.INVALID_OFFLINE_METER_FILE_ID": "",
      "API.OFFLINE_METER_FILE_NOT_FOUND": "",
      "API.FAILED_TO_RESTORE_OFFLINE_METER_FILE": "",
      "API.INVALID_POINT_NAME": "",
      "API.INVALID_OBJECT_TYPE": "",
      "API.INVALID_UNITS": "",
      "API.INVALID_LOW_LIMIT_VALUE": "",
      "API.INVALID_RATIO_VALUE": "",
      "API.INVALID_IS_TREND_VALUE": "",
      "API.INVALID_IS_VIRTUAL_VALUE": "",
      "API.VIRTUAL_POINT_SHOULD_BE_ANALOG_VALUE": "",
      "API.INVALID_ADDRESS": "",
      "API.POINT_NAME_IS_ALREADY_IN_USE": "",
      "API.THERE_IS_RELATION_WITH_SENSORS": "",
      "API.INVALID_PRIVILEGE_NAME": "",
      "API.INVALID_PRIVILEGE_DATA": "",
      "API.PRIVILEGE_NAME_IS_ALREADY_IN_USE": "",
      "API.INVALID_PRIVILEGE_ID": "",
      "API.THERE_IS_RELATIONSHIP_WITH_USERS": "",
      "API.PRIVILEGE_NOT_FOUND": "",
      "API.INVALID_PRIVILEGE_ID_": "",
      "API.INVALID_RULE_NAME": "",
      "API.INVALID_CATEGORY": "",
      "API.INVALID_FDD_CODE": "",
      "API.INVALID_PRIORITY": "",
      "API.INVALID_CHANNEL": "",
      "API.INVALID_EXPRESSION": "",
      "API.INVALID_MESSAGE_TEMPLATE": "",
      "API.INVALID_IS_ENABLED": "",
      "API.RULE_NAME_IS_ALREADY_IN_USE": "",
      "API.INVALID_RULE_ID": "",
      "API.RULE_NOT_FOUND": "",
      "API.INVALID_SENSOR_NAME": "",
      "API.SENSOR_NAME_IS_ALREADY_IN_USE": "",
      "API.INVALID_SENSOR_ID": "",
      "API.SENSOR_NOT_FOUND": "",
      "API.SENSOR_POINT_RELATION_EXISTED": "",
      "API.SENSOR_POINT_RELATION_NOT_FOUND": "",
      "API.INVALID_SHOPFLOOR_NAME": "",
      "API.INVALID_AREA_VALUE": "",
      "API.SHOPFLOOR_NAME_IS_ALREADY_IN_USE": "",
      "API.THIS_SHOPFLOOR_CAN_NOT_BE_DELETED": "",
      "API.THERE_IS_RELATION_WITH_VIRTUAL_METERS": "",
      "API.SHOPFLOOR_EQUIPMENT_RELATION_EXISTED": "",
      "API.SHOPFLOOR_EQUIPMENT_RELATION_NOT_FOUND": "",
      "API.SHOPFLOOR_METER_RELATION_EXISTED": "",
      "API.SHOPFLOOR_METER_RELATION_NOT_FOUND": "",
      "API.SHOPFLOOR_OFFLINE_METER_RELATION_EXISTED": "",
      "API.SHOPFLOOR_OFFLINE_METER_RELATION_NOT_FOUND": "",
      "API.SHOPFLOOR_POINT_RELATION_EXISTED": "",
      "API.SHOPFLOOR_POINT_RELATION_NOT_FOUND": "",
      "API.SHOPFLOOR_SENSOR_RELATION_EXISTED": "",
      "API.SHOPFLOOR_SENSOR_RELATION_NOT_FOUND": "",
      "API.SHOPFLOOR_VIRTUAL_METER_RELATION_EXISTED": "",
      "API.SHOPFLOOR_VIRTUAL_METER_RELATION_NOT_FOUND": "",
      "API.INVALID_SPACE_NAME": "",
      "API.INVALID_PARENT_SPACE_ID": "",
      "API.INVALID_TIMEZONE_ID": "",
      "API.SPACE_NAME_IS_ALREADY_IN_USE": "",
      "API.PARENT_SPACE_NOT_FOUND": "",
      "API.TIMEZONE_NOT_FOUND": "",
      "API.THIS_SPACE_CAN_NOT_BE_DELETED": "",
      "API.THERE_IS_RELATION_WITH_CHILDREN_SPACES": "",
      "API.SPACE_COMBINED_EQUIPMENT_RELATION_EXISTED": "",
      "API.SPACE_COMBINED_EQUIPMENT_RELATION_NOT_FOUND": "",
      "API.SPACE_EQUIPMENT_RELATION_EXISTED": "",
      "API.SPACE_EQUIPMENT_RELATION_NOT_FOUND": "",
      "API.SPACE_METER_RELATION_EXISTED": "",
      "API.SPACE_METER_RELATION_NOT_FOUND": "",
      "API.SPACE_OFFLINE_METER_RELATION_EXISTED": "",
      "API.SPACE_OFFLINE_METER_RELATION_NOT_FOUND": "",
      "API.SPACE_POINT_RELATION_EXISTED": "",
      "API.SPACE_POINT_RELATION_NOT_FOUND": "",
      "API.SPACE_SENSOR_RELATION_EXISTED": "",
      "API.SPACE_SENSOR_RELATION_NOT_FOUND": "",
      "API.SPACE_SHOPFLOOR_RELATION_EXISTED": "",
      "API.SPACE_SHOPFLOOR_RELATION_NOT_FOUND": "",
      "API.SPACE_STORE_RELATION_EXISTED": "",
      "API.SPACE_STORE_RELATION_NOT_FOUND": "",
      "API.SPACE_TENANT_RELATION_EXISTED": "",
      "API.SPACE_TENANT_RELATION_NOT_FOUND": "",
      "API.SPACE_VIRTUAL_METER_RELATION_EXISTED": "",
      "API.SPACE_VIRTUAL_METER_RELATION_NOT_FOUND": "",
      "API.INVALID_TOKEN": "",
      "API.USER_SESSION_NOT_FOUND": "",
      "API.SPACE_NOT_FOUND_IN_PRIVILEGE": "",
      "API.INVALID_STORE_NAME": "",
      "API.INVALID_ADDRESS_VALUE": "",
      "API.INVALID_LATITUDE_VALUE": "",
      "API.INVALID_LONGITUDE_VALUE": "",
      "API.INVALID_STORE_TYPE_ID": "",
      "API.STORE_NAME_IS_ALREADY_IN_USE": "",
      "API.STORE_TYPE_NOT_FOUND": "",
      "API.STORE_METER_RELATION_EXISTED": "",
      "API.STORE_METER_RELATION_NOT_FOUND": "",
      "API.STORE_OFFLINE_METER_RELATION_EXISTED": "",
      "API.STORE_OFFLINE_METER_RELATION_NOT_FOUND": "",
      "API.STORE_POINT_RELATION_EXISTED": "",
      "API.STORE_POINT_RELATION_NOT_FOUND": "",
      "API.STORE_SENSOR_RELATION_EXISTED": "",
      "API.STORE_SENSOR_RELATION_NOT_FOUND": "",
      "API.STORE_VIRTUAL_METER_RELATION_EXISTED": "",
      "API.STORE_VIRTUAL_METER_RELATION_NOT_FOUND": "",
      "API.INVALID_STORE_TYPE_NAME": "",
      "API.INVALID_STORE_TYPE_DESCRIPTION": "",
      "API.INVALID_STORE_TYPE_SIMPLIFIED_CODE": "",
      "API.STORE_TYPE_NAME_IS_ALREADY_IN_USE": "",
      "API.STORE_TYPE_SIMPLIFIED_CODE_IS_ALREADY_IN_USE": "",
      "API.STORE_TYPE_USED_IN_STORE": "",
      "API.INVALID_TARIFF_TYPE": "",
      "API.INVALID_TARIFF_BLOCK_PRICING": "",
      "API.INVALID_TARIFF_TIME_OF_USE_PRICING": "",
      "API.INVALID_UNIT_OF_PRICE": "",
      "API.TARIFF_NAME_IS_ALREADY_IN_USE": "",
      "API.TARIFF_NOT_EMPTY": "",
      "API.TARIFF_IN_USE": "",
      "API.INVALID_TENANT_NAME": "",
      "API.INVALID_BUILDINGS_VALUE": "",
      "API.INVALID_FLOORS_VALUE": "",
      "API.INVALID_ROOMS_VALUE": "",
      "API.INVALID_TENANT_TYPE_ID": "",
      "API.INVALID_IS_KEY_TENANT_VALUE": "",
      "API.INVALID_LEASE_NUMBER_VALUE": "",
      "API.INVALID_IS_IN_LEASE_VALUE": "",
      "API.TENANT_NAME_IS_ALREADY_IN_USE": "",
      "API.TENANT_TYPE_NOT_FOUND": "",
      "API.THERE_IS_RELATION_WITH_SENSOR": "",
      "API.TENANT_METER_RELATION_EXISTED": "",
      "API.TENANT_METER_RELATION_NOT_FOUND": "",
      "API.TENANT_OFFLINE_METER_RELATION_EXISTED": "",
      "API.TENANT_OFFLINE_METER_RELATION_NOT_FOUND": "",
      "API.TENANT_POINT_RELATION_EXISTED": "",
      "API.TENANT_POINT_RELATION_NOT_FOUND": "",
      "API.TENANT_SENSOR_RELATION_EXISTED": "",
      "API.TENANT_SENSOR_RELATION_NOT_FOUND": "",
      "API.TENANT_VIRTUAL_METER_RELATION_EXISTED": "",
      "API.TENANT_VIRTUAL_METER_RELATION_NOT_FOUND": "",
      "API.INVALID_TENANT_TYPE_NAME": "",
      "API.INVALID_TENANT_TYPE_DESCRIPTION": "",
      "API.INVALID_TENANT_TYPE_SIMPLIFIED_CODE": "",
      "API.TENANT_TYPE_NAME_IS_ALREADY_IN_USE": "",
      "API.TENANT_TYPE_SIMPLIFIED_CODE_IS_ALREADY_IN_USE": "",
      "API.TENANT_TYPE_USED_IN_TENANT": "",
      "API.INVALID_TEXT_MESSAGE_ID": "",
      "API.TEXT_MESSAGE_NOT_FOUND": "",
      "API.INVALID_DISPLAY_NAME": "",
      "API.INVALID_IS_ADMIN_VALUE": "",
      "API.USER_NAME_IS_ALREADY_IN_USE": "",
      "API.EMAIL_IS_ALREADY_IN_USE": "",
      "API.INVALID_USER_ID": "",
      "API.INVALID_USER_NAME_OR_EMAIL": "",
      "API.INVALID_OLD_PASSWORD": "",
      "API.INVALID_NEW_PASSWORD": "",
      "API.ADMINISTRATOR_SESSION_NOT_FOUND": "",
      "API.ADMINISTRATOR_SESSION_TIMEOUT": "",
      "API.INVALID_VIRTUAL_METER_NAME": "",
      "API.INVALID_EXPRESSION_OBJECT": "",
      "API.INVALID_EQUATION_IN_EXPRESSION": "",
      "API.EMPTY_VARIABLES_ARRAY": "",
      "API.INVALID_VARIABLE_NAME": "",
      "API.INVALID_VARIABLE_METER_TYPE": "",
      "API.INVALID_VARIABLE_METER_ID": "",
      "API.VIRTUAL_METER_NAME_IS_ALREADY_IN_USE": "",
      "API.METER_OF_VARIABLE_NOT_FOUND": "",
      "API.OFFLINE_METER_OF_VARIABLE_NOT_FOUND": "",
      "API.VIRTUAL_METER_OF_VARIABLE_NOT_FOUND": "",
      "API.THERE_IS_RELATION_WITH_OTHER_VIRTUAL_METERS": "",
      "API.INVALID_WEB_MESSAGE_ID": "",
      "API.WEB_MESSAGE_NOT_FOUND": "",
      "API.INVALID_REPLY": "",
      "API.INVALID_WECHAT_MESSAGE_ID": "",
      "API.WECHAT_MESSAGE_NOT_FOUND": "",
    }
  },
  zh_cn: {
    translation: {
