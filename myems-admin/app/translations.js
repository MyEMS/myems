    ...
    $translateProvider
        ...
        .translations('zh_CN', {
            ...
            API: {
                ...
                DISTRIBUTION_SYSTEM_NAME_IS_ALREADY_IN_USE: 'Distribution System Name Is Already In Use',
                DISTRIBUTION_SYSTEM_NOT_FOUND: 'Distribution System Not Found',
                DATE_LOCAL_USED_IN_WORKING_CALENDAR: '本地日期在工作日历中已使用',
                ...
                SPACE_VIRTUAL_METER_RELATION_EXISTS: 'Space Virtual Meter Relation Exists',
                SPACE_VIRTUAL_METER_RELATION_NOT_FOUND: 'Space Virtual Meter Relation Not Found',
                SPACE_WORKING_CALENDAR_RELATION_EXISTS: '空间与工作日历关系已存在',
                SPACE_WORKING_CALENDAR_RELATION_NOT_FOUND: '空间与工作日历关系不存在',
                STORE_WORKING_CALENDAR_RELATION_EXISTS: '门店与工作日历关系已存在',
                STORE_WORKING_CALENDAR_RELATION_NOT_FOUND: '门店与工作日历关系不存在',
                TENANT_WORKING_CALENDAR_RELATION_EXISTS: '租户与工作日历关系已存在',
                TENANT_WORKING_CALENDAR_RELATION_NOT_FOUND: '租户与工作日历关系不存在',
                SHOPFLOOR_WORKING_CALENDAR_RELATION_EXISTS: '车间与工作日历关系已存在',
                SHOPFLOOR_WORKING_CALENDAR_RELATION_NOT_FOUND: '车间与工作日历关系不存在',
                START_DATETIME_MUST_BE_EARLIER_THAN_END_DATETIME: 'Start Datetime Must Be Earlier Than End Datetime',
                STORE_METER_RELATION_EXISTS: 'Store Meter Relation Exists',
                STORE_METER_RELATION_NOT_FOUND: 'Store Meter Relation Not Found',
                STORE_NAME_IS_ALREADY_IN_USE: 'Store Name Is Already In Use',
	    ...
	    .translations('de', {
            ...
            API: {
                ...
                DISTRIBUTION_SYSTEM_NAME_IS_ALREADY_IN_USE: 'Distribution System Name Is Already In Use',
                DISTRIBUTION_SYSTEM_NOT_FOUND: 'Distribution System Not Found',
                DATE_LOCAL_USED_IN_WORKING_CALENDAR: 'Lokal verwendetes Datum im Arbeitskalender',
                ...
                SPACE_VIRTUAL_METER_RELATION_EXISTS: 'Space Virtual Meter Relation Exists',
                SPACE_VIRTUAL_METER_RELATION_NOT_FOUND: 'Space Virtual Meter Relation Not Found',
                SPACE_WORKING_CALENDAR_RELATION_EXISTS: 'Eine Raum-zu-Arbeit-Kalenderbeziehung ist bereits vorhanden',
                SPACE_WORKING_CALENDAR_RELATION_NOT_FOUND: 'Der Bereich hat keine Beziehung zum Arbeitskalender',
