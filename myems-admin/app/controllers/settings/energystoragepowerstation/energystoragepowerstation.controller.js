    ...
    SweetAlert) {
		...
		$scope.addEnergyStoragePowerStation = function() {
			...
			modalInstance.result.then(function(energystoragepowerstation) {
				...
				if (energystoragepowerstation.longitude_point != null && energystoragepowerstation.longitude_point.id != null ) {
					energystoragepowerstation.longitude_point_id = energystoragepowerstation.longitude_point.id;
				} else {
					energystoragepowerstation.longitude_point_id = undefined;
				}
				if (energystoragepowerstation.latitude_point != null && energystoragepowerstation.latitude_point.id != null ) {
					energystoragepowerstation.latitude_point_id = energystoragepowerstation.latitude_point.id;
				} else {
					energystoragepowerstation.latitude_point_id = undefined;
				}
				if (energystoragepowerstation.svg2 != null && energystoragepowerstation.svg2.id != null) {
					energystoragepowerstation.svg2_id = energystoragepowerstation.svg2.id;
				}
				if (energystoragepowerstation.svg3 != null && energystoragepowerstation.svg3.id != null) {
					energystoragepowerstation.svg3_id = energystoragepowerstation.svg3.id;
				}
				if (energystoragepowerstation.svg4 != null && energystoragepowerstation.svg4.id != null) {
					energystoragepowerstation.svg4_id = energystoragepowerstation.svg4.id;
				}
				if (energystoragepowerstation.svg5 != null && energystoragepowerstation.svg5.id != null) {
					energystoragepowerstation.svg5_id = energystoragepowerstation.svg5.id;
				}
				let headers = { "User-UUID": $scope.cur_user.uuid, "Token": $scope.cur_user.token };
		...
		$scope.editEnergyStoragePowerStation = function(energystoragepowerstation) {
			...
			modalInstance.result.then(function(modifiedEnergyStoragePowerStation) {
				...
				if (modifiedEnergyStoragePowerStation.longitude_point != null && modifiedEnergyStoragePowerStation.longitude_point.id != null ) {
					modifiedEnergyStoragePowerStation.longitude_point_id = modifiedEnergyStoragePowerStation.longitude_point.id;
				} else {
					modifiedEnergyStoragePowerStation.longitude_point_id = undefined;
				}
				if (modifiedEnergyStoragePowerStation.latitude_point != null && modifiedEnergyStoragePowerStation.latitude_point.id != null ) {
					modifiedEnergyStoragePowerStation.latitude_point_id = modifiedEnergyStoragePowerStation.latitude_point.id;
				} else {
					modifiedEnergyStoragePowerStation.latitude_point_id = undefined;
				}
				if (modifiedEnergyStoragePowerStation.svg2 != null && modifiedEnergyStoragePowerStation.svg2.id != null) {
					modifiedEnergyStoragePowerStation.svg2_id = modifiedEnergyStoragePowerStation.svg2.id;
				}
				if (modifiedEnergyStoragePowerStation.svg3 != null && modifiedEnergyStoragePowerStation.svg3.id != null) {
					modifiedEnergyStoragePowerStation.svg3_id = modifiedEnergyStoragePowerStation.svg3.id;
				}
				if (modifiedEnergyStoragePowerStation.svg4 != null && modifiedEnergyStoragePowerStation.svg4.id != null) {
					modifiedEnergyStoragePowerStation.svg4_id = modifiedEnergyStoragePowerStation.svg4.id;
				}
				if (modifiedEnergyStoragePowerStation.svg5 != null && modifiedEnergyStoragePowerStation.svg5.id != null) {
					modifiedEnergyStoragePowerStation.svg5_id = modifiedEnergyStoragePowerStation.svg5.id;
				}
