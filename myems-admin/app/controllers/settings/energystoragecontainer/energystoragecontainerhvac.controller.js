...
// Energy Storage Container HVAC controller - container association

app.controller(
  "EnergyStorageContainerHVACController",
  function (
    $scope,
    $rootScope,
    $window,
    ...
    // Load energy storage container hva cs by energy storage container id
    $scope.getEnergyStorageContainerHVACsByEnergyStorageContainerID = function (
      id
    ) {
      let headers = {
        "User-UUID": $scope.cur_user.uuid,
      ...
      EnergyStorageContainerHVACService.getEnergyStorageContainerHVACsByEnergyStorageContainerID(
        id,
        headers,
        function (response) {
          if (angular.isDefined(response.status) && response.status === 200) {
    ...
    $scope.changeEnergyStorageContainer = function (item, model) {
      ...
      $scope.getEnergyStorageContainerHVACsByEnergyStorageContainerID(
    ...
    // Open add modal and create energy storage container hvac
    $scope.addEnergyStorageContainerHVAC = function () {
      var modalInstance = $uibModal.open({
        templateUrl:
          "views/settings/energystoragecontainer/energystoragecontainerhvac.model.html",
      ...
      modalInstance.result.then(
        function (energystoragecontainerhvac) {
          let headers = {
            "User-UUID": $scope.cur_user.uuid,
            Token: $scope.cur_user.token,
          };
          EnergyStorageContainerHVACService.addEnergyStorageContainerHVAC(
            $scope.currentEnergyStorageContainer.id,
                ...
                toaster.pop({
                  ...
                  body: $translate.instant("TOASTER.SUCCESS_ADD_BODY", {
                    template: $translate.instant(
                      "ENERGY_STORAGE_CONTAINER.ENERGY_STORAGE_CONTAINER_HVAC"
                    ),
                  }),
    ...
    // Open edit modal and update energy storage container hvac
    $scope.editEnergyStorageContainerHVAC = function (
      energystoragecontainerhvac
    ) {
      var modalInstance = $uibModal.open({
        templateUrl:
        ...
        resolve: {
          params: function () {
            return {
              energystoragecontainerhvac: angular.copy(
                energystoragecontainerhvac
              ),
              points: angular.copy($scope.points),
            };
      ...
      modalInstance.result.then(
        function (modifiedEnergyStorageContainerHVAC) {
          let headers = {
            "User-UUID": $scope.cur_user.uuid,
            Token: $scope.cur_user.token,
          };
          EnergyStorageContainerHVACService.editEnergyStorageContainerHVAC(
            $scope.currentEnergyStorageContainer.id,
            modifiedEnergyStorageContainerHVAC,
            headers,
            function (response) {
              if (
                angular.isDefined(response.status) &&
    ...
    $scope.bindEnergyStorageContainerHVACPoint = function (
      energystoragecontainerhvac
    ) {
      var modalInstance = $uibModal.open({
        templateUrl:
          "views/settings/energystoragecontainer/energystoragecontainerhvacpoint.model.html",
    ...
    // Confirm and delete energy storage container hvac
    $scope.deleteEnergyStorageContainerHVAC = function (
      energystoragecontainerhvac
    ) {
      SweetAlert.swal(
        {
        ...
        function (isConfirm) {
          if (isConfirm) {
            ...
            EnergyStorageContainerHVACService.deleteEnergyStorageContainerHVAC(
              $scope.currentEnergyStorageContainer.id,
...
app.controller(
  "ModalAddEnergyStorageContainerHVACCtrl",
  function ($scope, $uibModalInstance, params) {
    $scope.operation =
      "ENERGY_STORAGE_CONTAINER.ADD_ENERGY_STORAGE_CONTAINER_HVAC";
...
app.controller(
  "ModalEditEnergyStorageContainerHVACCtrl",
  function ($scope, $uibModalInstance, params) {
    $scope.operation =
      "ENERGY_STORAGE_CONTAINER.EDIT_ENERGY_STORAGE_CONTAINER_HVAC";
...
app.controller(
  "ModalBindEnergyStorageContainerHVACCtrl",
  function (
    $scope,
    $uibModalInstance,
    toaster,
    ...
    EnergyStorageContainerHVACService.getPointsByHVACID(
      $scope.energystoragecontainerid,
      $scope.energystoragecontainerhvac.id,
      headers,
      function (response) {
        if (angular.isDefined(response.status) && response.status === 200) {
    ...
    $scope.pairPoint = function (dragEl, dropEl) {
      ...
      let headers = { "User-UUID": params.user_uuid, Token: params.token };
      EnergyStorageContainerHVACService.addPair(
        params.energystoragecontainerid,
        params.energystoragecontainerhvac.id,
        pointid,
        headers,
        function (response) {
    ...
    $scope.deletePointPair = function (dragEl, dropEl) {
      ...
      let headers = { "User-UUID": params.user_uuid, Token: params.token };
      EnergyStorageContainerHVACService.deletePair(
        params.energystoragecontainerid,
        params.energystoragecontainerhvac.id,
        pointid,
        headers,
