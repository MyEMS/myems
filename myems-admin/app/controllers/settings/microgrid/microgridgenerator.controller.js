...
// Microgrid Generator controller - CRUD and settings management
...
app.controller('MicrogridGeneratorController', function(
	...
	$scope.getAllMeters = function() {
  	...
  	// Load microgrid generators by microgrid id
  	...
  	// Open add modal and create microgrid generator
  	...
  	// Open edit modal and update microgrid generator
  	...
  	// Confirm and delete microgrid generator
