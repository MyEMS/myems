...
// Microgrid Grid controller - CRUD and settings management
...
app.controller('MicrogridGridController', function(
	...
	$scope.getAllMeters = function() {
  	...
  	// Load microgrid grids by microgrid id
  	...
  	// Open add modal and create microgrid grid
  	...
  	// Open edit modal and update microgrid grid
  	...
  	// Confirm and delete microgrid grid
