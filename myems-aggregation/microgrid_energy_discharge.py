...
def main(logger):
    ...
    while True:
        ...
        try:
            ...
            logger.error("Error in step 1.1 of microgrid_energy_discharge.main " + str(e))
            if cursor_system_db:
        ...
        try:
            ...
            logger.error("Error in step 1.2 of microgrid_energy_discharge.main " + str(e))
            # sleep and continue the outer loop to reconnect the database
            time.sleep(60)
            continue
        finally:
...
def worker(microgrid):
    ...
    try:
        ...
        error_string = "Error in step 1.1 of microgrid_energy_discharge.worker " + str(e)
        if cursor_system_db:
            cursor_system_db.close()
        if cnx_system_db:
            cnx_system_db.close()
    ...
    try:
        ...
        error_string = "Error in step 1.2 of microgrid_energy_discharge.worker " + str(e)
        if cursor_system_db:
            cursor_system_db.close()
        if cnx_system_db:
            cnx_system_db.close()
    ...
    try:
        ...
        error_string = "Error in step 2.1 of microgrid_energy_discharge.worker " + str(e)
        if cursor_energy_db:
    ...
    try:
        ...
        error_string = "Error in step 2.2 of microgrid_energy_discharge.worker " + str(e)
        if cursor_energy_db:
            cursor_energy_db.close()
        if cnx_energy_db:
            cnx_energy_db.close()
    ...
    try:
        ...
        error_string = "Error in step 3.1 of microgrid_energy_discharge.worker " + str(e)
        if cursor_energy_db:
            cursor_energy_db.close()
        if cnx_energy_db:
            cnx_energy_db.close()
    ...
    try:
        ...
        error_string = "Error in step 5 of microgrid_energy_discharge.worker " + str(e)
        if cursor_energy_db:
            cursor_energy_db.close()
        if cnx_energy_db:
            cnx_energy_db.close()
    ...
    while len(aggregated_values) > 0:
        ...
        try:
            ...
            error_string = "Error in step 6.1 of microgrid_energy_discharge.worker " + str(e)
            print(error_string)
            if cursor_energy_db:
                cursor_energy_db.close()
            if cnx_energy_db:
