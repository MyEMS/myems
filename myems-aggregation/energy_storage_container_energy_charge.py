...
def main(logger):
    ...
    while True:
        ...
        try:
            ...
            logger.error("Error in step 1.1 of energy_storage_container_energy_charge.main " + str(e))
            if cursor_system_db:
        ...
        try:
            ...
            logger.error("Error in step 1.2 of energy_storage_container_energy_charge.main " + str(e))
            # sleep and continue the outer loop to reconnect the database
            time.sleep(60)
            continue
        finally:
...
def worker(energy_storage_container):
    ...
    try:
        ...
        error_string = "Error in step 1.1 of energy_storage_container_energy_charge.worker " + str(e)
        if cursor_system_db:
            cursor_system_db.close()
        if cnx_system_db:
            cnx_system_db.close()
    ...
    try:
        ...
        error_string = "Error in step 1.2 of energy_storage_container_energy_charge.worker " + str(e)
        if cursor_system_db:
            cursor_system_db.close()
        if cnx_system_db:
            cnx_system_db.close()
    ...
    try:
        ...
        error_string = "Error in step 2.1 of energy_storage_container_energy_charge.worker " + str(e)
        if cursor_energy_db:
    ...
    try:
        ...
        error_string = "Error in step 2.2 of energy_storage_container_energy_charge.worker " + str(e)
        if cursor_energy_db:
            cursor_energy_db.close()
        if cnx_energy_db:
            cnx_energy_db.close()
    ...
    try:
        ...
        error_string = "Error in step 3.1 of energy_storage_container_energy_charge.worker " + str(e)
        if cursor_energy_db:
            cursor_energy_db.close()
        if cnx_energy_db:
            cnx_energy_db.close()
    ...
    try:
        ...
        error_string = "Error in step 5 of energy_storage_container_energy_charge.worker " + str(e)
        if cursor_energy_db:
            cursor_energy_db.close()
        if cnx_energy_db:
            cnx_energy_db.close()
    ...
    while len(aggregated_values) > 0:
        ...
        try:
            add_values = (" INSERT INTO tbl_energy_storage_container_charge_hourly "
            ...
            error_string = "Error in step 6.1 of energy_storage_container_energy_charge.worker " + str(e)
            print(error_string)
            if cursor_energy_db:
                cursor_energy_db.close()
            if cnx_energy_db:
