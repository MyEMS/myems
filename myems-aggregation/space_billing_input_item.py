"""
MyEMS Space Billing Input Item Aggregation Service
...
associated with each space and calculates the corresponding billing amounts using time-of-use tariffs.
...
def main(logger):
    """
    Main function for space billing input item aggregation service.
    ...
    3. For each space, processes billing calculations by energy items
    ...
    while True:
        ...
        for space in space_list:
            ...
            # Query energy consumption data by energy items for this space since the last processed timestamp
