"""
MyEMS Equipment Billing Input Item Aggregation Service
...
associated with each equipment and calculates the corresponding billing amounts using time-of-use tariffs.
...
def main(logger):
    """
    Main function for equipment billing input item aggregation service.
    ...
    3. For each equipment, processes billing calculations by energy items
    ...
    while True:
        ...
        for equipment in equipment_list:
            ...
            # Query energy consumption data by energy items for this equipment since the last processed timestamp
