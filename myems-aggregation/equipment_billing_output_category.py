"""
MyEMS Equipment Billing Output Category Aggregation Service

This module handles the calculation of billing costs for equipment based on energy output consumption
and tariff structures. It processes energy output data from various sources associated with
...
3. Fetches energy output consumption data since the last processed timestamp
...
def main(logger):
    """
    Main function for equipment billing output category aggregation service.

    This function runs continuously and processes billing calculations for all equipment
    based on energy output. It retrieves energy output data, applies tariffs, and
    ...
    3. For each equipment, processes billing calculations for energy output
    ...
    while True:
        ...
        try:
            ...
            logger.error("Error in step 1.1 of equipment_billing_output_category " + str(e))
            if cursor_system_db:
        ...
        for equipment in equipment_list:
            ...
            # Query energy output consumption data for this equipment since the last processed timestamp
            ...
            if len(billing_dict) > 0:
                try:
                    ...
                    query = (" INSERT INTO tbl_equipment_output_category_hourly "
