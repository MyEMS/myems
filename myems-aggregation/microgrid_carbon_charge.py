...
def main(logger):
    ...
    while True:
        ...
        try:
            ...
            logger.error("Error in step 1.1 of microgrid_carbon_charge " + str(e))
            if cursor_system_db:
        ...
        try:
            ...
            logger.error("Error in step 1.2 of microgrid_carbon_charge " + str(e))
            if cursor_system_db:
                cursor_system_db.close()
            if cnx_system_db:
                cnx_system_db.close()
        ...
        try:
            ...
            logger.error("Error in step 1.3 of microgrid_carbon_charge " + str(e))
            if cursor_energy_db:
        ...
        try:
            ...
            logger.error("Error in step 1.4 of microgrid_carbon_charge " + str(e))
            if cursor_carbon_db:
        ...
        for microgrid in microgrid_list:
            ...
            try:
                ...
                logger.error("Error in step 2 of microgrid_carbon_charge " + str(e))
            ...
            if len(carbon_dict) > 0:
                try:
                    ...
                    logger.error("Error in step 6 of microgrid_carbon_charge " + str(e))
                    # break the for microgrid loop
                    break
