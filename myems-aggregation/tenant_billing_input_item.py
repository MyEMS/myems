"""
MyEMS Tenant Billing Input Item Aggregation Service
...
associated with each tenant and calculates the corresponding billing amounts using time-of-use tariffs.
...
def main(logger):
    """
    Main function for tenant billing input item aggregation service.
    ...
    3. For each tenant, processes billing calculations by energy items
    ...
    while True:
        ...
        for tenant in tenant_list:
            ...
            # Query energy consumption data by energy items for this tenant since the last processed timestamp
