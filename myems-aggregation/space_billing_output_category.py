"""
MyEMS Space Billing Output Category Aggregation Service

This module handles the calculation of billing costs for spaces based on energy output consumption
...
def main(logger):
    """
    Main function for space billing output category aggregation service.
    ...
    3. For each space, processes billing calculations for energy output
    ...
    while True:
        ...
        for space in space_list:
            ...
            # Query energy output consumption data for this space since the last processed timestamp
            ...
            if len(billing_dict) > 0:
                try:
                    ...
                    query = (" INSERT INTO tbl_space_output_category_hourly "
