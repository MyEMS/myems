  ...
  $translateProvider
    .translations('en', {
      ...
      API: {
        ...
        TOTAL_STEAM_VALUE:
          'Total electricity cost + Total tap water fee + Steam production value',
        ...
        C_ENERGY_NPDTECRS:
          '--8.Non-production Day Theoretical Energy Consumption Ratio Standard',
        ...
        C_COST_NPDTCRS:
          '--8.Non-production Day Theoretical Cost Ratio Standard',
        ...
        TENANT_ALREADY_ASSOCIATED_WITH_METER:
          'Tenant already Associated with Meter',
        TENANT_ALREADY_ASSOCIATED_WITH_OFFLINE_METER:
          'Tenant already Associated with Offline Meter',
        TENANT_ALREADY_ASSOCIATED_WITH_VIRTUAL_METER:
          'Tenant already Associated with Virtual Meter',
        TENANT_AND_METER_RELATIONSHIP_NOT_FOUND:
          'Tenant and Meter Relationship Not Found',
        TENANT_AND_OFFLINE_METER_RELATIONSHIP_NOT_FOUND:
          'Tenant and Offline Meter Relationship Not Found',
        TENANT_AND_VIRTUAL_METER_RELATIONSHIP_NOT_FOUND:
          'Tenant and Virtual Meter Relationship Not Found',
        STORE_NOT_FOUND: 'Store Not Found',
        STORE_ALREADY_ASSOCIATED_WITH_METER:
          'Store already Associated with Meter',
        STORE_ALREADY_ASSOCIATED_WITH_OFFLINE_METER:
          'Store already Associated with Offline Meter',
        STORE_ALREADY_ASSOCIATED_WITH_VIRTUAL_METER:
          'Store already Associated with Virtual Meter',
        STORE_AND_METER_RELATIONSHIP_NOT_FOUND:
          'Store and Meter Relationship Not Found',
        STORE_AND_OFFLINE_METER_RELATIONSHIP_NOT_FOUND:
          'Store and Offline Meter Relationship Not Found',
        STORE_AND_VIRTUAL_METER_RELATIONSHIP_NOT_FOUND:
          'Store and Virtual Meter Relationship Not Found',
        ...
        EQUIPMENT_METER_RELATIONSHIP_EXISTED:
          'Equipment Meter Relationship Existed',
        EQUIPMENT_METER_RELATIONSHIP_NOT_FOUND:
          'Equipment Meter Relationship Not Found',
        EQUIPMENT_NOT_FOUND: 'Equipment Not Found',
        EQUIPMENT_OFFLINE_METER_RELATIONSHIP_NOT_FOUND:
          'Equipment Offline Meter Relationship Not Found',
        EQUIPMENT_OFFLINE_METER_RELATIONSHIP_ALREADY_EXISTS:
          'Equipment Offline Meter Relationship already Exists',
        EQUIPMENT_VIRTUAL_METER_RELATIONSHIP_NOT_FOUND:
          'Equipment Virtual Meter Relationship Not Found',
        EQUIPMENT_VIRTUAL_METER_RELATIONSHIP_ALREADY_EXISTS:
          'Equipment Virtual Meter Relationship already Exists',
        COMBINED_EQUIPMENT_METER_RELATIONSHIP_EXISTED:
          'Combined Equipment Meter Relationship Existed',
        COMBINED_EQUIPMENT_METER_RELATIONSHIP_NOT_FOUND:
          'Combined Equipment Meter Relationship Not Found',
        COMBINED_EQUIPMENT_NOT_FOUND: 'Combined Equipment Not Found',
        COMBINED_EQUIPMENT_OFFLINE_METER_RELATIONSHIP_NOT_FOUND:
          'Combined Equipment Offline Meter Relationship Not Found',
        COMBINED_EQUIPMENT_OFFLINE_METER_RELATIONSHIP_ALREADY_EXISTS:
          'Combined Equipment Offline Meter Relationship already Exists',
        COMBINED_EQUIPMENT_VIRTUAL_METER_RELATIONSHIP_NOT_FOUND:
          'Combined Equipment Virtual Meter Relationship Not Found',
        COMBINED_EQUIPMENT_VIRTUAL_METER_RELATIONSHIP_ALREADY_EXISTS:
          'Combined Equipment Virtual Meter Relationship already Exists',
        SPACE_NOT_FOUND: 'Space Not Found',
        SPACE_ALREADY_ASSOCIATED_WITH_METER:
          'Space already Associated with Meter',
        SPACE_ALREADY_ASSOCIATED_WITH_OFFLINE_METER:
          'Space already Associated with Offline Meter',
        SPACE_ALREADY_ASSOCIATED_WITH_VIRTUAL_METER:
          'Space already Associated with Virtual Meter',
        SPACE_AND_METER_RELATIONSHIP_NOT_FOUND:
          'Space and Meter Relationship Not Found',
        SPACE_AND_OFFLINE_METER_RELATIONSHIP_NOT_FOUND:
          'Space and Offline Meter Relationship Not Found',
        SPACE_AND_VIRTUAL_METER_RELATIONSHIP_NOT_FOUND:
          'Space and Virtual Meter Relationship Not Found',
        ...
        INVALID_PRIVILEGE_TO_RESET_PASSWORD:
          'Invalid Privilege to Reset Password',
        ...
        INVALID_END_DATE_TIME:
          'Invalid end date(full expected format: YYYY-MM-DDTHH:MM:SS)',
        INVALID_END_DATE_TIME_YMD:
          'Invalid end date time (expected format: YYYY-MM-DD)',
        INVALID_END_DATE_TIME_YMDHMS:
          'Invalid end date time (expected format: YYYY-MM-DDTHH:MM:SS)',
        INVALID_EQUATION_IN_EXPRESSION: 'Invalid equation in expression',
        INVALID_EQUIPMENTS_SHUTDOWN_RATE_VALUE:
          'Invalid equipments_shutdown_rate value',
        INVALID_COMBINED_EQUIPMENTS_SHUTDOWN_RATE_VALUE:
          'Invalid combined equipments_shutdown_rate value',
        ...
        INVALID_IS_EQUIPMENT_STATUS_COUNTED_VALUE:
          'Invalid is_equipment_status_counted value',
        INVALID_IS_COMBINED_EQUIPMENT_STATUS_COUNTED_VALUE:
          'Invalid is_combined_equipment_status_counted value',
        ...
        INVALID_PERIOD_FORMAT:
          "Invalid period (expected 'year', 'month', 'day' or 'hour')",
        ...
        INVALID_START_DATE_TIME:
          'Invalid start date time (full expected format: YYYY-MM-DDTHH:MM:SS)',
        INVALID_START_DATE_TIME_YMD:
          'Invalid start date time (expected format: YYYY-MM-DD)',
        INVALID_START_DATE_TIME_YMDHMS:
          'Invalid start date time (expected format: YYYY-MM-DDTHH:MM:SS)',
        ...
        LINE_PRODUCT_RELATIONSHIP_NOT_FOUND:
          'Line Product Relationship Not Found',
        LINE_ALREADY_ASSOCIATED_WITH_METER:
          'Line already Associated with Meter',
        LINE_ALREADY_ASSOCIATED_WITH_OFFLINE_METER:
          'Line already Associated with Offline Meter',
        LINE_ALREADY_ASSOCIATED_WITH_VIRTUAL_METER:
          'Line already Associated with Virtual Meter',
        LINE_AND_METER_RELATIONSHIP_NOT_FOUND:
          'Line and Meter Relationship Not Found',
        LINE_AND_OFFLINE_METER_RELATIONSHIP_NOT_FOUND:
          'Line and Offline Meter Relationship Not Found',
        LINE_AND_VIRTUAL_METER_RELATIONSHIP_NOT_FOUND:
          'Line and Virtual Meter Relationship Not Found',
        METER_NOT_FOUND: 'Meter Not Found',
        METER_POINT_RELATIONSHIP_EXISTED: 'Meter Point Relationship Existed',
        METER_POINT_RELATIONSHIP_NOT_FOUND:
          'Meter Point Relationship Not Found',
        ...
        START_DATE_SHOULD_BE_EARLY_THAN_END_DATE:
          'Start date should be early than end date',
        START_DATETIME_SHOULD_BE_EARLY_THAN_END_DATETIME:
          'Start datetime should be early than end datetime',
        TARIFF_IN_USE: 'Tariff In Use',
        TARIFF_NOT_EMPTY: 'Tariff Not Empty',
        TARIFF_NOT_FOUND: 'Tariff Not Found',
        TARIFF_ALREADY_ASSOCIATED_WITH_COSTCENTER:
          'Tariff already Associated with Cost Center',
        TARIFF_ALREADY_ASSOCIATED_WITH_SPACE:
          'Tariff already Associated with Space',
        TARIFF_IS_NOT_ASSOCIATED_WITH_COST_CENTER:
          'Tariff is not associated with Cost Center',
        TARIFF_IS_NOT_ASSOCIATED_WITH_SPACE:
          'Tariff is not associated with Space',
        POINT_ALREADY_ASSOCIATED_WITH_SPACE:
          'Point already Associated with Space',
        POINT_IS_NOT_ASSOCIATED_WITH_SPACE:
          'Point is not associated with Space',
        TEAM_NOT_FOUND: 'Team Not Found',
        TEXT_MESSAGE_NOT_FOUND: 'Text Message Not Found',
        THERE_IS_RELATIONSHIP_WITH_TENANTS:
          'There is relationship with Tenants',
        THERE_IS_RELATIONSHIP_WITH_STORES: 'There is relationship with Stores',
        THERE_IS_RELATIONSHIP_WITH_COMPANIES:
          'There is relationship with companies',
        THERE_IS_RELATIONSHIP_WITH_EQUIPMENTS:
          'There is relationship with equipments',
        THERE_IS_RELATIONSHIP_WITH_COMBINED_EQUIPMENTS:
          'There is relationship with combined equipments',
        ...
        THERE_IS_RELATIONSHIP_WITH_OFFLINE_METERS:
          'There is relationship with offline meters',
        ...
        THERE_IS_RELATIONSHIP_WITH_VIRTUAL_METERS:
          'There is relationship with virtual meters',
        ...
        YOU_DO_NOT_HAVE_PERMISSION_TO_VIEW_THE_DATA:
          'You don\t have permission to view the data.',
      },
    })
    .translations('cn', {
      MY_EMS_NAME: 'MyEMS',
      ...
      API: {
        ...
        INVALID_END_DATE_TIME:
          '无效的结束日期（完整预期格式：YYYY-MM-DDTHH：MM：SS）',
        INVALID_END_DATE_TIME_YMD:
          '无效的结束日期时间（预期格式:YYYY-MM-DDTHH)',
        INVALID_END_DATE_TIME_YMDHMS:
          '无效的结束日期时间（预期格式:YYYY-MM-DDTHH：MM：SS)',
        INVALID_EQUATION_IN_EXPRESSION: '无效的表达式公式',
        INVALID_COMBINED_EQUIPMENTS_SHUTDOWN_RATE_VALUE:
          '无效的设备_shutdown_rate值',
        ...
        INVALID_IS_COMBINED_EQUIPMENT_STATUS_COUNTED_VALUE:
          '无效的is_equipment_status_counted值',
        INVALID_IS_EQUIPMENT_STATUS_COUNTED_VALUE:
          '无效的is_equipment_status_counted值',
        ...
        INVALID_START_DATE_TIME:
          '无效的开始日期时间（完整的预期格式：YYYY-MM-DDTHH：MM：SS）',
        INVALID_START_DATE_TIME_YMD: '无效的开始日期时间（预期格式:YYYY-MM-DD)',
        INVALID_START_DATE_TIME_YMDHMS:
          '无效的开始日期时间（预期格式:YYYY-MM-DDTHH：MM：SS)',
    ...
    .translations('de', {
      ...
      FDD: {
        ...
        DES_EXPRESSION: 'Klicken Sie auf "Bearbeiten", um Details anzuzeigen',
      ...
      SETTING: {
        ...
        EDIT_PARAM_COMBINED_EQUIPMENT:
          'Bearbeiten Sie die Parameter des Kombinationsgeräts',
        ...
        PHONE_ID_FORMAT:
          'Bitte geben Sie die Landesvorwahl ein: z. B. 0086 + Handynummer',
      ...
      DISTRIBUTION_SYSTEM: {
        ...
        SELECT_DISTRIBUTION_SYSTEM:
          'Bitte wählen Sie das Stromverteilungssystem',
        SVG: 'SVG',
        ...
        DISTRIBUTION_CIRCUIT_ID: 'ICH WÜRDE',
        DISTRIBUTION_CIRCUIT_NAME: 'Name',
      ...
      SWEET: {
        ...
        TEXT:
          'Durch Löschen dieses Artikels werden auch alle zugehörigen Daten gelöscht!',
      ...
      API: {
        ...
        TOTAL_STEAM_VALUE:
          'Gesamtstromrechnung + Gesamtleitungswasserrechnung + Dampfproduktionswert',
        ...
        ENERGY_UNIT_FOUR:
          'Produktionswerkstatt für chemische Arzneimittelgruppen',
        ...
        NON_WORKING_DAY_ENERGY_PER_DAY:
          'Täglicher durchschnittlicher Energieverbrauch außerhalb der Produktion',
        NWDSSEPD:
          'Durchschnittlicher täglicher Energieverbrauchswert des Standardzustands des Nichtproduktionstages',
        NWDTECR:
          'Theoretische Schließrate der Ausrüstung an Tagen ohne Produktion',
        NWDAECR:
          'Tatsächliche Abschaltrate der Geräte an Tagen ohne Produktion',
        ...
        SINGLE_DEVICE_ENERGY:
          'Säulendiagramm zum Energieverbrauch einzelner Geräte',
        EQUIPMENT_STATUS_ENERGY_RATIO:
          'Prozentsatz des Energieverbrauchs des Gerätezustands',
        EQUIPMENT_STATUS_TIME_RATIO: 'Prozentsatz der Gerätezustandszeit',

        RUNNING_TIME: 'Laufzeit verarbeiten',
        RUNNING_ENERGY_CONSUMPTION:
          'Energieverbrauch des Verarbeitungsbetriebs',
        ...
        C_ENERGY_ANALYSIS_SUBJECT:
          '0. Analysieren Sie den Hauptkörper (untergeordnete Energieverbrauchseinheit).',
        C_ENERGY_EQUIPMENT_STATION: '--1. Gerätestation',
        C_RUNNING_TIME: '2. Laufzeit verarbeiten',
        C_RUNNING_ENERGY_CONSUMPTION:
          '3. Energieverbrauch des Verarbeitungsbetriebs',
        ...
        C_ENERGY_NPDTECRS:
          '--8. Standard für den theoretischen Energieverbrauch am Tag ohne Produktion',
        C_ENERGY_NPDECR:
          '--9. Täglicher Energieverbrauch außerhalb der Produktion',

        C_COST_ANALYSIS_SUBJECT:
          '0. Analysieren Sie den Hauptkörper (untergeordnete Energieverbrauchseinheit).',
        ...
        C_COST_NPDTECRS:
          '--8. Der theoretische Kostenverhältnisstandard für Nichtproduktionstage',
        ...
        TENANT_ALREADY_ASSOCIATED_WITH_METER:
          'Der Mieter ist bereits mit dem Zähler verbunden',
        TENANT_ALREADY_ASSOCIATED_WITH_OFFLINE_METER:
          'Der Mandant ist bereits mit der Offline-Tabelle verknüpft',
        TENANT_ALREADY_ASSOCIATED_WITH_VIRTUAL_METER:
          'Der Mandant ist bereits der virtuellen Tabelle zugeordnet',
        TENANT_AND_METER_RELATIONSHIP_NOT_FOUND:
          'Mieter- und Zählerbeziehung nicht gefunden',
        TENANT_AND_OFFLINE_METER_RELATIONSHIP_NOT_FOUND:
          'Mandanten- und Offline-Tabellenbeziehung nicht gefunden',
        TENANT_AND_VIRTUAL_METER_RELATIONSHIP_NOT_FOUND:
          'Beziehung zwischen Mandant und virtueller Tabelle nicht gefunden',
        STORE_NOT_FOUND: 'Kein Geschäft gefunden',
        STORE_ALREADY_ASSOCIATED_WITH_METER:
          'Das Geschäft ist bereits dem Zähler zugeordnet',
        STORE_ALREADY_ASSOCIATED_WITH_OFFLINE_METER:
          'Der Speicher wurde der Offline-Tabelle zugeordnet',
        STORE_ALREADY_ASSOCIATED_WITH_VIRTUAL_METER:
          'Der Speicher wurde der virtuellen Tabelle zugeordnet',
        STORE_AND_METER_RELATIONSHIP_NOT_FOUND:
          'Die Beziehung zwischen dem Geschäft und dem Zähler wurde nicht gefunden',
        STORE_AND_OFFLINE_METER_RELATIONSHIP_NOT_FOUND:
          'Die Beziehung zwischen dem Geschäft und der Offline-Tabelle wurde nicht gefunden',
        STORE_AND_VIRTUAL_METER_RELATIONSHIP_NOT_FOUND:
          'Die Beziehung zwischen dem Geschäft und der virtuellen Tabelle wurde nicht gefunden',
        ADVANCE_REPORT_FILE_NOT_FOUND:
          'Keine erweiterte Berichtsdatei gefunden',
        ...
        COST_CENTER_EXTERNAL_ID_EXISTS:
          'Externe Kostenstellen-ID ist bereits vorhanden',
        ...
        COMBINED_EQUIPMENT_METER_RELATIONSHIP_EXISTED:
          'Die Beziehung zwischen der kombinierten Ausrüstung und dem Zähler besteht bereits',
        COMBINED_EQUIPMENT_METER_RELATIONSHIP_NOT_FOUND:
          'Die Beziehung zwischen der kombinierten Ausrüstung und dem Messgerät wurde nicht gefunden',
        COMBINED_EQUIPMENT_NOT_FOUND: 'Kombinationsgerät nicht gefunden',
        COMBINED_EQUIPMENT_OFFLINE_METER_RELATIONSHIP_NOT_FOUND:
          'Die Beziehung zwischen dem kombinierten Gerät und der Offline-Tabelle wurde nicht gefunden',
        COMBINED_EQUIPMENT_OFFLINE_METER_RELATIONSHIP_ALREADY_EXISTS:
          'Die Beziehung zwischen dem kombinierten Gerät und der Offline-Tabelle besteht bereits',
        COMBINED_EQUIPMENT_VIRTUAL_METER_RELATIONSHIP_NOT_FOUND:
          'Die Beziehung zwischen dem kombinierten Gerät und der virtuellen Tabelle wurde nicht gefunden',
        COMBINED_EQUIPMENT_VIRTUAL_METER_RELATIONSHIP_ALREADY_EXISTS:
          'Die Beziehung zwischen dem kombinierten Gerät und der virtuellen Tabelle besteht bereits',
        EQUIPMENT_METER_RELATIONSHIP_EXISTED:
          'Die Beziehung zwischen Gerät und Zähler besteht bereits',
        EQUIPMENT_METER_RELATIONSHIP_NOT_FOUND:
          'Geräte- und Zählerbeziehung nicht gefunden',
        EQUIPMENT_NOT_FOUND: 'Gerät nicht gefunden',
        EQUIPMENT_OFFLINE_METER_RELATIONSHIP_NOT_FOUND:
          'Die Beziehung zwischen dem Gerät und der Offline-Tabelle wurde nicht gefunden',
        EQUIPMENT_OFFLINE_METER_RELATIONSHIP_ALREADY_EXISTS:
          'Die Beziehung zwischen dem Gerät und der Offline-Tabelle besteht bereits',
        EQUIPMENT_VIRTUAL_METER_RELATIONSHIP_NOT_FOUND:
          'Die Beziehung zwischen dem Gerät und der virtuellen Tabelle wurde nicht gefunden',
        EQUIPMENT_VIRTUAL_METER_RELATIONSHIP_ALREADY_EXISTS:
          'Die Beziehung zwischen dem Gerät und der virtuellen Tabelle besteht bereits',
        SPACE_NOT_FOUND: 'Kein Platz gefunden',
        SPACE_ALREADY_ASSOCIATED_WITH_METER:
          'Der Raum ist bereits dem Zähler zugeordnet',
        SPACE_ALREADY_ASSOCIATED_WITH_OFFLINE_METER:
          'Der Speicherplatz ist bereits der Offline-Tabelle zugeordnet',
        SPACE_ALREADY_ASSOCIATED_WITH_VIRTUAL_METER:
          'Der Speicherplatz ist bereits der virtuellen Tabelle zugeordnet',
        SPACE_AND_METER_RELATIONSHIP_NOT_FOUND:
          'Die Beziehung zwischen dem Raum und dem Zähler wurde nicht gefunden',
        SPACE_AND_OFFLINE_METER_RELATIONSHIP_NOT_FOUND:
          'Speicherplatz und Offline-Tabellenbeziehung nicht gefunden',
        SPACE_AND_VIRTUAL_METER_RELATIONSHIP_NOT_FOUND:
          'Speicherplatz und virtuelle Tabellenbeziehung nicht gefunden',
        ...
        INVALID_ADVANCE_REPORT_FILE_ID:
          'Ungültige ID der erweiterten Berichtsdatei',
        ...
        INVALID_PRIVILEGE_TO_RESET_PASSWORD:
          'Ungültige Berechtigung zum Zurücksetzen des Kennworts',
        ...
        INVALID_COOKIES_PLEASE_RE_LOGIN:
          'Ungültiger Cookie, bitte erneut anmelden',
        INVALID_EMAIL: 'Ungültige E-Mail',
        INVALID_EMS_CONTACT_EMAIL_VALUE:
          'Ungültiger Wert für ems_contact_email',
        INVALID_EMS_CONTACT_NAME_VALUE: 'Ungültiger Wert für ems_contact_name',
        INVALID_EMS_CONTACT_PHONE_VALUE:
          'Ungültiger Wert für ems_contact_phone',
        INVALID_END_DATE_TIME:
          'Ungültiges Enddatum (volles erwartetes Format: JJJJ-MM-TTTHH: MM: SS)',
        INVALID_END_DATE_TIME_YMD:
          'Ungültige Enddatumzeit (erwartetes Format: JJJJ-MM-TTTHH)',
        INVALID_END_DATE_TIME_YMDHMS:
          'Ungültige Enddatumzeit (erwartetes Format: JJJJ-MM-TTTHH: MM: SS)',
        INVALID_EQUATION_IN_EXPRESSION: 'Ungültige Ausdrucksformel',
        INVALID_COMBINED_EQUIPMENTS_SHUTDOWN_RATE_VALUE:
          'Ungültiger _shutdown_rate-Wert des Geräts',
        INVALID_EQUIPMENTS_SHUTDOWN_RATE_VALUE:
          'Ungültiger _shutdown_rate-Wert des Geräts',
        ...
        INVALID_IS_COMBINED_EQUIPMENT_STATUS_COUNTED_VALUE:
          'Ungültiger Wert für is_equipment_status_counted',
        INVALID_IS_EQUIPMENT_STATUS_COUNTED_VALUE:
          'Ungültiger Wert für is_equipment_status_counted',
        ...
        INVALID_PERIOD_FORMAT:
          'Ungültiges Zeitraumformat (erwartetes Format "Jahr", "Monat", "Tag" oder "Stunde"）',
        ...
        INVALID_START_DATE_TIME:
          'Ungültige Startzeit (vollständiges erwartetes Format: JJJJ-MM-TTTHH: MM: SS)',
        INVALID_START_DATE_TIME_YMD:
          'Ungültige Startzeit (erwartetes Format: JJJJ-MM-TT)',
        INVALID_START_DATE_TIME_YMDHMS:
          'Ungültige Startzeit (erwartetes Format: JJJJ-MM-TTTHH: MM: SS)',
        INVALID_SUSPENDED_VALUE: 'Ungültiger Pausenwert',
        INVALID_USE_LIFE_END_VALUE:
          'Ungültiger Wert für die Lebensdauer des Geräts',
        INVALID_USE_LIFE_START_VALUE:
          'Ungültiger Startwert der Gerätelebensdauer',
        ...
        METER_POINT_RELATIONSHIP_EXISTED:
          'Es gibt eine Beziehung zwischen Metern und Punkten',
        METER_POINT_RELATIONSHIP_NOT_FOUND:
          'Die Beziehung zwischen dem Messgerät und dem Punkt wurde nicht gefunden',
        METER_OF_VARIABLE_NOT_FOUND:
          'Kein mit der Variablen verknüpftes Messgerät gefunden',
        ...
        OFFLINE_METER_OF_VARIABLE_NOT_FOUND:
          'Die der Variablen zugeordnete Offline-Tabelle wurde nicht gefunden',
        ...
        START_DATETIME_SHOULD_BE_EARLY_THAN_END_DATETIME:
          'Das Startdatum und die Startzeit sollten vor dem Enddatum und der Endzeit liegen',
        TARIFF_IN_USE: 'Rate wird verwendet',
        TARIFF_NOT_EMPTY: 'Die Rate ist nicht leer',
        TARIFF_NOT_FOUND: 'Rate nicht gefunden',
        TARIFF_ALREADY_ASSOCIATED_WITH_COSTCENTER:
          'Der Tarif ist bereits der Kostenstelle zugeordnet',
        TARIFF_ALREADY_ASSOCIATED_WITH_SPACE:
          'Die Rate wurde mit dem Speicherplatz verknüpft',
        TARIFF_IS_NOT_ASSOCIATED_WITH_COST_CENTER:
          'Der Tarif ist nicht mit der Kostenstelle verknüpft',
        TARIFF_IS_NOT_ASSOCIATED_WITH_SPACE:
          'Rate und Platz sind nicht miteinander verbunden',
        POINT_ALREADY_ASSOCIATED_WITH_SPACE:
          'Datenpunkte wurden mit dem Raum verknüpft',
        POINT_IS_NOT_ASSOCIATED_WITH_SPACE:
          'Datenpunkte sind nicht mit Leerzeichen verknüpft',
        TEAM_NOT_FOUND: 'Kein Team gefunden',
        TEXT_MESSAGE_NOT_FOUND: 'SMS nicht gefunden',
        THERE_IS_RELATIONSHIP_WITH_TENANTS:
          'Haben Sie eine Beziehung mit dem Mieter',
        THERE_IS_RELATIONSHIP_WITH_STORES: 'Hat eine Beziehung zum Geschäft',
        THERE_IS_RELATIONSHIP_WITH_COMPANIES:
          'Haben Sie eine Beziehung mit dem Unternehmen',
        THERE_IS_RELATIONSHIP_WITH_COMBINED_EQUIPMENTS:
          'Bezogen auf kombinierte Ausrüstung',
        ...
        THERE_IS_RELATIONSHIP_WITH_OFFLINE_METERS:
          'Bezogen auf Offline-Tabelle',
        THERE_IS_RELATIONSHIP_WITH_TEAMS: 'Habe eine Beziehung zum Team',
        THERE_IS_RELATIONSHIP_WITH_USERS:
          'Haben Sie eine Beziehung zu Benutzern',
        THERE_IS_RELATIONSHIP_WITH_VIRTUAL_METERS:
          'Bezogen auf virtuelle Tabelle',
