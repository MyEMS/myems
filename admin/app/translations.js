    ...
    $translateProvider
        .translations('en', {
            ...
            API: {
                ...
                ALIYUN_SMS_API_ACCESS_KEY_ID_IS_ALREADY_IN_USE: 'Aliyun SMS API Access Key ID is Already in Use',
                ALIYUN_SMS_API_NOT_FOUND: 'Aliyun SMS API Not Found',
                ...
                INVALID_ALIYUN_SMS_API_ACCESS_KEY_ID: 'Invalid Aliyun SMS API Access Key ID',
                INVALID_ALIYUN_SMS_API_ACCESS_KEY_SECRET: 'Invalid Aliyun SMS API Access Key Secret',
                INVALID_ALIYUN_SMS_API_ENDPOINT: 'Invalid Aliyun SMS API Endpoint',
                INVALID_ALIYUN_SMS_API_ID: 'Invalid Aliyun SMS API ID',
                INVALID_ALIYUN_SMS_API_SIGN_NAME: 'Invalid Aliyun SMS API Sign Name',
                INVALID_ALIYUN_SMS_API_TEMPLATE_CODE: 'Invalid Aliyun SMS API Template Code',
