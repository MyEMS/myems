...
Italiano | [English](./README.md) | [German](./README_DE.md) | [Français](./README_FR.md) | [Español](./README_ES.md) | [Русский](./README_RU.md) | [Português](./README_PT.md) | [繁體中文](./README_TW.md) | [العربية](./README_AR.md) | [ไทย](./README_TH.md) | [हिन्दी](./README_HI.md) | [Bahasa Indonesia](./README_ID.md) | [Bahasa Melayu](./README_MS.md) | [Tiếng Việt](./README_VI.md) | [Türkçe](./README_TR.md)
...
## Presentazione dell'interfaccia utente web di MyEMS
...
## Presentazione dell'interfaccia utente di amministrazione di MyEMS
...
## Presentazione dell'interfaccia utente dashboard di MyEMS
...
[1]. [https://gitee.com/myems/myems](https://gitee.com/myems/myems) (Consigliato)
...
### Numero di porta predefinito

Interfaccia utente web di MyEMS: 80

API di MyEMS: 8000

Interfaccia utente di amministrazione di MyEMS: 8001
...
![Sistema Open Source di Gestione dell'Energia](./docs/images/qr_code_mp_weixin.png)


## Gruppo WeChat

![Gruppo WeChat](./docs/images/qr_code_wechat_group.png)

## Gruppo QQ

Numero gruppo: 792528967

![Gruppo QQ](./docs/images/qr_code_qq_group.png)
