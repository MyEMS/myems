-- MyEMS System Database Demo Data (ตัวอย่างภาษาไทย)
...
VALUES
(1, 'อุปกรณ์แบบผสม 1', '48aab70f-2e32-4518-9986-a6b7395acf58', 1, 0, 1, 1, '', 'description'),
(2, 'อุปกรณ์แบบผสม 2', 'c235e68c-e1be-4d7a-84e7-976c83ff6e44', 1, 0, 1, 1, '', 'description');
...
VALUES
(1, 'คุณเจียง (วิศวกร)', '5c5ce6e8-8d00-46b3-9602-4e1520a8b43f',  'john@myems.io', '+8613888888888', 'อาคารหมายเลข 1'),
(2, 'คุณจาง (วิศวกร)', '102b654d-e831-4365-bb1e-dbd55e897851',  'sample.tenant@myems.io', '+8613666666666', 'ผู้เช่าหลัก');
COMMIT;
...
VALUES
(1, 'ศูนย์ต้นทุน', 'd97b9736-c4f9-4005-a534-6af3487303ad', NULL);
COMMIT;
...
VALUES
(1, 'แหล่งข้อมูล Modbus TCP (ตัวอย่าง)', 'b3ace9d4-b63b-419b-818f-0f6d1d0603a4', 1, 'modbus-tcp', '{"host":"192.168.0.1", "port":502, "interval_in_seconds":60}'),
(2, 'แหล่งข้อมูล Modbus RTU (ตัวอย่าง) *เวอร์ชันองค์กร*', 'b903f0af-9115-448c-9d46-8caf5f9995f3', 1, 'modbus-rtu', '{"port": "/dev/ttyUSB0","slaveaddress": 1, "baudrate": 9600,"bytesize": 8,"parity": "N","stopbits": 1,"timeout": 0.05,"mode": "rtu"}'),
(3, 'แหล่งข้อมูล BACnet/IP (ตัวอย่าง) *เวอร์ชันองค์กร*', 'e2d5b30b-b554-4ebe-8ce7-f377ab380d19', 1, 'bacnet-ip', '{"host":"192.168.0.3", "port":47808}'),
(4, 'แหล่งข้อมูล S7 (ตัวอย่าง) *เวอร์ชันองค์กร*', '9eb0d705-d02a-43f8-9c62-7e5ef508b255', 1, 's7', '{"host":"192.168.0.4", "port":102, "rack": 0, "slot": 2}'),
(5, 'แหล่งข้อมูล ControlLogix (ตัวอย่าง) *เวอร์ชันองค์กร*', 'd1dc9792-7861-4dd3-9b01-07511dae16c1', 1, 'controllogix', '{"host":"192.168.0.5","port":44818,"processorslot":3}'),
(6, 'แหล่งข้อมูล OPC UA (ตัวอย่าง) *เวอร์ชันองค์กร*', '56e1c642-8032-495b-af2e-18a77ca75e0f', 1, 'opc-ua', '{"url":"opc.tcp://192.168.0.6:49320/OPCUA/SimulationServer/"}'),
(7, 'แหล่งข้อมูลสภาพอากาศ (ตัวอย่าง) *เวอร์ชันองค์กร*', '9bff8e95-c7c9-4002-b040-08a96ae196b5', 1, 'weather', '{"base_url":"WEATHER_API_URL", "location":"beijing", "key":"APPKEY"}'),
(8, 'แหล่งข้อมูล MySQL (ตัวอย่าง) *เวอร์ชันองค์กร*', '409439d0-3e0a-4ab3-865a-a5c0329925f8', 1, 'mysql', '{"host":"192.168.0.8", "port":3306, "user":"myems", "password":"!MyEMS1", "database":"myems_ingestion_db" }'),
(9, 'แหล่งข้อมูล SQL Server (ตัวอย่าง) *เวอร์ชันองค์กร*', '025f0429-5088-4f2a-85a3-dff9b4523692', 1, 'sqlserver', '{"host":"192.168.0.9", "port":1433, "user":"myems", "password":"!MyEMS1", "database":"myems_ingestion_db" }'),
(10, 'แหล่งข้อมูล PostgreSQL (ตัวอย่าง) *เวอร์ชันองค์กร*', 'd89b81e6-4917-4a84-b0e9-c2e939599d3a', 1, 'postgresql', '{"host":"192.168.0.10", "port":5432, "user":"myems", "password":"!MyEMS1", "database":"myems_ingestion_db" }'),
(11, 'แหล่งข้อมูล Oracle (ตัวอย่าง) *เวอร์ชันองค์กร*', '1bdf4db8-ea71-433e-ad16-b637275073d7', 1, 'oracle', '{"dsn":"192.168.0.11:1521/myems", "user":"myems", "password":"!MyEMS1"}'),
(13, 'แหล่งข้อมูล InfluxDB (ตัวอย่าง) *เวอร์ชันองค์กร*', '79cb60ff-c683-4289-ac69-bd13e1f970d1', 1, 'influxdb', '{"url":"http://192.168.0.13:8086", "token":"MYEMSINFLUXDBTOKEN", "org":"myems", "bucket":"myems"}'),
(14, 'แหล่งข้อมูล MQTT (ตัวอย่าง) *เวอร์ชันองค์กร*', 'e3d56e11-00da-4957-ab0b-1d761dc8b89f', 1, 'mqtt', '{"host":"192.168.1.101", "port":1883, "user":"myems", "password":"!MyEMS1", "topic":"myems", "qos":2 }');
COMMIT;
...
VALUES
(1, 'AHa01', '52f7abe1-ba0e-47a6-a327-4faac42a1d11', 1, '1ES', 'AHa01', 5100, 1250, 'สายไฟฟ้าเข้าหมายเลข 11 เส้น 1WHj2', 'AHa01');
...
VALUES
(1, 'ระบบจัดจำหน่ายไฟฟ้า (ตัวอย่าง)', '95652719-56fa-44cc-9bef-7aa47664d4ff', 1, 'ระบบจัดจำหน่าย (ตัวอย่าง)');
...
VALUES
(1, 'ไฟฟ้า', '6d0753ed-8b43-4332-b6fd-d2f5813831d3', 'kWh', 0.122, 0.928),
(2, 'น้ำประปา', '3dbfa598-fccc-4d60-bf11-14bd55540c66', 'm³', 0.085, 0.910),
(3, 'ก๊าซธรรมชาติ', '6d0753ed-8b43-4332-b6fd-d2f5813831d3', 'm³', 1.330, 2.162),
(4,'น้ำเย็น 4°C','d2a3021a-4911-4611-856e-80133000f1d5','m³',1.000,1.000),
(5,'น้ำเย็น 7°C','c1ad0696-e1ab-4e0c-a342-b194c0bc27e0','m³',1.000,1.000),
(6,'ไอน้ำ','ac91a5c4-4ae5-4a73-8e3f-044591f42eef','T',1.000,1.000),
(7,'ลมอัด','ff238e98-cd35-47c5-88a3-00617587775d','m³',1.000,1.000),
(8,'น้ำหมุนเวียน','7e159a34-b2e6-4fd3-ba76-897d134abe06','m³',1.000,1.000),
(9, 'ความร้อน','549f9cad-8db7-49d2-9473-95e37a3fc46a','KJ',1.000,1.000),
(10, 'ความเย็น','05aa257b-3cf6-4f19-808d-92e7dbf52b16','KJ',1.000,1.000),
(11, 'น้ำทิ้งรีไซเคิล','df6161b6-4a1b-46e7-b7c8-337b5b52d717','m³',1.000,1.000);
COMMIT;
...
VALUES
(1, 'ไฟฟ้าสำหรับแสงสว่างและปลั๊ก', 'cade4e78-2b85-4bea-ab6e-0d6accc88d03', 1),
(2, 'ไฟฟ้าทางเดินและแสงสว่างฉุกเฉิน', '7a6dc086-ce08-4d66-ba75-f69af92b32f4', 1),
(3, 'ไฟฟ้าแสงสว่างภูมิทัศน์ภายนอก', 'abcebbd1-b770-4e7c-ae54-8434d724522c', 1),
(4, 'ไฟฟ้าสถานีทำความเย็นและอุ่น', '97cdea54-04c7-4a6a-b4c2-df15874b2f49', 1),
(5, 'ไฟฟ้าปลายทางระบายอากาศ', '84ab7262-33fb-43a1-9880-9287cc268cc0', 1),
(6, 'ไฟฟ้าลิฟต์', '26a5fc62-3da1-41b0-bcb1-0056e25ee121', 1),
(7, 'ไฟฟ้าปั๊มน้ำ', 'fc6079f5-01a4-434f-9004-9382e8c3dd47', 1),
(8, 'ไฟฟ้าพัดลม', 'a4bf68cd-6ae1-48dd-b281-07c95312921d', 1),
(9, 'ไฟฟ้าพิเศษ', '1990d151-02ff-4fd6-b298-2b2edee4e0ea', 1);
COMMIT;
...
(`id`, `name`, `uuid`)
VALUES
(1, 'แผนภาพการไหลของพลังงาน (ตัวอย่าง)', '3ccbc9c6-9575-4212-a63a-a688d1154302');
...
VALUES
(1, 1, 'สายเข้า 10 kV ที่ 1'),
(2, 1, 'สายเข้า 10 kV ที่ 2'),
(3, 1, 'พื้นที่เช่า'),
(4, 1, 'พื้นที่ส่วนกลาง'),
(5, 1, 'โรงแรม'),
(6, 1, 'ที่จอดรถ'),
...
(`id`, `name`, `uuid`,  `is_input_counted`, `is_output_counted`, `cost_center_id`, `svg_id`, `camera_url`, `description` )
VALUES
(1, 'อุปกรณ์ 1', 'bfa8b106-89a1-49ca-9b2b-a481ac41a873', 1, 0, 1, 1, '', 'description'),
(2, 'อุปกรณ์ 2', 'ad5798ec-d827-43d9-bf08-fc7516f9c4c8', 1, 0, 1, 1, '', 'description');
...
VALUES
(2, 'เกตเวย์ 2', '8f75c0ab-9296-49c7-9058-8139febd0c31', 'd3860971-e6e0-4c98-9eba-5492869c5b19', null);
...
VALUES
(1, 'เครื่องวัด 1', '5ca47bc5-22c2-47fc-b906-33222191ea40', 1, 1, 0.000, 999.999, 1, 1, null, 'meter1'),
(2, 'เครื่องวัด 2', 'd6f3f56b-10ee-4d22-ad47-5acc1353a6f4', 1, 1, 0.000, 999.999, 1, 1, 1,  'meter2'),
(3, 'เครื่องวัด 3', '6db58cd6-33d3-58ed-a095-22333202fb51', 1, 1, 0.000, 999.999, 1, 1, 1,  'meter3');
...
VALUES
(1, 'เครื่องวัดออฟไลน์ 1', '62f473e0-1a35-41f3-9c30-8110d75d65bb', 1, 1, 0.0, 999.999, 1, 1, 'offlinemeter1');
...
(6, 'จุดข้อมูล Modbus TCP ตัวอย่าง 6', 2, 'ENERGY_VALUE',  'Wh', 99999999999, 0, 1.000, 1, 0,
  '{\"slave_id\":1, \"function_code\":3, \"offset\":40001, \"number_of_registers\":2, \"format\":\"=f\", \"byte_swap\":false}', null),

(7, 'จุดข้อมูลตัวอย่าง 7', 2, 'ANALOG_VALUE',  'V', 690, 0, 1.000, 1, 0,
  '{\"slave_id\":1, \"function_code\":3, \"offset\":40002, \"number_of_registers\":2, \"format\":\"=f\", \"byte_swap\":false}', null),

(8, 'จุดข้อมูล BACnet ตัวอย่าง 1', 3, 'ANALOG_VALUE',  'V', 690, 0, 1.000, 1, 0,
...
(9, 'จุดข้อมูล S7 ตัวอย่าง 1', 4, 'ANALOG_VALUE',  'kWh', 99999999999, 0, 1.000, 1, 0,
...
VALUES
(1, 'เซ็นเซอร์ 1', 'ba450606-6f39-41e0-8caf-75b528635511', 'คำอธิบายเซ็นเซอร์');
...
VALUES
(1, 'พื้นที่การผลิต 1', 'd03837fd-9d30-44fe-9443-154f7c7e15f1',  99999.999, 1, 1, 1,  'โครงการ MyEMS');
COMMIT;
...
VALUES
(2, 'อาคาร 1', '8f25b33b-db93-49b3-b0f8-b01e0c19df29', 1, 88888.888, 56, 1, 1, 1, 1,  'โครงการ MyEMS'),
(3, 'อาคาร 2', '195d7ea8-17b4-4e9c-bb37-546428155438', 1, 66666.666, 56, 1, 1, 1, 1, 'โครงการ MyEMS'),
(10000, 'พื้นที่ดีบัก', '2c44a292-eb0c-49a3-a50e-4fc03858dc0c', 1, 88888.888, 56, 1, 1, 1, 1,  'โครงการ MyEMS');
COMMIT;
...
VALUES
(1, 'SVG1', 'a0e79d2e-8756-457e-b1f2-4152e3591bff', '<?xml version="1.0" encoding="UTF-8"?><svg width="5cm" height="4cm" version="1.1" xmlns="http://www.w3.org/2000/svg"><desc>สี่เหลี่ยมแยกสี่รูป</desc><rect x=".5cm" y=".5cm" width="2cm" height="1cm"/></svg>', 'SVG ตัวอย่าง');
...
VALUES
(1, 'ไฟฟ้า TOU 2026 (เดือน 1–6)',    '590efb36-8587-42a9-ae6f-c715d21496d6', 1, 'timeofuse', 'THB/kWh', '2025-12-31 16:00:00', '2026-06-30 15:59:59'),
(2, 'ไฟฟ้า TOU 2026 (เดือน 7–9)',    'f5966640-18fc-437a-9efd-cbc0c58b6373', 1, 'timeofuse', 'THB/kWh', '2026-06-30 16:00:00', '2026-09-30 15:59:59'),
(3, 'ไฟฟ้า TOU 2026 (เดือน 10–12)',  '21727a1b-4b27-4186-b72e-db46e6e2d980', 1, 'timeofuse', 'THB/kWh', '2026-09-30 16:00:00', '2026-12-31 15:59:59'),
(4, 'ไฟฟ้า TOU 2023 (เดือน 1–6)',    'fe65e443-0ec2-4a16-823e-2365885e2598', 1, 'timeofuse', 'THB/kWh', '2022-12-31 16:00:00', '2023-06-30 15:59:59'),
(5, 'ไฟฟ้า TOU 2023 (เดือน 7–9)',    'd1285c81-4612-4d7c-9436-ed11b4e7abe4', 1, 'timeofuse', 'THB/kWh', '2023-06-30 16:00:00', '2023-09-30 15:59:59'),
(6, 'ไฟฟ้า TOU 2023 (เดือน 10–12)',  'e6c275b4-47eb-4f5d-bc59-edbe45c2a407', 1, 'timeofuse', 'THB/kWh', '2023-09-30 16:00:00', '2023-12-31 15:59:59'),
(7, 'ไฟฟ้า TOU 2024 (เดือน 1–6)',    'ca359f72-48ad-46a7-82af-cecbe98450e8', 1, 'timeofuse', 'THB/kWh', '2023-12-31 16:00:00', '2024-06-30 15:59:59'),
(8, 'ไฟฟ้า TOU 2024 (เดือน 7–9)',    '9fdda603-0f8f-4452-ad59-c5df54bc35f4', 1, 'timeofuse', 'THB/kWh', '2024-06-30 16:00:00', '2024-09-30 15:59:59'),
(9, 'ไฟฟ้า TOU 2024 (เดือน 10–12)',  'fb0442e7-4d44-4bfd-8b20-cad3f77a2480', 1, 'timeofuse', 'THB/kWh', '2024-09-30 16:00:00', '2024-12-31 15:59:59'),
(10, 'ไฟฟ้า TOU 2025 (เดือน 1–6)',   '3fa6e1f2-7d08-4f5a-bcbf-beb041d569c0', 1, 'timeofuse', 'THB/kWh', '2024-12-31 16:00:00', '2025-06-30 15:59:59'),
(11, 'ไฟฟ้า TOU 2025 (เดือน 7–9)',   '787240fb-1694-403e-a0a7-83d7be1cc0b8', 1, 'timeofuse', 'THB/kWh', '2025-06-30 16:00:00', '2025-09-30 15:59:59'),
(12, 'ไฟฟ้า TOU 2025 (เดือน 10–12)', 'a07fdf76-edcf-4124-96e7-ab733a5a4b70', 1, 'timeofuse', 'THB/kWh', '2025-09-30 16:00:00', '2025-12-31 15:59:59'),
(13, 'น้ำประปา',  '6fcbc77e-effb-4d43-9b30-77b062435d34', 2, 'timeofuse', 'THB/m³',    '2022-12-31 16:00:00', '2026-12-31 15:59:59'),
(14, 'ก๊าซธรรมชาติ', '6a4c56ff-b3e1-4555-9b1c-87d05bcfa4d9', 3, 'timeofuse', 'THB/m³',    '2022-12-31 16:00:00', '2026-12-31 15:59:59');
...
VALUES
(1, 'แมคโดนัลด์', 'd8a24322-4bab-4ba2-aedc-5d55a84c3db8', 'ถนนตงต้ามาชาง เลขที่ 7 เขตตงเฉิง ปักกิ่ง', 39.899493, 116.412041, 500.000, 1, 1, 1, 1,  'แมคโดนัลด์');
COMMIT;
...
VALUES
(1, 'อาหารและเครื่องดื่ม', '494d7d5e-e139-4629-b957-99ea4caf0401', 'อาหารและเครื่องดื่ม', 'RS'),
(2, 'ค้าปลีก', '1f556579-9d5c-45ce-9bd8-f2dc1d033470', 'ค้าปลีก', 'RT'),
(3, 'โรงแรม', 'cae697aa-ceca-435d-91bf-492b46607eb0', 'โรงแรม', 'HT');
...
VALUES
(1, 'Starbucks', '6b0da806-a4cd-431a-8116-2915e90aaf8b', 'อาคารหมายเลข 1', 'L1 L2 L3', '1201b+2247+3F', 418.8, 9, 1, 1,
 '6b0da806',  '2019-12-31 16:00:00', '2022-12-31 16:00:00', 1, 1, 1,  'คำอธิบาย');
COMMIT;
...
(`id`, `name`, `uuid`, `description`, `simplified_code`)
VALUES
(1, 'ผู้เช่าอาหารและเครื่องดื่ม', '83fffba1-9e22-4397-a93a-3742772c3753', 'อาหารและเครื่องดื่ม', 'FNB'),
(2, 'ผู้เช่าอาหาร (ก๊าซ)', 'ad95ed16-1c57-49a9-a85e-71e389393089', 'อาหาร (ก๊าซ)', 'FNBGas'),
(3, 'ผู้เช่าอาหาร (ไฟฟ้า)', '1dc21e83-4333-40f8-9e25-ea049becba37', 'อาหาร (ไฟฟ้า)', 'FNBElec'),
(4, 'ผู้เช่าแสงสว่างสูง', '4208a60d-d8e6-4fe5-8cea-a55109e9b397', 'แสงสว่างสูง', 'HighIllu'),
(5, 'ผู้เช่าหลัก', 'fc4ae534-544a-4a22-b83b-9f4aa99494aa', 'ผู้เช่าหลัก', 'ANCH'),
(6, 'ผู้เช่าพาณิชย์ทั่วไป', '6d1dca30-1cbe-463d-8a78-cdd5e0f8ac8b', 'พาณิชย์ทั่วไป', 'Normal'),
(7, 'ผู้เช่าพาณิชย์อื่น', '2078e1c0-3936-4ae7-9253-08e0aa1d84b6', 'พาณิชย์อื่น', 'Other'),
(8, 'ผู้เช่าสำนักงานเต็มชั้น', 'b2a580a3-edc9-4838-ae1d-7b7265860a9a', 'สำนักงานเต็มชั้น', 'WhFlr'),
(9, 'ผู้เช่าสำนักงานบางส่วนของชั้น', '55bbcba7-d8a0-44a0-9a9f-2f085e3cb044', 'สำนักงานบางส่วนของชั้น', 'NonWhFlr');
...
VALUES
(1, 'เครื่องวัดเสมือน 1', '3fff2cfb-f755-44c8-a919-6135205a8573', 'x1+x2+x3', 1, 1, 1, 1, 'คำอธิบายเครื่องวัดเสมือน');
