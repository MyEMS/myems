...
CREATE TABLE IF NOT EXISTS `myems_system_db`.`tbl_energy_storage_containers_batteries` (
  ...
  `soh_point_id` BIGINT NULL,
  `charging_power_limit_point_id` BIGINT NULL,
  `discharge_limit_power_point_id` BIGINT NULL,
  `rechargeable_capacity_point_id` BIGINT NULL,
  `dischargeable_capacity_point_id` BIGINT NULL,
  `average_temperature_point_id` BIGINT NULL,
  `average_voltage_point_id` BIGINT NULL,
  `insulation_value_point_id` BIGINT NULL,
  `positive_insulation_value_point_id` BIGINT NULL,
  `negative_insulation_value_point_id` BIGINT NULL,
  `maximum_temperature_point_id` BIGINT NULL,
  `maximum_temperature_battery_cell_point_id` BIGINT NULL,
  `minimum_temperature_point_id` BIGINT NULL,
  `minimum_temperature_battery_cell_point_id` BIGINT NULL,
  `maximum_voltage_point_id` BIGINT NULL,
  `maximum_voltage_battery_cell_point_id` BIGINT NULL,
  `minimum_voltage_point_id` BIGINT NULL,
  `minimum_voltage_battery_cell_point_id` BIGINT NULL,
  PRIMARY KEY (`id`));
...
CREATE TABLE IF NOT EXISTS `myems_system_db`.`tbl_energy_storage_containers_firecontrols` (
  ...
  `uuid` CHAR(36) NOT NULL,
  `energy_storage_container_id` BIGINT NOT NULL,
  `water_immersion_point_id` BIGINT,
  `emergency_stop_point_id` BIGINT,
  `electrical_compartment_smoke_detector_point_id` BIGINT,
  `battery_compartment_door_open_point_id` BIGINT,
  `electrical_compartment_door_open_point_id` BIGINT,
  `first_level_fire_alarm_point_id` BIGINT,
  `second_level_fire_alarm_point_id` BIGINT,
  `running_light_point_id` BIGINT,
  `fault_light_point_id` BIGINT,
  `ac_relay_tripping_point_id` BIGINT,
...
CREATE TABLE IF NOT EXISTS `myems_system_db`.`tbl_energy_storage_containers_hvacs` (
  ...
  `humidity_inside_point_id` BIGINT,
  `condensation_temperature_point_id` BIGINT,
  `defrosting_temperature_point_id` BIGINT,
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_system_db`.`tbl_hybrid_power_stations_cms_points`
-- ---------------------------------------------------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_system_db`.`tbl_hybrid_power_stations_generators_points`
-- ---------------------------------------------------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_system_db`.`tbl_hybrid_power_stations_loads_points`
-- ---------------------------------------------------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_system_db`.`tbl_hybrid_power_stations_pcses_points`
-- ---------------------------------------------------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_system_db`.`tbl_hybrid_power_stations_pvs_points`
-- ---------------------------------------------------------------------------------------------------------------------
