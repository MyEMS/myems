...
-- ---------------------------------------------------------------------------------------------------------------------
-- Table `myems_system_db`.`tbl_photovoltaic_power_stations_power_conversion_systems`
-- ---------------------------------------------------------------------------------------------------------------------
DROP TABLE IF EXISTS `myems_system_db`.`tbl_photovoltaic_power_stations_power_conversion_systems` ;
