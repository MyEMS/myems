...
CREATE TABLE IF NOT EXISTS `myems_system_db`.`tbl_energy_storage_containers_power_conversion_systems` (
  ...
  `today_charge_energy` DECIMAL(18, 3) NOT NULL,
  `today_discharge_energy` DECIMAL(18, 3) NOT NULL,
  `total_charge_energy` DECIMAL(18, 3) NOT NULL,
  `total_discharge_energy` DECIMAL(18, 3) NOT NULL,
