-- MyEMS System Database Demo Data (démonstration en français)
...
VALUES
(1, 'Équipement combiné 1', '48aab70f-2e32-4518-9986-a6b7395acf58', 1, 0, 1, 1, '', 'description'),
(2, 'Équipement combiné 2', 'c235e68c-e1be-4d7a-84e7-976c83ff6e44', 1, 0, 1, 1, '', 'description');
...
VALUES
(1, 'M. Jiang', '5c5ce6e8-8d00-46b3-9602-4e1520a8b43f',  'john@myems.io', '+8613888888888', 'Bâtiment n° 1'),
(2, 'M. Zhang', '102b654d-e831-4365-bb1e-dbd55e897851',  'sample.tenant@myems.io', '+8613666666666', 'Locataire principal');
COMMIT;
...
VALUES
(1, 'Centre de coûts', 'd97b9736-c4f9-4005-a534-6af3487303ad', NULL);
COMMIT;
...
VALUES
(1, 'Source de données Modbus TCP (exemple)', 'b3ace9d4-b63b-419b-818f-0f6d1d0603a4', 1, 'modbus-tcp', '{"host":"192.168.0.1", "port":502, "interval_in_seconds":60}'),
(2, 'Source de données Modbus RTU (exemple) *Édition entreprise*', 'b903f0af-9115-448c-9d46-8caf5f9995f3', 1, 'modbus-rtu', '{"port": "/dev/ttyUSB0","slaveaddress": 1, "baudrate": 9600,"bytesize": 8,"parity": "N","stopbits": 1,"timeout": 0.05,"mode": "rtu"}'),
(3, 'Source de données BACnet/IP (exemple) *Édition entreprise*', 'e2d5b30b-b554-4ebe-8ce7-f377ab380d19', 1, 'bacnet-ip', '{"host":"192.168.0.3", "port":47808}'),
(4, 'Source de données S7 (exemple) *Édition entreprise*', '9eb0d705-d02a-43f8-9c62-7e5ef508b255', 1, 's7', '{"host":"192.168.0.4", "port":102, "rack": 0, "slot": 2}'),
(5, 'Source de données ControlLogix (exemple) *Édition entreprise*', 'd1dc9792-7861-4dd3-9b01-07511dae16c1', 1, 'controllogix', '{"host":"192.168.0.5","port":44818,"processorslot":3}'),
(6, 'Source de données OPC UA (exemple) *Édition entreprise*', '56e1c642-8032-495b-af2e-18a77ca75e0f', 1, 'opc-ua', '{"url":"opc.tcp://192.168.0.6:49320/OPCUA/SimulationServer/"}'),
(7, 'Source de données météo (exemple) *Édition entreprise*', '9bff8e95-c7c9-4002-b040-08a96ae196b5', 1, 'weather', '{"base_url":"WEATHER_API_URL", "location":"beijing", "key":"APPKEY"}'),
(8, 'Source de données MySQL (exemple) *Édition entreprise*', '409439d0-3e0a-4ab3-865a-a5c0329925f8', 1, 'mysql', '{"host":"192.168.0.8", "port":3306, "user":"myems", "password":"!MyEMS1", "database":"myems_ingestion_db" }'),
(9, 'Source de données SQL Server (exemple) *Édition entreprise*', '025f0429-5088-4f2a-85a3-dff9b4523692', 1, 'sqlserver', '{"host":"192.168.0.9", "port":1433, "user":"myems", "password":"!MyEMS1", "database":"myems_ingestion_db" }'),
(10, 'Source de données PostgreSQL (exemple) *Édition entreprise*', 'd89b81e6-4917-4a84-b0e9-c2e939599d3a', 1, 'postgresql', '{"host":"192.168.0.10", "port":5432, "user":"myems", "password":"!MyEMS1", "database":"myems_ingestion_db" }'),
(11, 'Source de données Oracle (exemple) *Édition entreprise*', '1bdf4db8-ea71-433e-ad16-b637275073d7', 1, 'oracle', '{"dsn":"192.168.0.11:1521/myems", "user":"myems", "password":"!MyEMS1"}'),
(13, 'Source de données InfluxDB (exemple) *Édition entreprise*', '79cb60ff-c683-4289-ac69-bd13e1f970d1', 1, 'influxdb', '{"url":"http://192.168.0.13:8086", "token":"MYEMSINFLUXDBTOKEN", "org":"myems", "bucket":"myems"}'),
(14, 'Source de données MQTT (exemple) *Édition entreprise*', 'e3d56e11-00da-4957-ab0b-1d761dc8b89f', 1, 'mqtt', '{"host":"192.168.1.101", "port":1883, "user":"myems", "password":"!MyEMS1", "topic":"myems", "qos":2 }');
COMMIT;
...
VALUES
(1, 'AHa01', '52f7abe1-ba0e-47a6-a327-4faac42a1d11', 1, '1ES', 'AHa01', 5100, 1250, 'Entrée d''alimentation n° 11 ligne 1WHj2', 'AHa01');
...
VALUES
(1, 'Système de distribution électrique (exemple)', '95652719-56fa-44cc-9bef-7aa47664d4ff', 1, 'Système de distribution (démo)');
...
VALUES
(1, 'Électricité', '6d0753ed-8b43-4332-b6fd-d2f5813831d3', 'kWh', 0.122, 0.928),
(2, 'Eau du réseau', '3dbfa598-fccc-4d60-bf11-14bd55540c66', 'm³', 0.085, 0.910),
(3, 'Gaz naturel', '6d0753ed-8b43-4332-b6fd-d2f5813831d3', 'm³', 1.330, 2.162),
(4,'Eau glacée à 4 °C','d2a3021a-4911-4611-856e-80133000f1d5','m³',1.000,1.000),
(5,'Eau glacée à 7 °C','c1ad0696-e1ab-4e0c-a342-b194c0bc27e0','m³',1.000,1.000),
(6,'Vapeur','ac91a5c4-4ae5-4a73-8e3f-044591f42eef','T',1.000,1.000),
(7,'Air comprimé','ff238e98-cd35-47c5-88a3-00617587775d','m³',1.000,1.000),
(8,'Eau de circulation','7e159a34-b2e6-4fd3-ba76-897d134abe06','m³',1.000,1.000),
(9, 'Chaleur','549f9cad-8db7-49d2-9473-95e37a3fc46a','KJ',1.000,1.000),
(10, 'Froid','05aa257b-3cf6-4f19-808d-92e7dbf52b16','KJ',1.000,1.000),
(11, 'Eau réutilisée','df6161b6-4a1b-46e7-b7c8-337b5b52d717','m³',1.000,1.000);
COMMIT;
...
VALUES
(1, 'Électricité éclairage et prises', 'cade4e78-2b85-4bea-ab6e-0d6accc88d03', 1),
(2, 'Électricité circulations et éclairage de secours', '7a6dc086-ce08-4d66-ba75-f69af92b32f4', 1),
(3, 'Électricité éclairage paysager extérieur', 'abcebbd1-b770-4e7c-ae54-8434d724522c', 1),
(4, 'Électricité centrale CVC', '97cdea54-04c7-4a6a-b4c2-df15874b2f49', 1),
(5, 'Électricité terminaux CVC', '84ab7262-33fb-43a1-9880-9287cc268cc0', 1),
(6, 'Électricité ascenseurs', '26a5fc62-3da1-41b0-bcb1-0056e25ee121', 1),
(7, 'Électricité pompes', 'fc6079f5-01a4-434f-9004-9382e8c3dd47', 1),
(8, 'Électricité ventilateurs', 'a4bf68cd-6ae1-48dd-b281-07c95312921d', 1),
(9, 'Électricité spécifique', '1990d151-02ff-4fd6-b298-2b2edee4e0ea', 1);
COMMIT;
...
(`id`, `name`, `uuid`)
VALUES
(1, 'Diagramme de flux d''énergie (exemple)', '3ccbc9c6-9575-4212-a63a-a688d1154302');
...
VALUES
(1, 1, 'Arrivée 10 kV n° 1'),
(2, 1, 'Arrivée 10 kV n° 2'),
(3, 1, 'Zones louées'),
(4, 1, 'Parties communes'),
(5, 1, 'Hôtel'),
(6, 1, 'Parking'),
(7, 1, 'Restauration'),
...
(`id`, `name`, `uuid`,  `is_input_counted`, `is_output_counted`, `cost_center_id`, `svg_id`, `camera_url`, `description` )
VALUES
(1, 'Équipement 1', 'bfa8b106-89a1-49ca-9b2b-a481ac41a873', 1, 0, 1, 1, '', 'description'),
(2, 'Équipement 2', 'ad5798ec-d827-43d9-bf08-fc7516f9c4c8', 1, 0, 1, 1, '', 'description');
...
VALUES
(2, 'Passerelle 2', '8f75c0ab-9296-49c7-9058-8139febd0c31', 'd3860971-e6e0-4c98-9eba-5492869c5b19', null);
...
VALUES
(1, 'Compteur 1', '5ca47bc5-22c2-47fc-b906-33222191ea40', 1, 1, 0.000, 999.999, 1, 1, null, 'meter1'),
(2, 'Compteur 2', 'd6f3f56b-10ee-4d22-ad47-5acc1353a6f4', 1, 1, 0.000, 999.999, 1, 1, 1,  'meter2'),
(3, 'Compteur 3', '6db58cd6-33d3-58ed-a095-22333202fb51', 1, 1, 0.000, 999.999, 1, 1, 1,  'meter3');
...
VALUES
(1, 'Compteur hors ligne 1', '62f473e0-1a35-41f3-9c30-8110d75d65bb', 1, 1, 0.0, 999.999, 1, 1, 'offlinemeter1');
...
(6, 'Point de données Modbus TCP exemple 6', 2, 'ENERGY_VALUE',  'Wh', 99999999999, 0, 1.000, 1, 0,
  '{\"slave_id\":1, \"function_code\":3, \"offset\":40001, \"number_of_registers\":2, \"format\":\"=f\", \"byte_swap\":false}', null),

(7, 'Point de données exemple 7', 2, 'ANALOG_VALUE',  'V', 690, 0, 1.000, 1, 0,
  '{\"slave_id\":1, \"function_code\":3, \"offset\":40002, \"number_of_registers\":2, \"format\":\"=f\", \"byte_swap\":false}', null),

(8, 'Point de données BACnet exemple 1', 3, 'ANALOG_VALUE',  'V', 690, 0, 1.000, 1, 0,
...
(9, 'Point de données S7 exemple 1', 4, 'ANALOG_VALUE',  'kWh', 99999999999, 0, 1.000, 1, 0,
...
VALUES
(1, 'Capteur 1', 'ba450606-6f39-41e0-8caf-75b528635511', 'description du capteur');
...
VALUES
(1, 'Atelier 1', 'd03837fd-9d30-44fe-9443-154f7c7e15f1',  99999.999, 1, 1, 1,  'Projet MyEMS');
COMMIT;
...
VALUES
(2, 'Bâtiment 1', '8f25b33b-db93-49b3-b0f8-b01e0c19df29', 1, 88888.888, 56, 1, 1, 1, 1,  'Projet MyEMS'),
(3, 'Bâtiment 2', '195d7ea8-17b4-4e9c-bb37-546428155438', 1, 66666.666, 56, 1, 1, 1, 1, 'Projet MyEMS'),
(10000, 'Espace de débogage', '2c44a292-eb0c-49a3-a50e-4fc03858dc0c', 1, 88888.888, 56, 1, 1, 1, 1,  'Projet MyEMS');
COMMIT;
...
VALUES
(1, 'SVG1', 'a0e79d2e-8756-457e-b1f2-4152e3591bff', '<?xml version="1.0" encoding="UTF-8"?><svg width="5cm" height="4cm" version="1.1" xmlns="http://www.w3.org/2000/svg"><desc>Quatre rectangles séparés</desc><rect x=".5cm" y=".5cm" width="2cm" height="1cm"/></svg>', 'SVG démo');
...
VALUES
(1, '2026 Électricité TOU (janv.-juin)',    '590efb36-8587-42a9-ae6f-c715d21496d6', 1, 'timeofuse', 'EUR/kWh', '2025-12-31 16:00:00', '2026-06-30 15:59:59'),
(2, '2026 Électricité TOU (juil.-sept.)',    'f5966640-18fc-437a-9efd-cbc0c58b6373', 1, 'timeofuse', 'EUR/kWh', '2026-06-30 16:00:00', '2026-09-30 15:59:59'),
(3, '2026 Électricité TOU (oct.-déc.)',  '21727a1b-4b27-4186-b72e-db46e6e2d980', 1, 'timeofuse', 'EUR/kWh', '2026-09-30 16:00:00', '2026-12-31 15:59:59'),
(4, '2023 Électricité TOU (janv.-juin)',    'fe65e443-0ec2-4a16-823e-2365885e2598', 1, 'timeofuse', 'EUR/kWh', '2022-12-31 16:00:00', '2023-06-30 15:59:59'),
(5, '2023 Électricité TOU (juil.-sept.)',    'd1285c81-4612-4d7c-9436-ed11b4e7abe4', 1, 'timeofuse', 'EUR/kWh', '2023-06-30 16:00:00', '2023-09-30 15:59:59'),
(6, '2023 Électricité TOU (oct.-déc.)',  'e6c275b4-47eb-4f5d-bc59-edbe45c2a407', 1, 'timeofuse', 'EUR/kWh', '2023-09-30 16:00:00', '2023-12-31 15:59:59'),
(7, '2024 Électricité TOU (janv.-juin)',    'ca359f72-48ad-46a7-82af-cecbe98450e8', 1, 'timeofuse', 'EUR/kWh', '2023-12-31 16:00:00', '2024-06-30 15:59:59'),
(8, '2024 Électricité TOU (juil.-sept.)',    '9fdda603-0f8f-4452-ad59-c5df54bc35f4', 1, 'timeofuse', 'EUR/kWh', '2024-06-30 16:00:00', '2024-09-30 15:59:59'),
(9, '2024 Électricité TOU (oct.-déc.)',  'fb0442e7-4d44-4bfd-8b20-cad3f77a2480', 1, 'timeofuse', 'EUR/kWh', '2024-09-30 16:00:00', '2024-12-31 15:59:59'),
(10, '2025 Électricité TOU (janv.-juin)',   '3fa6e1f2-7d08-4f5a-bcbf-beb041d569c0', 1, 'timeofuse', 'EUR/kWh', '2024-12-31 16:00:00', '2025-06-30 15:59:59'),
(11, '2025 Électricité TOU (juil.-sept.)',   '787240fb-1694-403e-a0a7-83d7be1cc0b8', 1, 'timeofuse', 'EUR/kWh', '2025-06-30 16:00:00', '2025-09-30 15:59:59'),
(12, '2025 Électricité TOU (oct.-déc.)', 'a07fdf76-edcf-4124-96e7-ab733a5a4b70', 1, 'timeofuse', 'EUR/kWh', '2025-09-30 16:00:00', '2025-12-31 15:59:59'),
(13, 'Eau du réseau',  '6fcbc77e-effb-4d43-9b30-77b062435d34', 2, 'timeofuse', 'EUR/m³',    '2022-12-31 16:00:00', '2026-12-31 15:59:59'),
(14, 'Gaz naturel', '6a4c56ff-b3e1-4555-9b1c-87d05bcfa4d9', 3, 'timeofuse', 'EUR/m³',    '2022-12-31 16:00:00', '2026-12-31 15:59:59');
...
VALUES
(1, 'McDonald''s', 'd8a24322-4bab-4ba2-aedc-5d55a84c3db8', '7 rue Dongdamachang, district de Dongcheng, Pékin', 39.899493, 116.412041, 500.000, 1, 1, 1, 1,  'McDonald''s');
COMMIT;
...
VALUES
(1, 'Restauration', '494d7d5e-e139-4629-b957-99ea4caf0401', 'Restauration', 'RS'),
(2, 'Commerce de détail', '1f556579-9d5c-45ce-9bd8-f2dc1d033470', 'Commerce de détail', 'RT'),
(3, 'Hôtel', 'cae697aa-ceca-435d-91bf-492b46607eb0', 'Hôtel', 'HT');
...
VALUES
(1, 'Starbucks', '6b0da806-a4cd-431a-8116-2915e90aaf8b', 'Bâtiment n° 1', 'L1 L2 L3', '1201b+2247+3F', 418.8, 9, 1, 1,
 '6b0da806',  '2019-12-31 16:00:00', '2022-12-31 16:00:00', 1, 1, 1,  'description');
COMMIT;
...
(`id`, `name`, `uuid`, `description`, `simplified_code`)
VALUES
(1, 'Locataire restauration', '83fffba1-9e22-4397-a93a-3742772c3753', 'Restauration', 'FNB'),
(2, 'Locataire restauration (gaz)', 'ad95ed16-1c57-49a9-a85e-71e389393089', 'Restauration (gaz)', 'FNBGas'),
(3, 'Locataire restauration (électrique)', '1dc21e83-4333-40f8-9e25-ea049becba37', 'Restauration (électrique)', 'FNBElec'),
(4, 'Locataire forte luminosité', '4208a60d-d8e6-4fe5-8cea-a55109e9b397', 'Locataire forte luminosité', 'HighIllu'),
(5, 'Locataire ancrage', 'fc4ae534-544a-4a22-b83b-9f4aa99494aa', 'Locataire ancrage', 'ANCH'),
(6, 'Locataire commercial standard', '6d1dca30-1cbe-463d-8a78-cdd5e0f8ac8b', 'Locataire commercial standard', 'Normal'),
(7, 'Autre locataire commercial', '2078e1c0-3936-4ae7-9253-08e0aa1d84b6', 'Autre locataire commercial', 'Other'),
(8, 'Locataire bureaux étage entier', 'b2a580a3-edc9-4838-ae1d-7b7265860a9a', 'Locataire bureaux étage entier', 'WhFlr'),
(9, 'Locataire bureaux partiel', '55bbcba7-d8a0-44a0-9a9f-2f085e3cb044', 'Locataire bureaux partiel', 'NonWhFlr');
...
VALUES
(1, 'Compteur virtuel 1', '3fff2cfb-f755-44c8-a919-6135205a8573', 'x1+x2+x3', 1, 1, 1, 1, 'description compteur virtuel');
