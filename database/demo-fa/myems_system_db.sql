...
VALUES
(1, 'آقای جیانگ (مهندس)', '5c5ce6e8-8d00-46b3-9602-4e1520a8b43f',  'john@myems.cn', '+8613888888888', 'ساختمان شماره ۱'),
(2, 'آقای ژانگ (مهندس)', '102b654d-e831-4365-bb1e-dbd55e897851',  'sample.tenant@myems.cn', '+8613666666666', 'مستاجر اصلی');
COMMIT;
