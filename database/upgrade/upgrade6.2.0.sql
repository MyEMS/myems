...
-- 此脚本仅用于将6.1.0升级到6.2.0
-- THIS SCRIPT IS ONLY FOR UPGRADING 6.1.0 TO 6.2.0
...
UPDATE `myems_system_db`.`tbl_versions` SET version='6.2.0', release_date='2026-02-08' WHERE id=1;
