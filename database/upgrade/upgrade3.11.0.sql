...
ALTER TABLE myems_system_db.tbl_microgrids DROP COLUMN microgrid_type_id;
ALTER TABLE myems_system_db.tbl_microgrids DROP COLUMN microgrid_owner_type_id;
