...
VALUES
(1, 'Beispiel ModbusTCP Datenquellenverwaltung', 'b3ace9d4-b63b-419b-818f-0f6d1d0603a4', 1, 'modbus-tcp', '{"host":"192.168.0.1", "port":502}'),
...
(11, 'Beispiel Oracle Datenquellenverwaltung', '1bdf4db8-ea71-433e-ad16-b637275073d7', 1, 'oracle', '{"host":"192.168.0.11", "port":1521, "user":"myems", "password":"!MyEMS1", "database":"myems_ingestion_db" }'),
...
(13, 'Beispiel InfluxDB Datenquellenverwaltung', '79cb60ff-c683-4289-ac69-bd13e1f970d1', 1, 'influxdb', '{"host":"192.168.0.13", "port":8086, "user":"myems", "password":"!MyEMS1", "database":"myems_ingestion_db" }');
COMMIT;
...
VALUES
(1, 'Beispiel Verwaltung des Verteilungssystems', '95652719-56fa-44cc-9bef-7aa47664d4ff', '<?xml version="1.0" encoding="UTF-8"?><svg width="5cm" height="4cm" version="1.1" xmlns="http://www.w3.org/2000/svg"><desc>Four separate rectangles</desc><rect x=".5cm" y=".5cm" width="2cm" height="1cm"/></svg>', 'demo distribution system');
...
VALUES
(1, 'Beispiel Meter1', '5ca47bc5-22c2-47fc-b906-33222191ea40', 1, true, 0.000, 999.999, 1, 1, null, 'meter1'),
(2, 'Beispiel Meter2', '5ca47bc5-22c2-47fc-b906-33222191ea40', 1, true, 0.000, 999.999, 1, 1, 1,  'meter2'),
(3, 'Beispiel Meter3', '6db58cd6-33d3-58ed-a095-22333202fb51', 1, true, 0.000, 999.999, 1, 1, 1,  'meter3');
...
VALUES
(1, 'Beispiel Offline Meter', '62f473e0-1a35-41f3-9c30-8110d75d65bb', 1, true, 0.0, 999.999, 1, 1, 'offlinemeter1');
...
(9, 'S7 Beispiel Punkt 1', 4, 'ANALOG_VALUE',  'kWh', 99999999999, 0, 1.000, true,
...
VALUES
(1, '2020TimeOfUseElectricity1-6',    '590efb36-8587-42a9-ae6f-c715d21496d6', 1, 'timeofuse', 'EUR/kWh', '2019-12-31 16:00:00', '2020-06-30 15:59:59'),
(2, '2020TimeOfUseElectricity7-9',    'f5966640-18fc-437a-9efd-cbc0c58b6373', 1, 'timeofuse', 'EUR/kWh', '2020-06-30 16:00:00', '2020-09-30 15:59:59'),
(3, '2020TimeOfUseElectricity10-12',  '21727a1b-4b27-4186-b72e-db46e6e2d980', 1, 'timeofuse', 'EUR/kWh', '2020-09-30 16:00:00', '2020-12-31 15:59:59'),
(4, '2021TimeOfUseElectricity1-6',    'fe65e443-0ec2-4a16-823e-2365885e2598', 1, 'timeofuse', 'EUR/kWh', '2020-12-31 16:00:00', '2021-06-30 15:59:59'),
(5, '2021TimeOfUseElectricity7-9',    'd1285c81-4612-4d7c-9436-ed11b4e7abe4', 1, 'timeofuse', 'EUR/kWh', '2021-06-30 16:00:00', '2021-09-30 15:59:59'),
(6, '2021TimeOfUseElectricity10-12',  'e6c275b4-47eb-4f5d-bc59-edbe45c2a407', 1, 'timeofuse', 'EUR/kWh', '2021-09-30 16:00:00', '2021-12-31 15:59:59'),
(7, '2022TimeOfUseElectricity1-6',    'ca359f72-48ad-46a7-82af-cecbe98450e8', 1, 'timeofuse', 'EUR/kWh', '2021-12-31 16:00:00', '2022-06-30 15:59:59'),
(8, '2022TimeOfUseElectricity7-9',    '9fdda603-0f8f-4452-ad59-c5df54bc35f4', 1, 'timeofuse', 'EUR/kWh', '2022-06-30 16:00:00', '2022-09-30 15:59:59'),
(9, '2022TimeOfUseElectricity10-12',  'fb0442e7-4d44-4bfd-8b20-cad3f77a2480', 1, 'timeofuse', 'EUR/kWh', '2022-09-30 16:00:00', '2022-12-31 15:59:59'),
(10, '2023TimeOfUseElectricity1-6',   '3fa6e1f2-7d08-4f5a-bcbf-beb041d569c0', 1, 'timeofuse', 'EUR/kWh', '2022-12-31 16:00:00', '2023-06-30 15:59:59'),
(11, '2023TimeOfUseElectricity7-9',   '787240fb-1694-403e-a0a7-83d7be1cc0b8', 1, 'timeofuse', 'EUR/kWh', '2023-06-30 16:00:00', '2023-09-30 15:59:59'),
(12, '2023TimeOfUseElectricity10-12', 'a07fdf76-edcf-4124-96e7-ab733a5a4b70', 1, 'timeofuse', 'EUR/kWh', '2023-09-30 16:00:00', '2023-12-31 15:59:59'),
(13, 'Leitungswasser',  '6fcbc77e-effb-4d43-9b30-77b062435d34', 2, 'timeofuse', 'EUR/m³',    '2019-12-31 16:00:00', '2023-12-31 15:59:59'),
(14, 'Erdgas', '6a4c56ff-b3e1-4555-9b1c-87d05bcfa4d9', 3, 'timeofuse', 'EUR/m³',    '2019-12-31 16:00:00', '2023-12-31 15:59:59'),
(15, 'Komponentengestufter Strompreis', 'd1b81d2f-d387-43d3-affd-d796b7236b60', 1, 'block',     'EUR/kWh', '2019-12-31 16:00:00', '2023-12-31 15:59:59');
...
-- '2020 TimeOfUseElectricity10-12'
...
-- '2021 TimeOfUseElectricity10-12'
...
-- '2022 TimeOfUseElectricity10-12'
...
-- '2023 TimeOfUseElectricity10-12'
...
VALUES
-- 'Komponentengestufter Strompreis'
