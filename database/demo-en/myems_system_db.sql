...
VALUES
(1, 'CombinedEquipment1', '48aab70f-2e32-4518-9986-a6b7395acf58', 1, 0, 1, '<svg></svg>', 'description'),
(2, 'CombinedEquipment2', 'c235e68c-e1be-4d7a-84e7-976c83ff6e44', 1, 0, 1, '<svg></svg>', 'description');
