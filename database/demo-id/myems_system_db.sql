-- MyEMS System Database Demo Data (demo bahasa Indonesia)
...
VALUES
(1, 'Bapak Jiang (insinyur)', '5c5ce6e8-8d00-46b3-9602-4e1520a8b43f',  'john@myems.io', '+8613888888888', 'Gedung 1'),
(2, 'Bapak Zhang (insinyur)', '102b654d-e831-4365-bb1e-dbd55e897851',  'sample.tenant@myems.io', '+8613666666666', 'Penyewa utama');
COMMIT;
...
VALUES
(1, 'Pusat biaya', 'd97b9736-c4f9-4005-a534-6af3487303ad', NULL);
COMMIT;
...
VALUES
(1, 'AHa01', '52f7abe1-ba0e-47a6-a327-4faac42a1d11', 1, '1ES', 'AHa01', 5100, 1250, 'Sambungan listrik 11# 1WHj2', 'AHa01');
...
VALUES
(1, 'Sistem distribusi listrik (contoh)', '95652719-56fa-44cc-9bef-7aa47664d4ff', 1, 'demo distribution system');
...
VALUES
(1, 'Listrik', '6d0753ed-8b43-4332-b6fd-d2f5813831d3', 'kWh', 0.122, 0.928),
(2, 'Air PDAM', '3dbfa598-fccc-4d60-bf11-14bd55540c66', 'm³', 0.085, 0.910),
(3, 'Gas alam', '6d0753ed-8b43-4332-b6fd-d2f5813831d3', 'm³', 1.330, 2.162),
(4,'Air pendingin 4 °C','d2a3021a-4911-4611-856e-80133000f1d5','m³',1.000,1.000),
(5,'Air pendingin 7 °C','c1ad0696-e1ab-4e0c-a342-b194c0bc27e0','m³',1.000,1.000),
(6,'Uap','ac91a5c4-4ae5-4a73-8e3f-044591f42eef','T',1.000,1.000),
(7,'Udara bertekanan','ff238e98-cd35-47c5-88a3-00617587775d','m³',1.000,1.000),
(8,'Air sirkulasi','7e159a34-b2e6-4fd3-ba76-897d134abe06','m³',1.000,1.000),
(9, 'Kalor','549f9cad-8db7-49d2-9473-95e37a3fc46a','KJ',1.000,1.000),
(10, 'Dingin','05aa257b-3cf6-4f19-808d-92e7dbf52b16','KJ',1.000,1.000),
(11, 'Air daur ulang','df6161b6-4a1b-46e7-b7c8-337b5b52d717','m³',1.000,1.000);
COMMIT;
...
VALUES
(1, 'Listrik penerangan dan stopkontak', 'cade4e78-2b85-4bea-ab6e-0d6accc88d03', 1),
(2, 'Listrik koridor dan penerangan darurat', '7a6dc086-ce08-4d66-ba75-f69af92b32f4', 1),
(3, 'Listrik penerangan lanskap luar', 'abcebbd1-b770-4e7c-ae54-8434d724522c', 1),
(4, 'Listrik pusat panas dan dingin', '97cdea54-04c7-4a6a-b4c2-df15874b2f49', 1),
(5, 'Listrik terminal AC', '84ab7262-33fb-43a1-9880-9287cc268cc0', 1),
(6, 'Listrik lift', '26a5fc62-3da1-41b0-bcb1-0056e25ee121', 1),
(7, 'Listrik pompa', 'fc6079f5-01a4-434f-9004-9382e8c3dd47', 1),
(8, 'Listrik ventilasi', 'a4bf68cd-6ae1-48dd-b281-07c95312921d', 1),
(9, 'Listrik khusus', '1990d151-02ff-4fd6-b298-2b2edee4e0ea', 1);
COMMIT;
...
(`id`, `name`, `uuid`)
VALUES
(1, 'Diagram aliran energi (contoh)', '3ccbc9c6-9575-4212-a63a-a688d1154302');
...
VALUES
(1, 'Meteran 1', '5ca47bc5-22c2-47fc-b906-33222191ea40', 1, 1, 0.000, 999.999, 1, 1, null, 'meter1'),
(2, 'Meteran 2', 'd6f3f56b-10ee-4d22-ad47-5acc1353a6f4', 1, 1, 0.000, 999.999, 1, 1, 1,  'meter2'),
(3, 'Meteran 3', '6db58cd6-33d3-58ed-a095-22333202fb51', 1, 1, 0.000, 999.999, 1, 1, 1,  'meter3');
...
VALUES
(1, 'Meteran offline 1', '62f473e0-1a35-41f3-9c30-8110d75d65bb', 1, 1, 0.0, 999.999, 1, 1, 'offlinemeter1');
...
VALUES
(2, 'Gedung 1', '8f25b33b-db93-49b3-b0f8-b01e0c19df29', 1, 88888.888, 56, 1, 1, 1, 1,  'MyEMS Project'),
(3, 'Gedung 2', '195d7ea8-17b4-4e9c-bb37-546428155438', 1, 66666.666, 56, 1, 1, 1, 1, 'MyEMS Project'),
(10000, 'Ruang debug', '2c44a292-eb0c-49a3-a50e-4fc03858dc0c', 1, 88888.888, 56, 1, 1, 1, 1,  'MyEMS Project');
COMMIT;
...
VALUES
(1, 'Listrik TOU 2026 (bulan 1–6)',    '590efb36-8587-42a9-ae6f-c715d21496d6', 1, 'timeofuse', 'IDR/kWh', '2025-12-31 16:00:00', '2026-06-30 15:59:59'),
(2, 'Listrik TOU 2026 (bulan 7–9)',    'f5966640-18fc-437a-9efd-cbc0c58b6373', 1, 'timeofuse', 'IDR/kWh', '2026-06-30 16:00:00', '2026-09-30 15:59:59'),
(3, 'Listrik TOU 2026 (bulan 10–12)',  '21727a1b-4b27-4186-b72e-db46e6e2d980', 1, 'timeofuse', 'IDR/kWh', '2026-09-30 16:00:00', '2026-12-31 15:59:59'),
(4, 'Listrik TOU 2023 (bulan 1–6)',    'fe65e443-0ec2-4a16-823e-2365885e2598', 1, 'timeofuse', 'IDR/kWh', '2022-12-31 16:00:00', '2023-06-30 15:59:59'),
(5, 'Listrik TOU 2023 (bulan 7–9)',    'd1285c81-4612-4d7c-9436-ed11b4e7abe4', 1, 'timeofuse', 'IDR/kWh', '2023-06-30 16:00:00', '2023-09-30 15:59:59'),
(6, 'Listrik TOU 2023 (bulan 10–12)',  'e6c275b4-47eb-4f5d-bc59-edbe45c2a407', 1, 'timeofuse', 'IDR/kWh', '2023-09-30 16:00:00', '2023-12-31 15:59:59'),
(7, 'Listrik TOU 2024 (bulan 1–6)',    'ca359f72-48ad-46a7-82af-cecbe98450e8', 1, 'timeofuse', 'IDR/kWh', '2023-12-31 16:00:00', '2024-06-30 15:59:59'),
(8, 'Listrik TOU 2024 (bulan 7–9)',    '9fdda603-0f8f-4452-ad59-c5df54bc35f4', 1, 'timeofuse', 'IDR/kWh', '2024-06-30 16:00:00', '2024-09-30 15:59:59'),
(9, 'Listrik TOU 2024 (bulan 10–12)',  'fb0442e7-4d44-4bfd-8b20-cad3f77a2480', 1, 'timeofuse', 'IDR/kWh', '2024-09-30 16:00:00', '2024-12-31 15:59:59'),
(10, 'Listrik TOU 2025 (bulan 1–6)',   '3fa6e1f2-7d08-4f5a-bcbf-beb041d569c0', 1, 'timeofuse', 'IDR/kWh', '2024-12-31 16:00:00', '2025-06-30 15:59:59'),
(11, 'Listrik TOU 2025 (bulan 7–9)',   '787240fb-1694-403e-a0a7-83d7be1cc0b8', 1, 'timeofuse', 'IDR/kWh', '2025-06-30 16:00:00', '2025-09-30 15:59:59'),
(12, 'Listrik TOU 2025 (bulan 10–12)', 'a07fdf76-edcf-4124-96e7-ab733a5a4b70', 1, 'timeofuse', 'IDR/kWh', '2025-09-30 16:00:00', '2025-12-31 15:59:59'),
(13, 'Air PDAM',  '6fcbc77e-effb-4d43-9b30-77b062435d34', 2, 'timeofuse', 'IDR/m³',    '2022-12-31 16:00:00', '2026-12-31 15:59:59'),
(14, 'Gas alam', '6a4c56ff-b3e1-4555-9b1c-87d05bcfa4d9', 3, 'timeofuse', 'IDR/m³',    '2022-12-31 16:00:00', '2026-12-31 15:59:59');
...
VALUES
(1, 'McDonald''s', 'd8a24322-4bab-4ba2-aedc-5d55a84c3db8', 'Jalan Dongdachang No. 7, Dongcheng, Beijing', 39.899493, 116.412041, 500.000, 1, 1, 1, 1,  'McDonald''s');
COMMIT;
...
VALUES
(1, 'Makanan & minuman', '494d7d5e-e139-4629-b957-99ea4caf0401', 'Makanan & minuman', 'RS'),
(2, 'Ritel', '1f556579-9d5c-45ce-9bd8-f2dc1d033470', 'Ritel', 'RT'),
...
VALUES
(1, 'Starbucks', '6b0da806-a4cd-431a-8116-2915e90aaf8b', 'Gedung 1', 'L1 L2 L3', '1201b+2247+3F', 418.8, 9, 1, 1,
 '6b0da806',  '2019-12-31 16:00:00', '2022-12-31 16:00:00', 1, 1, 1,  'deskripsi');
COMMIT;
...
(`id`, `name`, `uuid`, `description`, `simplified_code`)
VALUES
(1, 'Penyewa F&B', '83fffba1-9e22-4397-a93a-3742772c3753', 'Makanan & minuman', 'FNB'),
(2, 'Penyewa F&B (gas)', 'ad95ed16-1c57-49a9-a85e-71e389393089', 'Makanan (gas)', 'FNBGas'),
(3, 'Penyewa F&B (listrik)', '1dc21e83-4333-40f8-9e25-ea049becba37', 'Makanan (listrik)', 'FNBElec'),
...
(6, 'Penyewa ritel umum', '6d1dca30-1cbe-463d-8a78-cdd5e0f8ac8b', 'Ritel umum', 'Normal'),
(7, 'Penyewa ritel lainnya', '2078e1c0-3936-4ae7-9253-08e0aa1d84b6', 'Ritel lainnya', 'Other'),
(8, 'Penyewa kantor satu lantai penuh', 'b2a580a3-edc9-4838-ae1d-7b7265860a9a', 'Kantor satu lantai penuh', 'WhFlr'),
(9, 'Penyewa kantor sebagian lantai', '55bbcba7-d8a0-44a0-9a9f-2f085e3cb044', 'Kantor sebagian lantai', 'NonWhFlr');
...
VALUES
(1, 'Meter virtual 1', '3fff2cfb-f755-44c8-a919-6135205a8573', 'x1+x2+x3', 1, 1, 1, 1, 'virtual description');
