-- MyEMS System Database Demo Data (demonstração em português)
...
VALUES
(1, 'Equipamento combinado 1', '48aab70f-2e32-4518-9986-a6b7395acf58', 1, 0, 1, 1, '', 'description'),
(2, 'Equipamento combinado 2', 'c235e68c-e1be-4d7a-84e7-976c83ff6e44', 1, 0, 1, 1, '', 'description');
...
VALUES
(1, 'Sr. Jiang', '5c5ce6e8-8d00-46b3-9602-4e1520a8b43f',  'john@myems.io', '+8613888888888', 'Edifício n.º 1'),
(2, 'Sr. Zhang', '102b654d-e831-4365-bb1e-dbd55e897851',  'sample.tenant@myems.io', '+8613666666666', 'Inquilino âncora');
COMMIT;
...
VALUES
(1, 'Centro de custos', 'd97b9736-c4f9-4005-a534-6af3487303ad', NULL);
COMMIT;
...
VALUES
(1, 'Fonte de dados Modbus TCP (exemplo)', 'b3ace9d4-b63b-419b-818f-0f6d1d0603a4', 1, 'modbus-tcp', '{"host":"192.168.0.1", "port":502, "interval_in_seconds":60}'),
(2, 'Fonte de dados Modbus RTU (exemplo) *Edição empresarial*', 'b903f0af-9115-448c-9d46-8caf5f9995f3', 1, 'modbus-rtu', '{"port": "/dev/ttyUSB0","slaveaddress": 1, "baudrate": 9600,"bytesize": 8,"parity": "N","stopbits": 1,"timeout": 0.05,"mode": "rtu"}'),
(3, 'Fonte de dados BACnet/IP (exemplo) *Edição empresarial*', 'e2d5b30b-b554-4ebe-8ce7-f377ab380d19', 1, 'bacnet-ip', '{"host":"192.168.0.3", "port":47808}'),
(4, 'Fonte de dados S7 (exemplo) *Edição empresarial*', '9eb0d705-d02a-43f8-9c62-7e5ef508b255', 1, 's7', '{"host":"192.168.0.4", "port":102, "rack": 0, "slot": 2}'),
...
VALUES
(1, 'AHa01', '52f7abe1-ba0e-47a6-a327-4faac42a1d11', 1, '1ES', 'AHa01', 5100, 1250, 'Entrada de alimentação n.º 11 linha 1WHj2', 'AHa01');
...
VALUES
(1, 'Sistema de distribuição elétrica (exemplo)', '95652719-56fa-44cc-9bef-7aa47664d4ff', 1, 'Sistema de distribuição (demo)');
...
VALUES
(1, 'Eletricidade', '6d0753ed-8b43-4332-b6fd-d2f5813831d3', 'kWh', 0.122, 0.928),
(2, 'Água da rede', '3dbfa598-fccc-4d60-bf11-14bd55540c66', 'm³', 0.085, 0.910),
(3, 'Gás natural', '6d0753ed-8b43-4332-b6fd-d2f5813831d3', 'm³', 1.330, 2.162),
(4,'Água gelada a 4 °C','d2a3021a-4911-4611-856e-80133000f1d5','m³',1.000,1.000),
(5,'Água gelada a 7 °C','c1ad0696-e1ab-4e0c-a342-b194c0bc27e0','m³',1.000,1.000),
(6,'Vapor','ac91a5c4-4ae5-4a73-8e3f-044591f42eef','T',1.000,1.000),
(7,'Ar comprimido','ff238e98-cd35-47c5-88a3-00617587775d','m³',1.000,1.000),
(8,'Água de circulação','7e159a34-b2e6-4fd3-ba76-897d134abe06','m³',1.000,1.000),
(9, 'Calor','549f9cad-8db7-49d2-9473-95e37a3fc46a','KJ',1.000,1.000),
(10, 'Frio','05aa257b-3cf6-4f19-808d-92e7dbf52b16','KJ',1.000,1.000),
(11, 'Água reutilizada','df6161b6-4a1b-46e7-b7c8-337b5b52d717','m³',1.000,1.000);
COMMIT;
...
VALUES
(1, 'Eletricidade de iluminação e tomadas', 'cade4e78-2b85-4bea-ab6e-0d6accc88d03', 1),
(2, 'Eletricidade de corredores e iluminação de emergência', '7a6dc086-ce08-4d66-ba75-f69af92b32f4', 1),
(3, 'Eletricidade de iluminação paisagística exterior', 'abcebbd1-b770-4e7c-ae54-8434d724522c', 1),
(4, 'Eletricidade da central térmica', '97cdea54-04c7-4a6a-b4c2-df15874b2f49', 1),
(5, 'Eletricidade dos terminais de climatização', '84ab7262-33fb-43a1-9880-9287cc268cc0', 1),
(6, 'Eletricidade dos elevadores', '26a5fc62-3da1-41b0-bcb1-0056e25ee121', 1),
(7, 'Eletricidade das bombas', 'fc6079f5-01a4-434f-9004-9382e8c3dd47', 1),
(8, 'Eletricidade dos ventiladores', 'a4bf68cd-6ae1-48dd-b281-07c95312921d', 1),
(9, 'Eletricidade especial', '1990d151-02ff-4fd6-b298-2b2edee4e0ea', 1);
COMMIT;
...
(`id`, `name`, `uuid`)
VALUES
(1, 'Diagrama de fluxo de energia (exemplo)', '3ccbc9c6-9575-4212-a63a-a688d1154302');
...
(`id`, `name`, `uuid`,  `is_input_counted`, `is_output_counted`, `cost_center_id`, `svg_id`, `camera_url`, `description` )
VALUES
(1, 'Equipamento 1', 'bfa8b106-89a1-49ca-9b2b-a481ac41a873', 1, 0, 1, 1, '', 'description'),
(2, 'Equipamento 2', 'ad5798ec-d827-43d9-bf08-fc7516f9c4c8', 1, 0, 1, 1, '', 'description');
...
VALUES
(1, 'Medidor 1', '5ca47bc5-22c2-47fc-b906-33222191ea40', 1, 1, 0.000, 999.999, 1, 1, null, 'meter1'),
(2, 'Medidor 2', 'd6f3f56b-10ee-4d22-ad47-5acc1353a6f4', 1, 1, 0.000, 999.999, 1, 1, 1,  'meter2'),
(3, 'Medidor 3', '6db58cd6-33d3-58ed-a095-22333202fb51', 1, 1, 0.000, 999.999, 1, 1, 1,  'meter3');
...
VALUES
(1, 'Medidor offline 1', '62f473e0-1a35-41f3-9c30-8110d75d65bb', 1, 1, 0.0, 999.999, 1, 1, 'offlinemeter1');
...
(6, 'Ponto de dados Modbus TCP exemplo 6', 2, 'ENERGY_VALUE',  'Wh', 99999999999, 0, 1.000, 1, 0,
  '{\"slave_id\":1, \"function_code\":3, \"offset\":40001, \"number_of_registers\":2, \"format\":\"=f\", \"byte_swap\":false}', null),

(7, 'Ponto de dados exemplo 7', 2, 'ANALOG_VALUE',  'V', 690, 0, 1.000, 1, 0,
  '{\"slave_id\":1, \"function_code\":3, \"offset\":40002, \"number_of_registers\":2, \"format\":\"=f\", \"byte_swap\":false}', null),

(8, 'Ponto de dados BACnet exemplo 1', 3, 'ANALOG_VALUE',  'V', 690, 0, 1.000, 1, 0,
...
(9, 'Ponto de dados S7 exemplo 1', 4, 'ANALOG_VALUE',  'kWh', 99999999999, 0, 1.000, 1, 0,
...
VALUES
(1, 'Sensor 1', 'ba450606-6f39-41e0-8caf-75b528635511', 'descrição do sensor');
...
VALUES
(1, 'Área de produção 1', 'd03837fd-9d30-44fe-9443-154f7c7e15f1',  99999.999, 1, 1, 1,  'Projeto MyEMS');
COMMIT;
...
VALUES
(2, 'Edifício 1', '8f25b33b-db93-49b3-b0f8-b01e0c19df29', 1, 88888.888, 56, 1, 1, 1, 1,  'Projeto MyEMS'),
(3, 'Edifício 2', '195d7ea8-17b4-4e9c-bb37-546428155438', 1, 66666.666, 56, 1, 1, 1, 1, 'Projeto MyEMS'),
(10000, 'Espaço de depuração', '2c44a292-eb0c-49a3-a50e-4fc03858dc0c', 1, 88888.888, 56, 1, 1, 1, 1,  'Projeto MyEMS');
COMMIT;
...
VALUES
(1, 'SVG1', 'a0e79d2e-8756-457e-b1f2-4152e3591bff', '<?xml version="1.0" encoding="UTF-8"?><svg width="5cm" height="4cm" version="1.1" xmlns="http://www.w3.org/2000/svg"><desc>Quatro retângulos separados</desc><rect x=".5cm" y=".5cm" width="2cm" height="1cm"/></svg>', 'SVG demo');
...
VALUES
(1, 'Eletricidade TOU 2026 (jan.-jun.)',    '590efb36-8587-42a9-ae6f-c715d21496d6', 1, 'timeofuse', 'EUR/kWh', '2025-12-31 16:00:00', '2026-06-30 15:59:59'),
(2, 'Eletricidade TOU 2026 (jul.-set.)',    'f5966640-18fc-437a-9efd-cbc0c58b6373', 1, 'timeofuse', 'EUR/kWh', '2026-06-30 16:00:00', '2026-09-30 15:59:59'),
(3, 'Eletricidade TOU 2026 (out.-dez.)',  '21727a1b-4b27-4186-b72e-db46e6e2d980', 1, 'timeofuse', 'EUR/kWh', '2026-09-30 16:00:00', '2026-12-31 15:59:59'),
(4, 'Eletricidade TOU 2023 (jan.-jun.)',    'fe65e443-0ec2-4a16-823e-2365885e2598', 1, 'timeofuse', 'EUR/kWh', '2022-12-31 16:00:00', '2023-06-30 15:59:59'),
(5, 'Eletricidade TOU 2023 (jul.-set.)',    'd1285c81-4612-4d7c-9436-ed11b4e7abe4', 1, 'timeofuse', 'EUR/kWh', '2023-06-30 16:00:00', '2023-09-30 15:59:59'),
(6, 'Eletricidade TOU 2023 (out.-dez.)',  'e6c275b4-47eb-4f5d-bc59-edbe45c2a407', 1, 'timeofuse', 'EUR/kWh', '2023-09-30 16:00:00', '2023-12-31 15:59:59'),
(7, 'Eletricidade TOU 2024 (jan.-jun.)',    'ca359f72-48ad-46a7-82af-cecbe98450e8', 1, 'timeofuse', 'EUR/kWh', '2023-12-31 16:00:00', '2024-06-30 15:59:59'),
(8, 'Eletricidade TOU 2024 (jul.-set.)',    '9fdda603-0f8f-4452-ad59-c5df54bc35f4', 1, 'timeofuse', 'EUR/kWh', '2024-06-30 16:00:00', '2024-09-30 15:59:59'),
(9, 'Eletricidade TOU 2024 (out.-dez.)',  'fb0442e7-4d44-4bfd-8b20-cad3f77a2480', 1, 'timeofuse', 'EUR/kWh', '2024-09-30 16:00:00', '2024-12-31 15:59:59'),
(10, 'Eletricidade TOU 2025 (jan.-jun.)',   '3fa6e1f2-7d08-4f5a-bcbf-beb041d569c0', 1, 'timeofuse', 'EUR/kWh', '2024-12-31 16:00:00', '2025-06-30 15:59:59'),
(11, 'Eletricidade TOU 2025 (jul.-set.)',   '787240fb-1694-403e-a0a7-83d7be1cc0b8', 1, 'timeofuse', 'EUR/kWh', '2025-06-30 16:00:00', '2025-09-30 15:59:59'),
(12, 'Eletricidade TOU 2025 (out.-dez.)', 'a07fdf76-edcf-4124-96e7-ab733a5a4b70', 1, 'timeofuse', 'EUR/kWh', '2025-09-30 16:00:00', '2025-12-31 15:59:59'),
(13, 'Água da rede',  '6fcbc77e-effb-4d43-9b30-77b062435d34', 2, 'timeofuse', 'EUR/m³',    '2022-12-31 16:00:00', '2026-12-31 15:59:59'),
(14, 'Gás natural', '6a4c56ff-b3e1-4555-9b1c-87d05bcfa4d9', 3, 'timeofuse', 'EUR/m³',    '2022-12-31 16:00:00', '2026-12-31 15:59:59');
...
VALUES
(1, 'McDonald''s', 'd8a24322-4bab-4ba2-aedc-5d55a84c3db8', 'Rua Dongdamachang n.º 7, distrito de Dongcheng, Pequim', 39.899493, 116.412041, 500.000, 1, 1, 1, 1,  'McDonald''s');
COMMIT;
...
VALUES
(1, 'Restauração', '494d7d5e-e139-4629-b957-99ea4caf0401', 'Restauração', 'RS'),
(2, 'Varejo', '1f556579-9d5c-45ce-9bd8-f2dc1d033470', 'Varejo', 'RT'),
...
VALUES
(1, 'Starbucks', '6b0da806-a4cd-431a-8116-2915e90aaf8b', 'Edifício n.º 1', 'L1 L2 L3', '1201b+2247+3F', 418.8, 9, 1, 1,
 '6b0da806',  '2019-12-31 16:00:00', '2022-12-31 16:00:00', 1, 1, 1,  'descrição');
COMMIT;
...
(`id`, `name`, `uuid`, `description`, `simplified_code`)
VALUES
(1, 'Inquilino de restauração', '83fffba1-9e22-4397-a93a-3742772c3753', 'Restauração', 'FNB'),
(2, 'Inquilino de restauração (gás)', 'ad95ed16-1c57-49a9-a85e-71e389393089', 'Restauração (gás)', 'FNBGas'),
(3, 'Inquilino de restauração (elétrico)', '1dc21e83-4333-40f8-9e25-ea049becba37', 'Restauração (elétrico)', 'FNBElec'),
(4, 'Inquilino de alta luminância', '4208a60d-d8e6-4fe5-8cea-a55109e9b397', 'Inquilino de alta luminância', 'HighIllu'),
(5, 'Inquilino âncora', 'fc4ae534-544a-4a22-b83b-9f4aa99494aa', 'Inquilino âncora', 'ANCH'),
(6, 'Inquilino comercial normal', '6d1dca30-1cbe-463d-8a78-cdd5e0f8ac8b', 'Inquilino comercial normal', 'Normal'),
(7, 'Outro inquilino comercial', '2078e1c0-3936-4ae7-9253-08e0aa1d84b6', 'Outro inquilino comercial', 'Other'),
(8, 'Inquilino de escritórios piso completo', 'b2a580a3-edc9-4838-ae1d-7b7265860a9a', 'Escritórios piso completo', 'WhFlr'),
(9, 'Inquilino de escritórios piso parcial', '55bbcba7-d8a0-44a0-9a9f-2f085e3cb044', 'Escritórios piso parcial', 'NonWhFlr');
...
VALUES
(1, 'Medidor virtual 1', '3fff2cfb-f755-44c8-a919-6135205a8573', 'x1+x2+x3', 1, 1, 1, 1, 'descrição do medidor virtual');
