...
def main():
    ...
    point_list = [
        ...
        (1, '192.168.0.2', 'analogInput', 1, 'presentValue', None),
        (2, '192.168.0.2', 'analogInput', 2, 'presentValue', None),
        (3, '192.168.0.2', 'analogInput', 3, 'presentValue', None),
        (4, '192.168.0.2', 'analogInput', 4, 'presentValue', None),
        (5, '192.168.0.2', 'analogInput', 5, 'presentValue', None),
        (6, '192.168.0.2', 'analogInput', 6, 'presentValue', None),
    ]
